...
const PLUGINS = [
  ...
  { key: "sales-agent", accent: "#4F46E5", scene: "chatbot" },
  ...
  { key: "masonry-gallery", accent: "#F97316", scene: "gallery" },
  ...
  { key: "floating-video", accent: "#EF4444", scene: "video-float" },
  { key: "video-gallery", accent: "#A855F7", scene: "video-grid" },
  ...
  { key: "scroll-progress", accent: "#94A3B8", scene: "scroll" },
  { key: "dark-mode", accent: "#1E293B", scene: "darkmode" },
  { key: "text-resizer", accent: "#0891B2", scene: "text-size" },
