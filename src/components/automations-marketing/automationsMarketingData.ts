...
export const automationsModules = [
  ...
  {
    accent: "#e11d8c",
    title: "AI שמזיז משימות",
    text: "יועץ BizUply יכול ליצור משימות, לשלוף משימות ממתינות, לידים פתוחים ופגישות קרובות.",
    tags: ["AI Advisor", "משימות"],
  },
  {
    accent: "#f59e0b",
...
export const automationsFaq: MarketingFaq[] = [
  ...
  },
  {
    ...
    a: "יועץ BizUply יכול ליצור משימות ולשלוף משימות ממתינות, לידים פתוחים ופגישות קרובות — כשכבה שמאיצה את התהליכים שכבר רצים.",
  },
  {
    q: "אפשר להתחיל בקטן?",
