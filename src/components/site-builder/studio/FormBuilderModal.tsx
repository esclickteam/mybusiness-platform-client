...
function FieldSideDropOverlay({
  ...
  return (
    <div
      className={[
        "pointer-events-none absolute bottom-1 top-1 z-20 w-2 rounded-full bg-gradient-to-l from-violet-100 via-sky-100 to-cyan-100 border border-violet-200/70 shadow-[0_0_0_6px_rgba(37,99,235,0.16)]",
        ...
        <aside className="flex w-[390px] shrink-0 flex-col border-l border-slate-200/80 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)]">
          <div className="relative flex items-center justify-between overflow-hidden border-b border-slate-200/80 bg-white px-6 py-5">
            ...
            <div className="relative flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-100 via-sky-100 to-cyan-100 border border-violet-200/80 text-slate-800 shadow-lg shadow-violet-200">
            ...
            <div className="rounded-[26px] border border-slate-200/80 bg-white p-4 shadow-[0_14px_40px_rgba(15,23,42,0.06)]">
              ...
              <div className="grid grid-cols-2 gap-3">
                {FIELD_TYPES.map((item) => (
                  ...
                  >
                    <span className="mb-2 flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-50 to-blue-50 text-violet-700 ring-1 ring-violet-100 transition group-hover:from-violet-200/80 group-hover:via-sky-100 group-hover:to-cyan-100 group-hover:text-slate-800 group-hover:ring-transparent">
                      {item.icon}
                    </span>
