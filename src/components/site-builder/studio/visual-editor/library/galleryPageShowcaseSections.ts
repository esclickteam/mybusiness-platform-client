...
const page01 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("gallery", 0, {
      ...
      images: [IMG.architecture, IMG.interior, IMG.fashion, IMG.workspace, IMG.construction, IMG.abstract, IMG.beauty, IMG.event, IMG.nature, IMG.travel, IMG.camera, IMG.studio],
...
const page02 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("gallery", 1, {
      ...
      cta: 'צפו ברצף',
      image: IMG.interior,
      images: [IMG.interior, IMG.fashion, IMG.workspace, IMG.construction, IMG.abstract, IMG.beauty, IMG.event, IMG.nature, IMG.travel, IMG.camera, IMG.studio, IMG.architecture],
...
const page03 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("gallery", 2, {
      ...
      cta: 'פתחו קייס',
      image: IMG.fashion,
      images: [IMG.fashion, IMG.workspace, IMG.construction, IMG.abstract, IMG.beauty, IMG.event, IMG.nature, IMG.travel, IMG.camera, IMG.studio, IMG.architecture, IMG.interior],
...
const page04 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("gallery", 3, {
      ...
      cta: 'גלו פרויקט',
      image: IMG.workspace,
      images: [IMG.workspace, IMG.construction, IMG.abstract, IMG.beauty, IMG.event, IMG.nature, IMG.travel, IMG.camera, IMG.studio, IMG.architecture, IMG.interior, IMG.fashion],
      items: [{ title: 'פרויקט מגורים', copy: 'חללים חמים ומדויקים.' }, { title: 'מסחרי', copy: 'נוכחות רחוב חזקה.' }, { title: 'מותג', copy: 'שפה ויזואלית עקבית.' }, { title: 'אירוע', copy: 'רגעים שנבחרו.' }, { title: 'מוצר', copy: 'צילום שמוכר.' }, { title: 'דיגיטל', copy: 'ממשקים נקיים.' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page05 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("gallery", 4, {
      ...
      images: [IMG.construction, IMG.abstract, IMG.beauty, IMG.event, IMG.nature, IMG.travel, IMG.camera, IMG.studio, IMG.architecture, IMG.interior, IMG.fashion, IMG.workspace],
      items: [{ title: 'אור', copy: 'קומפוזיציה בהירה.', meta: '01' }, { title: 'צל', copy: 'דרמה מבוקרת.', meta: '02' }, { title: 'טקסטורה', copy: 'חומרים אמיתיים.', meta: '03' }, { title: 'פריים', copy: 'רגע מדויק.', meta: '04' }, { title: 'עריכה', copy: 'סלקציה.', meta: '05' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page06 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("gallery", 5, {
      ...
      cta: 'היכנסו לתערוכה',
      image: IMG.abstract,
      images: [IMG.abstract, IMG.beauty, IMG.event, IMG.nature, IMG.travel, IMG.camera, IMG.studio, IMG.architecture, IMG.interior, IMG.fashion, IMG.workspace, IMG.construction],
      items: [{ title: '01 נבחר', copy: 'עבודת דגל.', meta: '01' }, { title: '02 חדש', copy: 'מהסטודיו.', meta: '02' }, { title: '03 אהוב', copy: 'הכי נצפה.', meta: '03' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page07 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("gallery", 6, {
      ...
      cta: 'שמרו השראה',
      image: IMG.beauty,
      images: [IMG.beauty, IMG.event, IMG.nature, IMG.travel, IMG.camera, IMG.studio, IMG.architecture, IMG.interior, IMG.fashion, IMG.workspace, IMG.construction, IMG.abstract],
      items: [{ title: 'פרויקט מגורים', copy: 'חללים חמים ומדויקים.' }, { title: 'מסחרי', copy: 'נוכחות רחוב חזקה.' }, { title: 'מותג', copy: 'שפה ויזואלית עקבית.' }, { title: 'אירוע', copy: 'רגעים שנבחרו.' }, { title: 'מוצר', copy: 'צילום שמוכר.' }, { title: 'דיגיטל', copy: 'ממשקים נקיים.' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page08 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("gallery", 7, {
      ...
      cta: 'פתחו פרויקט',
      image: IMG.event,
      images: [IMG.event, IMG.nature, IMG.travel, IMG.camera, IMG.studio, IMG.architecture, IMG.interior, IMG.fashion, IMG.workspace, IMG.construction, IMG.abstract, IMG.beauty],
      items: [{ title: 'אור', copy: 'קומפוזיציה בהירה.', meta: '01' }, { title: 'צל', copy: 'דרמה מבוקרת.', meta: '02' }, { title: 'טקסטורה', copy: 'חומרים אמיתיים.', meta: '03' }, { title: 'פריים', copy: 'רגע מדויק.', meta: '04' }, { title: 'עריכה', copy: 'סלקציה.', meta: '05' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page09 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("gallery", 8, {
      ...
      cta: 'גללו הלאה',
      image: IMG.nature,
      images: [IMG.nature, IMG.travel, IMG.camera, IMG.studio, IMG.architecture, IMG.interior, IMG.fashion, IMG.workspace, IMG.construction, IMG.abstract, IMG.beauty, IMG.event],
      items: [{ title: '01 נבחר', copy: 'עבודת דגל.', meta: '01' }, { title: '02 חדש', copy: 'מהסטודיו.', meta: '02' }, { title: '03 אהוב', copy: 'הכי נצפה.', meta: '03' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page10 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("gallery", 9, {
      ...
      image: IMG.travel,
      images: [IMG.travel, IMG.camera, IMG.studio, IMG.architecture, IMG.interior, IMG.fashion, IMG.workspace, IMG.construction, IMG.abstract, IMG.beauty, IMG.event, IMG.nature],
      items: [{ title: 'פרויקט מגורים', copy: 'חללים חמים ומדויקים.' }, { title: 'מסחרי', copy: 'נוכחות רחוב חזקה.' }, { title: 'מותג', copy: 'שפה ויזואלית עקבית.' }, { title: 'אירוע', copy: 'רגעים שנבחרו.' }, { title: 'מוצר', copy: 'צילום שמוכר.' }, { title: 'דיגיטל', copy: 'ממשקים נקיים.' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
