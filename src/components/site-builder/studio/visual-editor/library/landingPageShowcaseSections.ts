...
const page01 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("promote", 0, {
      ...
      secondaryCta: 'למידע',
      image: IMG.product,
      images: [IMG.product, IMG.tech, IMG.fashion, IMG.ecommerce, IMG.event, IMG.finance, IMG.abstract, IMG.wellness, IMG.product, IMG.tech],
...
const page02 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("promote", 1, {
      ...
      cta: 'הצטרפו עכשיו',
      image: IMG.tech,
      images: [IMG.tech, IMG.fashion, IMG.ecommerce, IMG.event, IMG.finance, IMG.abstract, IMG.wellness, IMG.product, IMG.tech, IMG.product],
...
const page03 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("promote", 2, {
      ...
      cta: 'מימוש ההטבה',
      image: IMG.fashion,
      images: [IMG.fashion, IMG.ecommerce, IMG.event, IMG.finance, IMG.abstract, IMG.wellness, IMG.product, IMG.tech, IMG.product, IMG.tech],
      items: [{ title: 'הטבה', copy: 'מחיר מוגבל.' }, { title: 'בונוס', copy: 'מתנה בהרשמה.' }, { title: 'אחריות', copy: 'בלי סיכון.' }, { title: 'מהיר', copy: 'התחלה מיידית.' }, { title: 'פשוט', copy: 'שלושה קליקים.' }, { title: 'תוצאה', copy: 'רואים הבדל.' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page04 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("promote", 3, {
      ...
      cta: 'לקנייה',
      image: IMG.ecommerce,
      images: [IMG.ecommerce, IMG.event, IMG.finance, IMG.abstract, IMG.wellness, IMG.product, IMG.tech, IMG.product, IMG.tech, IMG.fashion],
      items: [{ title: 'לחצו', copy: 'בוחרים מסלול.', meta: '01' }, { title: 'נרשמים', copy: 'משאירים פרטים.', meta: '02' }, { title: 'מקבלים', copy: 'הגישה נפתחת.', meta: '03' }, { title: 'מתחילים', copy: 'עובדים.', meta: '04' }, { title: 'צומחים', copy: 'מודדים.', meta: '05' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page05 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("promote", 4, {
      ...
      cta: 'בקשו גישה',
      image: IMG.event,
      images: [IMG.event, IMG.finance, IMG.abstract, IMG.wellness, IMG.product, IMG.tech, IMG.product, IMG.tech, IMG.fashion, IMG.ecommerce],
      items: [{ title: 'הטבה', copy: 'מחיר מוגבל.' }, { title: 'בונוס', copy: 'מתנה בהרשמה.' }, { title: 'אחריות', copy: 'בלי סיכון.' }, { title: 'מהיר', copy: 'התחלה מיידית.' }, { title: 'פשוט', copy: 'שלושה קליקים.' }, { title: 'תוצאה', copy: 'רואים הבדל.' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page06 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("promote", 5, {
      ...
      cta: 'שמרו מקום',
      image: IMG.finance,
      images: [IMG.finance, IMG.abstract, IMG.wellness, IMG.product, IMG.tech, IMG.product, IMG.tech, IMG.fashion, IMG.ecommerce, IMG.event],
      items: [{ title: 'לחצו', copy: 'בוחרים מסלול.', meta: '01' }, { title: 'נרשמים', copy: 'משאירים פרטים.', meta: '02' }, { title: 'מקבלים', copy: 'הגישה נפתחת.', meta: '03' }, { title: 'מתחילים', copy: 'עובדים.', meta: '04' }, { title: 'צומחים', copy: 'מודדים.', meta: '05' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page07 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("promote", 6, {
      ...
      cta: 'בקשו דמו',
      image: IMG.abstract,
      images: [IMG.abstract, IMG.wellness, IMG.product, IMG.tech, IMG.product, IMG.tech, IMG.fashion, IMG.ecommerce, IMG.event, IMG.finance],
      items: [{ title: 'הטבה', copy: 'מחיר מוגבל.' }, { title: 'בונוס', copy: 'מתנה בהרשמה.' }, { title: 'אחריות', copy: 'בלי סיכון.' }, { title: 'מהיר', copy: 'התחלה מיידית.' }, { title: 'פשוט', copy: 'שלושה קליקים.' }, { title: 'תוצאה', copy: 'רואים הבדל.' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page08 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("promote", 7, {
      ...
      cta: 'אני בפנים',
      image: IMG.wellness,
      images: [IMG.wellness, IMG.product, IMG.tech, IMG.product, IMG.tech, IMG.fashion, IMG.ecommerce, IMG.event, IMG.finance, IMG.abstract],
      items: [{ title: 'לחצו', copy: 'בוחרים מסלול.', meta: '01' }, { title: 'נרשמים', copy: 'משאירים פרטים.', meta: '02' }, { title: 'מקבלים', copy: 'הגישה נפתחת.', meta: '03' }, { title: 'מתחילים', copy: 'עובדים.', meta: '04' }, { title: 'צומחים', copy: 'מודדים.', meta: '05' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page09 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("promote", 8, {
      ...
      cta: 'השוו בעצמכם',
      image: IMG.product,
      images: [IMG.product, IMG.tech, IMG.product, IMG.tech, IMG.fashion, IMG.ecommerce, IMG.event, IMG.finance, IMG.abstract, IMG.wellness],
      items: [{ title: 'הטבה', copy: 'מחיר מוגבל.' }, { title: 'בונוס', copy: 'מתנה בהרשמה.' }, { title: 'אחריות', copy: 'בלי סיכון.' }, { title: 'מהיר', copy: 'התחלה מיידית.' }, { title: 'פשוט', copy: 'שלושה קליקים.' }, { title: 'תוצאה', copy: 'רואים הבדל.' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page10 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("promote", 9, {
      ...
      image: IMG.tech,
      images: [IMG.tech, IMG.product, IMG.tech, IMG.fashion, IMG.ecommerce, IMG.event, IMG.finance, IMG.abstract, IMG.wellness, IMG.product],
      items: [{ title: 'לחצו', copy: 'בוחרים מסלול.', meta: '01' }, { title: 'נרשמים', copy: 'משאירים פרטים.', meta: '02' }, { title: 'מקבלים', copy: 'הגישה נפתחת.', meta: '03' }, { title: 'מתחילים', copy: 'עובדים.', meta: '04' }, { title: 'צומחים', copy: 'מודדים.', meta: '05' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
