...
function accountNodes(theme: Theme, _index: number): VisualLibraryNodeTemplate[] {
  return [
    boxNode("bg", { backgroundColor: theme.bg }, absoluteLayout(0, 0, "100%", "100%", 1), "רקע"),
    textNode(
      "eyebrow",
    ...
    textNode(
      "subtitle",
      "פרטי החשבון, גישה מהירה והתנתקות.",
      { color: theme.muted, fontSize: "15px", fontWeight: "600", lineHeight: "1.6" },
      absoluteLayout(64, 124, 520, 40, 2),
    ),
    portalMount(
      "account",
      "portal-account",
      "פאנל חשבון",
      absoluteLayout(64, 180, 720, 640, 3),
      theme,
      { minHeight: "600px" },
    ),
  ];
  ...
  const layouts: Array<() => VisualLibraryNodeTemplate[]> = [
    () => [
      ...
      boxNode(
        ...
        absoluteLayout(620, 170, 420, 460, 2),
        "נתונים",
      ),
      crmFieldText("pl1", "treatments_left", "כמות טיפולים", { color: theme.muted, fontSize: "12px", fontWeight: "800" }, absoluteLayout(652, 210, 340, 22, 3), "label"),
      crmFieldText("pv1", "treatments_left", "4", { color: theme.ink, fontSize: "36px", fontWeight: "900" }, absoluteLayout(652, 240, 340, 48, 3), "value"),
      crmFieldText("pl2", "weight", "משקל", { color: theme.muted, fontSize: "12px", fontWeight: "800" }, absoluteLayout(652, 320, 340, 22, 3), "label"),
      crmFieldText("pv2", "weight", "72", { color: theme.ink, fontSize: "36px", fontWeight: "900" }, absoluteLayout(652, 350, 340, 48, 3), "value"),
      crmFieldText("pl3", "balance", "יתרה", { color: theme.muted, fontSize: "12px", fontWeight: "800" }, absoluteLayout(652, 430, 340, 22, 3), "label"),
      crmFieldText("pv3", "balance", "250", { color: theme.ink, fontSize: "36px", fontWeight: "900" }, absoluteLayout(652, 460, 340, 48, 3), "value"),
    ],
    () => [
      boxNode("bg", { backgroundColor: theme.soft }, absoluteLayout(0, 0, "100%", "100%", 1), "רקע"),
      portalMount(
      ...
      crmFieldText("pl1", "treatments_left", "כמות טיפולים", { color: theme.muted, fontSize: "12px", fontWeight: "800" }, absoluteLayout(460, 170, 280, 22, 3), "label"),
      crmFieldText("pv1", "treatments_left", "4", { color: theme.ink, fontSize: "40px", fontWeight: "900" }, absoluteLayout(460, 198, 280, 52, 3), "value"),
      crmFieldText("pl2", "weight", "משקל", { color: theme.muted, fontSize: "12px", fontWeight: "800" }, absoluteLayout(760, 170, 280, 22, 3), "label"),
      crmFieldText("pv2", "weight", "72", { color: theme.ink, fontSize: "40px", fontWeight: "900" }, absoluteLayout(760, 198, 280, 52, 3), "value"),
      crmFieldText("pl3", "balance", "יתרה", { color: theme.muted, fontSize: "12px", fontWeight: "800" }, absoluteLayout(460, 290, 280, 22, 3), "label"),
      crmFieldText("pv3", "balance", "250", { color: theme.ink, fontSize: "40px", fontWeight: "900" }, absoluteLayout(460, 318, 280, 52, 3), "value"),
      crmFieldText("pl4", "sessions_done", "מפגשים שבוצעו", { color: theme.muted, fontSize: "12px", fontWeight: "800" }, absoluteLayout(760, 290, 280, 22, 3), "label"),
      crmFieldText("pv4", "sessions_done", "8", { color: theme.ink, fontSize: "40px", fontWeight: "900" }, absoluteLayout(760, 318, 280, 52, 3), "value"),
    ...
    () => [
      ...
      textNode(
        "subtitle",
        "משקל · כמות טיפולים · יתרה · מפגשים — כל נתון בנפרד.",
        { color: "#e2e8f0", fontSize: "15px", fontWeight: "600" },
        absoluteLayout(64, 108, 700, 36, 2),
      ),
      crmFieldText("g1l", "treatments_left", "כמות טיפולים", { color: "#cbd5e1", fontSize: "12px", fontWeight: "800" }, absoluteLayout(64, 180, 300, 22, 3), "label"),
      crmFieldText("g1v", "treatments_left", "4", { color: "#f8fafc", fontSize: "44px", fontWeight: "900" }, absoluteLayout(64, 210, 300, 56, 3), "value"),
      crmFieldText("g2l", "weight", "משקל", { color: "#cbd5e1", fontSize: "12px", fontWeight: "800" }, absoluteLayout(404, 180, 300, 22, 3), "label"),
      crmFieldText("g2v", "weight", "72", { color: "#f8fafc", fontSize: "44px", fontWeight: "900" }, absoluteLayout(404, 210, 300, 56, 3), "value"),
      crmFieldText("g3l", "balance", "יתרה", { color: "#cbd5e1", fontSize: "12px", fontWeight: "800" }, absoluteLayout(64, 320, 300, 22, 3), "label"),
      crmFieldText("g3v", "balance", "250", { color: "#f8fafc", fontSize: "44px", fontWeight: "900" }, absoluteLayout(64, 350, 300, 56, 3), "value"),
      crmFieldText("g4l", "sessions_done", "מפגשים שבוצעו", { color: "#cbd5e1", fontSize: "12px", fontWeight: "800" }, absoluteLayout(404, 320, 300, 22, 3), "label"),
      crmFieldText("g4v", "sessions_done", "8", { color: "#f8fafc", fontSize: "44px", fontWeight: "900" }, absoluteLayout(404, 350, 300, 56, 3), "value"),
...
function customDataNodes(theme: Theme, index: number): VisualLibraryNodeTemplate[] {
  const layouts: Array<() => VisualLibraryNodeTemplate[]> = [
    () => [
      ...
      textNode(
        "title",
        "שימי כל נתון איפה שתרצי",
        { color: theme.ink, fontSize: "40px", fontWeight: "900" },
        absoluteLayout(64, 84, 720, 56, 2),
      ),
      textNode(
        "subtitle",
        "כל טקסט בעמוד אפשר לקשר לנתון מה-CRM — בכרטיס, למעלה, למטה או בטבלה.",
        { color: theme.muted, fontSize: "15px", fontWeight: "600", lineHeight: "1.7" },
        absoluteLayout(64, 150, 640, 56, 2),
      ),
      boxNode(
        "card1",
        {
        ...
        absoluteLayout(64, 230, 300, 160, 2),
        "כרטיס",
      ),
      crmFieldText(
        "l1",
        "treatments_left",
        "כמות טיפולים",
        { color: theme.muted, fontSize: "12px", fontWeight: "800" },
        absoluteLayout(88, 258, 240, 22, 3),
        "label",
        "תווית נתון",
      ),
      crmFieldText(
        ...
        "4",
        { color: theme.ink, fontSize: "42px", fontWeight: "900" },
        absoluteLayout(88, 300, 240, 56, 3),
        "value",
        "ערך נתון",
      ),
      boxNode(
        ...
        absoluteLayout(396, 230, 300, 160, 2),
        "כרטיס",
      ),
      crmFieldText(
        "l2",
        ...
        "משקל",
        { color: theme.muted, fontSize: "12px", fontWeight: "800" },
        absoluteLayout(420, 258, 240, 22, 3),
        "label",
      ),
      crmFieldText(
        "v2",
        ...
        "72",
        { color: theme.ink, fontSize: "42px", fontWeight: "900" },
        absoluteLayout(420, 300, 240, 56, 3),
        "value",
      ),
      boxNode(
        "table",
        ...
        absoluteLayout(64, 420, 980, 220, 2),
        "טבלה",
      ),
      ...tableRow("th", 64, 420, 980, theme, ["נתון", "ערך", "מקור", "סטטוס"], true),
      crmFieldText("tr1l", "balance", "יתרה", { color: theme.ink, fontSize: "14px", fontWeight: "800" }, absoluteLayout(88, 478, 180, 28, 3), "label"),
      crmFieldText("tr1v", "balance", "250", { color: theme.ink, fontSize: "14px", fontWeight: "900" }, absoluteLayout(320, 478, 120, 28, 3), "value"),
      textNode("tr1s", "CRM", { color: theme.muted, fontSize: "13px", fontWeight: "700" }, absoluteLayout(520, 478, 140, 28, 3)),
      textNode("tr1st", "מעודכן", { color: theme.accent, fontSize: "13px", fontWeight: "800" }, absoluteLayout(760, 478, 140, 28, 3)),
      crmFieldText("tr2l", "sessions_done", "מפגשים שבוצעו", { color: theme.ink, fontSize: "14px", fontWeight: "800" }, absoluteLayout(88, 526, 180, 28, 3), "label"),
      crmFieldText("tr2v", "sessions_done", "8", { color: theme.ink, fontSize: "14px", fontWeight: "900" }, absoluteLayout(320, 526, 120, 28, 3), "value"),
      textNode("tr2s", "CRM", { color: theme.muted, fontSize: "13px", fontWeight: "700" }, absoluteLayout(520, 526, 140, 28, 3)),
      textNode("tr2st", "מעודכן", { color: theme.accent, fontSize: "13px", fontWeight: "800" }, absoluteLayout(760, 526, 140, 28, 3)),
    ],
    () => [
      boxNode("bg", { backgroundColor: theme.soft }, absoluteLayout(0, 0, "100%", "100%", 1), "רקע"),
      textNode(
        ...
        "מדדים בראש העמוד",
        { color: theme.ink, fontSize: "36px", fontWeight: "900" },
        absoluteLayout(64, 48, 600, 48, 2),
      ),
      crmFieldText("top1l", "treatments_left", "כמות טיפולים", { color: theme.muted, fontSize: "12px", fontWeight: "800" }, absoluteLayout(64, 120, 220, 22, 2), "label"),
      crmFieldText("top1v", "treatments_left", "4", { color: theme.ink, fontSize: "48px", fontWeight: "900" }, absoluteLayout(64, 148, 220, 60, 2), "value"),
      crmFieldText("top2l", "weight", "משקל", { color: theme.muted, fontSize: "12px", fontWeight: "800" }, absoluteLayout(320, 120, 220, 22, 2), "label"),
      crmFieldText("top2v", "weight", "72", { color: theme.ink, fontSize: "48px", fontWeight: "900" }, absoluteLayout(320, 148, 220, 60, 2), "value"),
      crmFieldText("top3l", "balance", "יתרה", { color: theme.muted, fontSize: "12px", fontWeight: "800" }, absoluteLayout(576, 120, 220, 22, 2), "label"),
      crmFieldText("top3v", "balance", "250", { color: theme.ink, fontSize: "48px", fontWeight: "900" }, absoluteLayout(576, 148, 220, 60, 2), "value"),
      crmFieldText("top4l", "sessions_done", "מפגשים", { color: theme.muted, fontSize: "12px", fontWeight: "800" }, absoluteLayout(832, 120, 200, 22, 2), "label"),
      crmFieldText("top4v", "sessions_done", "8", { color: theme.ink, fontSize: "48px", fontWeight: "900" }, absoluteLayout(832, 148, 200, 60, 2), "value"),
      textNode(
        "hint",
        "בחרי כל טקסט בעורך → «נתון CRM» כדי לקשר אותו לשדה מתיק הלקוח.",
        { color: theme.muted, fontSize: "15px", fontWeight: "600" },
        absoluteLayout(64, 260, 900, 40, 2),
      ),
      portalMount(
        "account",
        "portal-account",
        "חשבון",
        absoluteLayout(64, 320, 420, 320, 3),
        theme,
        { minHeight: "300px" },
      ),
    ],
    () => [
      ...
      textNode(
        ...
        absoluteLayout(64, 56, 640, 50, 2),
      ),
      crmFieldText(
        "inline",
        "treatments_left",
        "כמות טיפולים: 4",
        { color: "#f8fafc", fontSize: "22px", fontWeight: "800" },
        absoluteLayout(64, 140, 480, 40, 2),
        "both",
      ),
      crmFieldText(
        "inline2",
        ...
        "יתרה: 250",
        { color: "#f8fafc", fontSize: "22px", fontWeight: "800" },
        absoluteLayout(64, 200, 480, 40, 2),
        "both",
      ),
      crmFieldText(
        "inline3",
        ...
        "משקל: 72",
        { color: "#f8fafc", fontSize: "22px", fontWeight: "800" },
        absoluteLayout(64, 260, 480, 40, 2),
        "both",
      ),
      textNode(
        "foot",
        "בלי בלוק עיצוב קבוע — רק הנתונים שחשובים לך, בדיוק איפה ששמת.",
        { color: "#cbd5e1", fontSize: "15px", fontWeight: "600" },
        absoluteLayout(64, 360, 700, 48, 2),
      ),
    ],
  ];
  return layouts[index % layouts.length]();
...
function buildCustomDataSections(): VisualLibrarySectionTemplate[] {
  return THEMES.map((theme, index) =>
    makeSection(
      ...
      "נתונים בודדים מה-CRM שניתן למקם בכל מקום בעמוד",
      [
        "custom-data",
        "נתונים משתנים",
        "portal-custom-data",
