...
const page01 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("faq", 0, {
      ...
      cta: 'לא מצאתם תשובה?',
      image: IMG.education,
      images: [IMG.education, IMG.office, IMG.workspace, IMG.tech, IMG.finance, IMG.tech, IMG.abstract, IMG.wellness, IMG.education, IMG.office],
...
const page02 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("faq", 1, {
      ...
      cta: 'חיפוש תשובה',
      image: IMG.office,
      images: [IMG.office, IMG.workspace, IMG.tech, IMG.finance, IMG.tech, IMG.abstract, IMG.wellness, IMG.education, IMG.office, IMG.education],
...
const page03 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("faq", 2, {
      ...
      cta: 'בחרו נושא',
      image: IMG.workspace,
      images: [IMG.workspace, IMG.tech, IMG.finance, IMG.tech, IMG.abstract, IMG.wellness, IMG.education, IMG.office, IMG.education, IMG.office],
      items: [{ title: 'איך מתחילים?', copy: 'נרשמים ובוחרים תבנית.' }, { title: 'יש ניסיון?', copy: 'כן, 14 יום.' }, { title: 'צריך כרטיס?', copy: 'לא לשלב הניסיון.' }, { title: 'אפשר לבטל?', copy: 'בכל רגע.' }, { title: 'יש תמיכה?', copy: 'צ׳אט ומייל.' }, { title: 'מה עם דומיין?', copy: 'אפשר לחבר.' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page04 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("faq", 3, {
      ...
      cta: 'פתחו קריאה',
      image: IMG.tech,
      images: [IMG.tech, IMG.finance, IMG.tech, IMG.abstract, IMG.wellness, IMG.education, IMG.office, IMG.education, IMG.office, IMG.workspace],
      items: [{ title: 'שאלה', copy: 'פותחים נושא.', meta: '01' }, { title: 'חיפוש', copy: 'מוצאים תשובה.', meta: '02' }, { title: 'הבנה', copy: 'מיישמים.', meta: '03' }, { title: 'עזרה', copy: 'אם צריך — פונים.', meta: '04' }, { title: 'פתרון', copy: 'חוזרים לעבודה.', meta: '05' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page05 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("faq", 4, {
      ...
      cta: 'שאלו אותנו',
      image: IMG.finance,
      images: [IMG.finance, IMG.tech, IMG.abstract, IMG.wellness, IMG.education, IMG.office, IMG.education, IMG.office, IMG.workspace, IMG.tech],
      items: [{ title: 'איך מתחילים?', copy: 'נרשמים ובוחרים תבנית.' }, { title: 'יש ניסיון?', copy: 'כן, 14 יום.' }, { title: 'צריך כרטיס?', copy: 'לא לשלב הניסיון.' }, { title: 'אפשר לבטל?', copy: 'בכל רגע.' }, { title: 'יש תמיכה?', copy: 'צ׳אט ומייל.' }, { title: 'מה עם דומיין?', copy: 'אפשר לחבר.' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page06 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("faq", 5, {
      ...
      cta: 'להתחלה מהירה',
      image: IMG.tech,
      images: [IMG.tech, IMG.abstract, IMG.wellness, IMG.education, IMG.office, IMG.education, IMG.office, IMG.workspace, IMG.tech, IMG.finance],
      items: [{ title: 'שאלה', copy: 'פותחים נושא.', meta: '01' }, { title: 'חיפוש', copy: 'מוצאים תשובה.', meta: '02' }, { title: 'הבנה', copy: 'מיישמים.', meta: '03' }, { title: 'עזרה', copy: 'אם צריך — פונים.', meta: '04' }, { title: 'פתרון', copy: 'חוזרים לעבודה.', meta: '05' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page07 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("faq", 6, {
      ...
      cta: 'כתבו לנו',
      image: IMG.abstract,
      images: [IMG.abstract, IMG.wellness, IMG.education, IMG.office, IMG.education, IMG.office, IMG.workspace, IMG.tech, IMG.finance, IMG.tech],
      items: [{ title: 'איך מתחילים?', copy: 'נרשמים ובוחרים תבנית.' }, { title: 'יש ניסיון?', copy: 'כן, 14 יום.' }, { title: 'צריך כרטיס?', copy: 'לא לשלב הניסיון.' }, { title: 'אפשר לבטל?', copy: 'בכל רגע.' }, { title: 'יש תמיכה?', copy: 'צ׳אט ומייל.' }, { title: 'מה עם דומיין?', copy: 'אפשר לחבר.' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page08 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("faq", 7, {
      ...
      cta: 'עוד פרטים',
      image: IMG.wellness,
      images: [IMG.wellness, IMG.education, IMG.office, IMG.education, IMG.office, IMG.workspace, IMG.tech, IMG.finance, IMG.tech, IMG.abstract],
      items: [{ title: 'שאלה', copy: 'פותחים נושא.', meta: '01' }, { title: 'חיפוש', copy: 'מוצאים תשובה.', meta: '02' }, { title: 'הבנה', copy: 'מיישמים.', meta: '03' }, { title: 'עזרה', copy: 'אם צריך — פונים.', meta: '04' }, { title: 'פתרון', copy: 'חוזרים לעבודה.', meta: '05' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page09 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("faq", 8, {
      ...
      cta: 'למדריכים',
      image: IMG.education,
      images: [IMG.education, IMG.office, IMG.education, IMG.office, IMG.workspace, IMG.tech, IMG.finance, IMG.tech, IMG.abstract, IMG.wellness],
      items: [{ title: 'איך מתחילים?', copy: 'נרשמים ובוחרים תבנית.' }, { title: 'יש ניסיון?', copy: 'כן, 14 יום.' }, { title: 'צריך כרטיס?', copy: 'לא לשלב הניסיון.' }, { title: 'אפשר לבטל?', copy: 'בכל רגע.' }, { title: 'יש תמיכה?', copy: 'צ׳אט ומייל.' }, { title: 'מה עם דומיין?', copy: 'אפשר לחבר.' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page10 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("faq", 9, {
      ...
      cta: 'שלחו שאלה',
      image: IMG.office,
      images: [IMG.office, IMG.education, IMG.office, IMG.workspace, IMG.tech, IMG.finance, IMG.tech, IMG.abstract, IMG.wellness, IMG.education],
      items: [{ title: 'שאלה', copy: 'פותחים נושא.', meta: '01' }, { title: 'חיפוש', copy: 'מוצאים תשובה.', meta: '02' }, { title: 'הבנה', copy: 'מיישמים.', meta: '03' }, { title: 'עזרה', copy: 'אם צריך — פונים.', meta: '04' }, { title: 'פתרון', copy: 'חוזרים לעבודה.', meta: '05' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
