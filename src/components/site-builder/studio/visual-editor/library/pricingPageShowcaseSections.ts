...
const page01 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("pricing", 0, {
      ...
      image: IMG.finance,
      images: [IMG.finance, IMG.tech, IMG.office, IMG.product, IMG.finance, IMG.tech, IMG.abstract, IMG.wellness, IMG.tech, IMG.office],
...
const page02 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("pricing", 1, {
      ...
      cta: 'השוואה מלאה',
      image: IMG.tech,
      images: [IMG.tech, IMG.office, IMG.product, IMG.finance, IMG.tech, IMG.abstract, IMG.wellness, IMG.tech, IMG.office, IMG.finance],
...
const page03 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("pricing", 2, {
      ...
      cta: 'התחילו ניסיון',
      image: IMG.office,
      images: [IMG.office, IMG.product, IMG.finance, IMG.tech, IMG.abstract, IMG.wellness, IMG.tech, IMG.office, IMG.finance, IMG.tech],
      items: [{ title: 'Basic', copy: 'להתחלה.' }, { title: 'Plus', copy: 'לצמיחה.' }, { title: 'Pro', copy: 'לעסקים.' }, { title: 'שנתי', copy: 'חיסכון.' }, { title: 'חודשי', copy: 'גמיש.' }, { title: 'מותאם', copy: 'לפי צורך.' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page04 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("pricing", 3, {
      ...
      cta: 'שדרגו ל-Pro',
      image: IMG.product,
      images: [IMG.product, IMG.finance, IMG.tech, IMG.abstract, IMG.wellness, IMG.tech, IMG.office, IMG.finance, IMG.tech, IMG.office],
      items: [{ title: 'בחירה', copy: 'מסלול.', meta: '01' }, { title: 'ניסיון', copy: '14 יום.', meta: '02' }, { title: 'הפעלה', copy: 'מיידית.', meta: '03' }, { title: 'שימוש', copy: 'כל הכלים.', meta: '04' }, { title: 'שדרוג', copy: 'בכל רגע.', meta: '05' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page05 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("pricing", 4, {
      ...
      cta: 'בחרו מסלול',
      image: IMG.finance,
      images: [IMG.finance, IMG.tech, IMG.abstract, IMG.wellness, IMG.tech, IMG.office, IMG.finance, IMG.tech, IMG.office, IMG.product],
      items: [{ title: 'Basic', copy: 'להתחלה.' }, { title: 'Plus', copy: 'לצמיחה.' }, { title: 'Pro', copy: 'לעסקים.' }, { title: 'שנתי', copy: 'חיסכון.' }, { title: 'חודשי', copy: 'גמיש.' }, { title: 'מותאם', copy: 'לפי צורך.' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page06 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("pricing", 5, {
      ...
      cta: 'הצטרפו',
      image: IMG.tech,
      images: [IMG.tech, IMG.abstract, IMG.wellness, IMG.tech, IMG.office, IMG.finance, IMG.tech, IMG.office, IMG.product, IMG.finance],
      items: [{ title: 'בחירה', copy: 'מסלול.', meta: '01' }, { title: 'ניסיון', copy: '14 יום.', meta: '02' }, { title: 'הפעלה', copy: 'מיידית.', meta: '03' }, { title: 'שימוש', copy: 'כל הכלים.', meta: '04' }, { title: 'שדרוג', copy: 'בכל רגע.', meta: '05' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page07 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("pricing", 6, {
      ...
      cta: 'עוד פרטים',
      image: IMG.abstract,
      images: [IMG.abstract, IMG.wellness, IMG.tech, IMG.office, IMG.finance, IMG.tech, IMG.office, IMG.product, IMG.finance, IMG.tech],
      items: [{ title: 'Basic', copy: 'להתחלה.' }, { title: 'Plus', copy: 'לצמיחה.' }, { title: 'Pro', copy: 'לעסקים.' }, { title: 'שנתי', copy: 'חיסכון.' }, { title: 'חודשי', copy: 'גמיש.' }, { title: 'מותאם', copy: 'לפי צורך.' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page08 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("pricing", 7, {
      ...
      cta: 'התחילו עכשיו',
      image: IMG.wellness,
      images: [IMG.wellness, IMG.tech, IMG.office, IMG.finance, IMG.tech, IMG.office, IMG.product, IMG.finance, IMG.tech, IMG.abstract],
      items: [{ title: 'בחירה', copy: 'מסלול.', meta: '01' }, { title: 'ניסיון', copy: '14 יום.', meta: '02' }, { title: 'הפעלה', copy: 'מיידית.', meta: '03' }, { title: 'שימוש', copy: 'כל הכלים.', meta: '04' }, { title: 'שדרוג', copy: 'בכל רגע.', meta: '05' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page09 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("pricing", 8, {
      ...
      cta: 'חשבו חיסכון',
      image: IMG.tech,
      images: [IMG.tech, IMG.office, IMG.finance, IMG.tech, IMG.office, IMG.product, IMG.finance, IMG.tech, IMG.abstract, IMG.wellness],
      items: [{ title: 'Basic', copy: 'להתחלה.' }, { title: 'Plus', copy: 'לצמיחה.' }, { title: 'Pro', copy: 'לעסקים.' }, { title: 'שנתי', copy: 'חיסכון.' }, { title: 'חודשי', copy: 'גמיש.' }, { title: 'מותאם', copy: 'לפי צורך.' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
...
const page10 = (() => {
  ...
  return makePageSection({
    ...
    nodes: buildCategoryPageNodes("pricing", 9, {
      ...
      cta: 'בקשו הצעה',
      image: IMG.office,
      images: [IMG.office, IMG.finance, IMG.tech, IMG.office, IMG.product, IMG.finance, IMG.tech, IMG.abstract, IMG.wellness, IMG.tech],
      items: [{ title: 'בחירה', copy: 'מסלול.', meta: '01' }, { title: 'ניסיון', copy: '14 יום.', meta: '02' }, { title: 'הפעלה', copy: 'מיידית.', meta: '03' }, { title: 'שימוש', copy: 'כל הכלים.', meta: '04' }, { title: 'שדרוג', copy: 'בכל רגע.', meta: '05' }],
      stats: [{ value: '98%', label: 'שביעות רצון' }, { value: '3x', label: 'צמיחה' }, { value: '14', label: 'ימים' }, { value: '5★', label: 'דירוג' }],
    }),
  });
