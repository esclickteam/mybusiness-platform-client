    ...
    <div className="pointer-events-none absolute bottom-4 left-4 z-[60]" dir="rtl">
      {!open ? (
        <button
          ...
          className="pointer-events-auto inline-flex items-center gap-2 rounded-full bg-violet-600 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-violet-600/30 hover:bg-violet-500"
        >
