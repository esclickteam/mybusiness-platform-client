...
<article class="rounded-[34px] border border-white/10 bg-white/8 p-7 text-white shadow-[0_24px_80px_rgba(0,0,0,0.12)]" data-bizuply-block="review-card" data-editable-card="true">
  <div class="flex items-center justify-between gap-4">
    ...
    <span class="rounded-full bg-white/10 px-4 py-2 text-xs font-black text-black/70" data-editable-text="true">
      5.0
    </span>
  </div>
  ...
  <div class="mt-7 flex items-center gap-4">
    ...
    <div>
      ...
      <p class="mt-1 text-xs font-bold text-black/45" data-editable-text="true">${meta}</p>
    </div>
  </div>
</article>
`;
