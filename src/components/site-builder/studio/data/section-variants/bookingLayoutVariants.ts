...
function calendarMock() {
  return `
<div class="${softCardClass} relative min-h-[420px] overflow-hidden" data-bizuply-plugin="booking" data-bizuply-widget="booking" data-bizuply-booking-mount="true" data-bizuply-crm-calendar="true" data-bizuply-booking-variant="month" data-bizuply-booking-frame="true" data-editable-card="true" style="min-height:420px">
  ...
  <a
    href="#booking"
    class="mt-7 flex min-h-14 items-center justify-center rounded-2xl bg-gradient-to-l from-[var(--biz-primary,#7C3AED)] to-[var(--biz-accent,#EC4899)] px-8 text-sm font-black text-black shadow-xl"
...
<div class="${softCardClass}" data-bizuply-block="booking-form" data-editable-card="true">
  ...
  <form class="mt-7 grid gap-4" data-bizuply-block="lead-form">
    ...
    <button class="inline-flex min-h-[56px] items-center justify-center rounded-2xl bg-gradient-to-l from-[var(--biz-primary,#7C3AED)] to-[var(--biz-accent,#EC4899)] px-8 text-sm font-black text-black shadow-xl" type="button">
      ${buttonText}
    </button>
  </form>
</div>
