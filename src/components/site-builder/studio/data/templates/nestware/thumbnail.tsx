...
export default function NestwareThumbnail() {
  return (
    <div className="relative flex h-full min-h-[260px] w-full flex-col justify-between overflow-hidden p-5 text-right" style={{ background: "#F0FDFA", color: "#134E4A", fontFamily: "Heebo, sans-serif" }}>
      ...
      <div className="relative">
        <div className="inline-flex px-2 py-1 text-[10px] font-black uppercase tracking-[0.2em]" style={{ background: "#0F766E", color: "#F0FDFA" }}>מוצרי בית</div>
        <h3 className="mt-4 text-3xl font-black leading-none" style={{ fontFamily: "DM Serif Display, serif" }}>Nestware</h3>
        <p className="mt-2 text-xs font-semibold opacity-70">הבית מסודר יפה יותר.</p>
      </div>
