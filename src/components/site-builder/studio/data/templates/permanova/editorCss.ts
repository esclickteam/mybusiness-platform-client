...
[data-template-id="permanova"] .t-ken { animation: permanova-ken 18s ease-in-out infinite alternate; }
[data-template-id="permanova"] .t-anim,
[data-template-id="permanova"] .t-anim { animation: permanova-up 0.9s cubic-bezier(0.22,1,0.36,1) both; }
[data-template-id="permanova"] .t-d1,
[data-template-id="permanova"] .t-d1 { animation-delay: .12s; }
[data-template-id="permanova"] .t-d2,
[data-template-id="permanova"] .t-d2 { animation-delay: .24s; }
[data-template-id="permanova"] .t-d3,
[data-template-id="permanova"] .t-d3 { animation-delay: .36s; }
[data-template-id="permanova"] .t-fade,
[data-template-id="permanova"] .t-fade { animation: permanova-fade 1s ease both; }
[data-template-id="permanova"] .t-marquee,
[data-template-id="permanova"] .t-marquee { animation: permanova-marquee 30s linear infinite; width: max-content; }
[data-template-id="permanova"] .t-float,
[data-template-id="permanova"] .t-float { animation: permanova-float 6s ease-in-out infinite; }
[data-template-id="permanova"] .t-pulse,
[data-template-id="permanova"] .t-pulse { animation: permanova-pulse 2.8s ease-in-out infinite; }
...
[data-template-id="permanova"] .t-glow { animation: permanova-glow 3.2s ease-in-out infinite; }
[data-template-id="permanova"] .t-scalein,
[data-template-id="permanova"] .t-scalein { animation: permanova-scalein 0.8s cubic-bezier(0.22,1,0.36,1) both; }
...
[data-template-id="permanova"] .t-hover:hover { transform: translateY(-5px); }
...
@media (prefers-reduced-motion: reduce) {
  ...
  [data-template-id="permanova"] .t-scalein,
  [data-template-id="permanova"] .t-fade,
  [data-template-id="permanova"] .t-fade { animation: none !important; }
}
`;
