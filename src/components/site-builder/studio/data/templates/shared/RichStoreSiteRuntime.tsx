    ...
    if (pageId === "contact") {
      return (
        <div>
          ...
          <section {...sectionProps("contact-rich-form", "contact", "טופס")} className={skin.alt + " px-5 py-16 lg:px-8"}><form className={cx("mx-auto grid max-w-3xl gap-3 border p-6", skin.card)} onSubmit={(e) => e.preventDefault()}><input className={cx("border px-4 py-3 text-sm", skin.input)} placeholder="שם מלא" /><input className={cx("border px-4 py-3 text-sm", skin.input)} placeholder="טלפון" /><input className={cx("border px-4 py-3 text-sm", skin.input)} placeholder="אימייל" /><textarea className={cx("min-h-32 border px-4 py-3 text-sm", skin.input)} placeholder="הודעה" /><button type="submit" className={cx("text-sm font-black", skin.button)}>{g("contactButton")}</button></form></section>
