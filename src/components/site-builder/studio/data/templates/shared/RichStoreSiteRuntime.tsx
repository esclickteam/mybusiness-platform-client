        ...
        <div className={cx("mx-auto grid max-w-7xl items-center gap-8 border p-8 md:grid-cols-2 lg:p-12", skin.softCard)}>
          ...
          <form
            className="flex flex-col gap-3 sm:flex-row"
             data-bizuply-block="lead-form" data-bizuply-form-id="shared-newsletter-1" data-bizuply-crm-lead="true" data-bizuply-success-message="תודה! קיבלנו את הפנייה ונחזור אליכם בהקדם." 
          >
    ...
    if (pageId === "contact") {
      return (
        <div>
          ...
          <section {...sectionProps("contact-rich-form", "contact", "טופס")} className={skin.alt + " px-5 py-16 lg:px-8"}><form className={cx("mx-auto grid max-w-3xl gap-3 border p-6", skin.card)}  data-bizuply-block="lead-form" data-bizuply-form-id="shared-contact-2" data-bizuply-crm-lead="true" data-bizuply-success-message="תודה! קיבלנו את הפנייה ונחזור אליכם בהקדם." ><input name="name" data-bizuply-form-field-id="name" autoComplete="name"  className={cx("border px-4 py-3 text-sm", skin.input)} placeholder="שם מלא" /><input name="phone" data-bizuply-form-field-id="phone" type="tel" autoComplete="tel"  className={cx("border px-4 py-3 text-sm", skin.input)} placeholder="טלפון" /><input name="email" data-bizuply-form-field-id="email" type="email" autoComplete="email"  className={cx("border px-4 py-3 text-sm", skin.input)} placeholder="אימייל" /><textarea name="message" data-bizuply-form-field-id="message"  className={cx("min-h-32 border px-4 py-3 text-sm", skin.input)} placeholder="הודעה" /><button type="submit" className={cx("text-sm font-black", skin.button)}>{g("contactButton")}</button></form></section>
