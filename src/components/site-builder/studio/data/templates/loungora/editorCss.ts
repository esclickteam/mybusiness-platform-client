...
[data-template-id="loungora"], [data-template-id="loungora-preview"] {
  --p: #5B21B6;
  --accent: #C4B5FD;
  --on-p: #F5F3FF;
  --bg: #FAF5FF;
...
[data-template-id="loungora-preview"] .store-display {
  font-family: "Literata", "Heebo", serif;
}
[data-template-id="loungora"] .store-card,
[data-template-id="loungora-preview"] .store-card {
...
[data-template-id="loungora-preview"] .store-card:hover {
  transform: translateY(-8px);
  box-shadow: 0 24px 60px rgba(0,0,0,0.18);
  border-color: var(--p);
}
[data-template-id="loungora"] .store-marquee,
[data-template-id="loungora-preview"] .store-marquee {
