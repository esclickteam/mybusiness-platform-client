      ...
      <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-4">
        {steps.map(([t,d],i) => (
          <div key={t} className="tpl-climb border-t pt-4" style={{ borderColor: "#c9a962", animationDelay: `${i*0.1}s` }}>
            ...
            <h3 className="mt-2 font-bold">{t}</h3><p className="mt-1 text-sm" style={{ color: "#8b9cb5" }}>{tx(d)}</p>
          </div>
        ))}
      </div>
    </section>
...
export default function BrokeriaPages({
  ...
  return (
    <div dir={templateDir()} data-template-id="brokeria" className="min-h-screen w-full overflow-x-hidden"
