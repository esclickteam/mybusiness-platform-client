...
[data-template-id="brokeria"] .tpl-ken, [data-template-id="brokeria"] .tpl-ken {
  animation: brokeria-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="brokeria"] .tpl-rise, [data-template-id="brokeria"] .tpl-rise {
  animation: brokeria-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="brokeria"] .tpl-rise-2, [data-template-id="brokeria"] .tpl-rise-2 {
  animation: brokeria-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="brokeria"] .tpl-rise-3, [data-template-id="brokeria"] .tpl-rise-3 {
  animation: brokeria-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="brokeria"] .tpl-marquee-track, [data-template-id="brokeria"] .tpl-marquee-track {
  display: flex; width: max-content; animation: brokeria-marquee 28s linear infinite;
}
[data-template-id="brokeria"] .tpl-float, [data-template-id="brokeria"] .tpl-float {
  animation: brokeria-float 5s ease-in-out infinite;
}
[data-template-id="brokeria"] .tpl-sweep, [data-template-id="brokeria"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="brokeria"] .tpl-sweep::after, [data-template-id="brokeria"] .tpl-sweep::after {
...
[data-template-id="brokeria"] .tpl-climb, [data-template-id="brokeria"] .tpl-climb {
...
[data-template-id="brokeria"] .tpl-prop-ticker, [data-template-id="brokeria"] .tpl-prop-ticker { display:flex;width:max-content;animation:brokeria-ticker 35s linear infinite; }
[data-template-id="brokeria"] .tpl-zoom-card:hover img, [data-template-id="brokeria"] .tpl-zoom-card:hover img { transform:scale(1.1); }
@keyframes brokeria-testi { to { transform:translateX(-50%); } }
[data-template-id="brokeria"] .tpl-testi-track, [data-template-id="brokeria"] .tpl-testi-track {
