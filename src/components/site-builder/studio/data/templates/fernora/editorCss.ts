...
[data-template-id="fernora"], [data-template-id="fernora-preview"] {
  --p: #15803D;
  --accent: #86EFAC;
  --on-p: #F0FDF4;
  --bg: #F3FAF4;
...
[data-template-id="fernora-preview"] .store-display {
  font-family: "Cormorant Garamond", "Heebo", serif;
}
[data-template-id="fernora"] .store-card,
[data-template-id="fernora-preview"] .store-card {
...
[data-template-id="fernora-preview"] .store-card:hover {
  transform: translateY(-8px);
  box-shadow: 0 24px 60px rgba(0,0,0,0.18);
  border-color: var(--p);
}
[data-template-id="fernora"] .store-marquee,
[data-template-id="fernora-preview"] .store-marquee {
