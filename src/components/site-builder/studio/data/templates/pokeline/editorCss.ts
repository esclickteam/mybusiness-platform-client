...
[data-template-id="pokeline"] .tpl-ken, [data-template-id="pokeline"] .tpl-ken {
  animation: pokeline-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="pokeline"] .tpl-rise, [data-template-id="pokeline"] .tpl-rise {
  animation: pokeline-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="pokeline"] .tpl-rise-2, [data-template-id="pokeline"] .tpl-rise-2 {
  animation: pokeline-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="pokeline"] .tpl-rise-3, [data-template-id="pokeline"] .tpl-rise-3 {
...
[data-template-id="pokeline"] .tpl-orbit, [data-template-id="pokeline"] .tpl-orbit { animation: pokeline-orbit 36s linear infinite; }
