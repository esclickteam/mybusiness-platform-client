...
export default function LoteraThumbnail() {
  ...
  return (
    <div dir={getTextDirection(i18n.language)} className="relative h-full min-h-[260px] w-full overflow-hidden" style={{ background: "#07131f", color: "#eef5fb" }}>
      ...
      <div className="absolute bottom-20 right-5 left-5">
        <p className="text-[9px] font-bold tracking-[0.24em]" style={{ color: "#5eb4ff" }}>{tx("נדל״ן יוקרה · חוף")}</p>
        <h3 className="mt-2 text-4xl font-bold leading-none" style={{ fontFamily: '"Frank Ruhl Libre"' }}>{tx("הבית נפתח אל הים.")}</h3>
      </div>
