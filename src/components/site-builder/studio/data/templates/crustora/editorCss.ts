...
[data-template-id="crustora"], [data-template-id="crustora-preview"] {
...
[data-template-id="crustora-preview"] .tpl-display {
...
[data-template-id="crustora"] .tpl-ken, [data-template-id="crustora-preview"] .tpl-ken {
  animation: crustora-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="crustora"] .tpl-rise, [data-template-id="crustora-preview"] .tpl-rise {
  animation: crustora-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="crustora"] .tpl-rise-2, [data-template-id="crustora-preview"] .tpl-rise-2 {
  animation: crustora-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="crustora"] .tpl-rise-3, [data-template-id="crustora-preview"] .tpl-rise-3 {
  animation: crustora-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="crustora"] .tpl-marquee-track, [data-template-id="crustora-preview"] .tpl-marquee-track {
  display: flex; width: max-content; animation: crustora-marquee 28s linear infinite;
}
[data-template-id="crustora"] .tpl-float, [data-template-id="crustora-preview"] .tpl-float {
  animation: crustora-float 5s ease-in-out infinite;
}
[data-template-id="crustora"] .tpl-sweep, [data-template-id="crustora-preview"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="crustora"] .tpl-sweep::after, [data-template-id="crustora-preview"] .tpl-sweep::after {
...
[data-template-id="crustora"] .tpl-climb, [data-template-id="crustora-preview"] .tpl-climb {
...
[data-template-id="crustora"] .tpl-pizza-spin, [data-template-id="crustora-preview"] .tpl-pizza-spin {
  animation: crustora-pizza-spin 28s linear infinite;
}
[data-template-id="crustora"] .tpl-flour, [data-template-id="crustora-preview"] .tpl-flour {
  animation: crustora-flour var(--flour-dur, 8s) linear infinite;
}
[data-template-id="crustora"] .tpl-heat-shimmer, [data-template-id="crustora-preview"] .tpl-heat-shimmer {
  animation: crustora-heat-shimmer 2.6s ease-in-out infinite;
}
[data-template-id="crustora"] .tpl-stretch-under, [data-template-id="crustora-preview"] .tpl-stretch-under {
  transform-origin: right center; animation: crustora-stretch-line 1.2s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="crustora"] .tpl-tri-card, [data-template-id="crustora-preview"] .tpl-tri-card {
