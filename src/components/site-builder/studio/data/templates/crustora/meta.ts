...
export const crustoraSeed = {
  ...
  blocks: [
    ...
    { type: "process", variant: "crust-process-steps", title: "Crust process steps" },
    { type: "gallery", variant: "crust-gallery", title: "Crust gallery" },
    { type: "reviews", variant: "crust-reviews", title: "Crust reviews" },
    { type: "stats", variant: "oven-stats-hours", title: "Oven stats + hours" },
    { type: "cta", variant: "crust-home-cta", title: "Home CTA teaser" },
    { type: "pizzasPage", variant: "full-pizza-menu", title: "Full pizza menu page" },
    { type: "ovenPage", variant: "oven-story", title: "Oven story page" },
    { type: "about", variant: "flour-timeline-chef", title: "Flour timeline + chef" },
