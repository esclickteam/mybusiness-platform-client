...
[data-template-id="mezzaline"] .tpl-ken, [data-template-id="mezzaline"] .tpl-ken {
  animation: mezzaline-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="mezzaline"] .tpl-rise, [data-template-id="mezzaline"] .tpl-rise {
  animation: mezzaline-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="mezzaline"] .tpl-rise-2, [data-template-id="mezzaline"] .tpl-rise-2 {
  animation: mezzaline-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="mezzaline"] .tpl-rise-3, [data-template-id="mezzaline"] .tpl-rise-3 {
  animation: mezzaline-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="mezzaline"] .tpl-marquee-track, [data-template-id="mezzaline"] .tpl-marquee-track {
  display: flex; width: max-content; animation: mezzaline-marquee 28s linear infinite;
}
[data-template-id="mezzaline"] .tpl-float, [data-template-id="mezzaline"] .tpl-float {
  animation: mezzaline-float 5s ease-in-out infinite;
}
[data-template-id="mezzaline"] .tpl-sweep, [data-template-id="mezzaline"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="mezzaline"] .tpl-sweep::after, [data-template-id="mezzaline"] .tpl-sweep::after {
...
[data-template-id="mezzaline"] .tpl-climb, [data-template-id="mezzaline"] .tpl-climb {
...
[data-template-id="mezzaline"] .tpl-olive, [data-template-id="mezzaline"] .tpl-olive {
  animation: mezzaline-olive-float 6s ease-in-out infinite;
}
[data-template-id="mezzaline"] .tpl-platter-rail, [data-template-id="mezzaline"] .tpl-platter-rail {
...
[data-template-id="mezzaline"] .tpl-branch-under, [data-template-id="mezzaline"] .tpl-branch-under {
