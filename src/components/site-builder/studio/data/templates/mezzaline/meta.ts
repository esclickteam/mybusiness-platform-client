...
export const mezzalineSeed = {
  ...
  blocks: [
    ...
    { type: "quote", variant: "parchment-quote-band", title: "Parchment quote band" },
    { type: "about", variant: "botanical-garden", title: "Botanical about" },
    { type: "contact", variant: "garden-table-form", title: "Garden table contact" },
