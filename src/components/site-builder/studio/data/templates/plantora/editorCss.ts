...
[data-template-id="plantora"] .tpl-ken, [data-template-id="plantora"] .tpl-ken {
  animation: plantora-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="plantora"] .tpl-rise, [data-template-id="plantora"] .tpl-rise {
  animation: plantora-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="plantora"] .tpl-rise-2, [data-template-id="plantora"] .tpl-rise-2 {
  animation: plantora-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="plantora"] .tpl-rise-3, [data-template-id="plantora"] .tpl-rise-3 {
...
[data-template-id="plantora"] .tpl-root, [data-template-id="plantora"] .tpl-root { transform-origin: top; animation: plantora-root 1.4s cubic-bezier(.22,1,.36,1) both; }
