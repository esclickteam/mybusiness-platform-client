...
[data-template-id="driftwood"] .tpl-ken, [data-template-id="driftwood"] .tpl-ken {
  animation: driftwood-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="driftwood"] .tpl-rise, [data-template-id="driftwood"] .tpl-rise {
  animation: driftwood-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="driftwood"] .tpl-rise-2, [data-template-id="driftwood"] .tpl-rise-2 {
  animation: driftwood-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="driftwood"] .tpl-rise-3, [data-template-id="driftwood"] .tpl-rise-3 {
  animation: driftwood-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="driftwood"] .tpl-marquee-track, [data-template-id="driftwood"] .tpl-marquee-track {
  display: flex; width: max-content; animation: driftwood-marquee 28s linear infinite;
}
[data-template-id="driftwood"] .tpl-float, [data-template-id="driftwood"] .tpl-float {
  animation: driftwood-float 5s ease-in-out infinite;
}
[data-template-id="driftwood"] .tpl-sweep, [data-template-id="driftwood"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="driftwood"] .tpl-sweep::after, [data-template-id="driftwood"] .tpl-sweep::after {
...
[data-template-id="driftwood"] .tpl-climb, [data-template-id="driftwood"] .tpl-climb {
...
[data-template-id="driftwood"] .tpl-organic, [data-template-id="driftwood"] .tpl-organic {
  animation: driftwood-organic-float 7s ease-in-out infinite;
}
[data-template-id="driftwood"] .tpl-menu-scroll, [data-template-id="driftwood"] .tpl-menu-scroll {
