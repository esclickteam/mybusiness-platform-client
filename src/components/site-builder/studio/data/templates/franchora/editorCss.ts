...
[data-template-id="franchora"], [data-template-id="franchora-preview"] {
  --p: #92400E;
  --a: #10B981;
  --bg: #FFFBEB;
  --surface: #FFFFFF;
...
[data-template-id="franchora-preview"] .text-center { text-align: center; }
[data-template-id="franchora"] .ag-display,
[data-template-id="franchora-preview"] .ag-display { font-family: "Poppins", "Bellefair", sans-serif; }
[data-template-id="franchora"] .ag-card,
[data-template-id="franchora-preview"] .ag-card {
...
[data-template-id="franchora-preview"] .ag-card:hover {
  transform: translateY(-20px) rotate(-0.7deg);
  border-color: var(--a);
  box-shadow: 0 24px 70px rgba(0,0,0,0.28);
}
[data-template-id="franchora"] .ag-ken,
[data-template-id="franchora-preview"] .ag-ken { animation: franchoraKen 30s ease-in-out infinite alternate; }
[data-template-id="franchora"] .ag-float,
[data-template-id="franchora-preview"] .ag-float { animation: franchoraFloat 9s ease-in-out infinite; }
[data-template-id="franchora"] .ag-pulse,
[data-template-id="franchora-preview"] .ag-pulse { animation: franchoraPulse 3.1s ease-in-out infinite; }
[data-template-id="franchora"] .ag-scan,
[data-template-id="franchora-preview"] .ag-scan { animation: franchoraScan 23s linear infinite; }
[data-template-id="franchora"] .ag-drift,
[data-template-id="franchora-preview"] .ag-drift { animation: franchoraDrift 24s ease-in-out infinite alternate; }
...
@media (prefers-reduced-motion: reduce) {
  [data-template-id="franchora"] .ag-ken,
  [data-template-id="franchora-preview"] .ag-ken,
  [data-template-id="franchora"] .ag-float,
  [data-template-id="franchora-preview"] .ag-float,
  [data-template-id="franchora"] .ag-pulse,
  [data-template-id="franchora-preview"] .ag-pulse,
  [data-template-id="franchora"] .ag-scan,
  [data-template-id="franchora-preview"] .ag-scan,
  [data-template-id="franchora"] .ag-drift,
  [data-template-id="franchora-preview"] .ag-drift { animation: none; }
}
`;
