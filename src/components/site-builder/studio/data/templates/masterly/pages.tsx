      ...
      <div className="relative z-10 mx-auto max-w-3xl text-center">
        ...
        {[[getValue(data,"reviewOneText"),getValue(data,"reviewOneName"),getValue(data,"reviewOneRole")],[getValue(data,"reviewTwoText"),getValue(data,"reviewTwoName"),getValue(data,"reviewTwoRole")],[getValue(data,"reviewThreeText"),getValue(data,"reviewThreeName"),getValue(data,"reviewThreeRole")]].slice(0,2).map(([text,name],i) => (
          <Reveal key={name} delayMs={i*120} className="mt-14">
            <p className="text-xl leading-10 text-white/90 md:text-2xl">"{tx(text)}"</p>
    ...
    <section data-template-section-type="about" className="px-5 py-12 md:py-24 lg:px-8 bg-black text-white">
      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
        <Reveal className="relative min-h-[360px] overflow-hidden border border-[var(--p)]/30 bg-[var(--surface)]/70">
          ...
          <span className="absolute bottom-6 right-6 rounded-full px-4 py-2 text-sm font-bold border border-[var(--p)] text-[var(--p)]">{tx("פרימיום")}</span>
        </Reveal>
  ...
  return (
    <section id="contact" data-template-section-type="contact" className="px-5 py-14 md:py-28 lg:px-8">
      <div className="mx-auto max-w-md border border-[var(--p)]/40 p-10 text-center">
        ...
        <form className="mt-8 grid gap-3 text-start" data-bizuply-block="lead-form" data-bizuply-crm-lead="true" data-bizuply-form-builder="true" data-bizuply-form-skin="template" data-bizuply-form-id="masterly-contact" data-bizuply-success-message={tx("תודה! קיבלנו את הפנייה ונחזור אלייך בהקדם.")}>
          <input className="border border-[var(--p)]/30 bg-transparent px-5 py-4 text-sm outline-none" placeholder={tx("שם מלא")}  name="name" data-bizuply-form-field-id="name" type="text" autoComplete="name" />
          <input className="border border-[var(--p)]/30 bg-transparent px-5 py-4 text-sm outline-none" placeholder={tx("אימייל")}  name="email" data-bizuply-form-field-id="email" type="email" autoComplete="email" />
  ...
  return (
    <div className="fixed inset-0 z-[80] grid place-items-center bg-black/70 px-4 backdrop-blur-sm">
      <div className="relative w-full max-w-md border border-[var(--p)]/30 bg-[var(--surface)] p-8">
        ...
        <form className="mt-6 grid gap-3" data-bizuply-block="lead-form" data-bizuply-crm-lead="true" data-bizuply-form-builder="true" data-bizuply-form-skin="template" data-bizuply-form-id="masterly-contact-2" data-bizuply-success-message={tx("תודה! קיבלנו את הפנייה ונחזור אלייך בהקדם.")}>
...
export default function MasterlyPages(props: MasterlyPagesProps) {
  ...
  return (
    <div dir={templateDir()} data-template-id="masterly" className="min-h-screen w-full overflow-x-hidden">
