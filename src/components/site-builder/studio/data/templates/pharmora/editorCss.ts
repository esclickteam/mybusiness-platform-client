...
[data-template-id="pharmora"], [data-template-id="pharmora-preview"] {
  --p: #0369A1;
  --accent: #34D399;
  --on-p: #F0F9FF;
  --bg: #F0F9FF;
...
[data-template-id="pharmora-preview"] .store-display {
  font-family: "IBM Plex Sans", "Heebo", serif;
}
[data-template-id="pharmora"] .store-card,
[data-template-id="pharmora-preview"] .store-card {
...
[data-template-id="pharmora-preview"] .store-card:hover {
  transform: translateY(-8px);
  box-shadow: 0 24px 60px rgba(0,0,0,0.18);
  border-color: var(--p);
}
[data-template-id="pharmora"] .store-marquee,
[data-template-id="pharmora-preview"] .store-marquee {
