...
import { pharmoraDefaultData, pharmoraDemoProducts } from "./defaultData";
import { pharmoraEditorCss } from "./editorCss";

export const pharmoraPages = [
...
export default function PharmoraPages(props: any) {
  return (
    <RichStoreSiteRuntime
      ...
      demoProducts={pharmoraDemoProducts}
      pages={pharmoraPages}
    />
  );
}
