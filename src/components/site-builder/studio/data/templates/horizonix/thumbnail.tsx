    ...
    <div dir={getTextDirection(i18n.language)} className="relative h-full min-h-[260px] w-full overflow-hidden">
      <div className="relative h-full min-h-[260px] overflow-hidden" style={{ background: "#0d1117" }}>
        <div className="flex h-full">
          <div className="w-1/3" style={{ backgroundImage: "url(https://images.unsplash.com/photo-1499793983690-29daaa814980?auto=format&fit=crop&w=2000&q=85)", backgroundSize: "cover" }} />
          ...
          <div className="w-1/3" style={{ backgroundImage: "url(https://images.unsplash.com/photo-1473496165774-b890209ef8aa?auto=format&fit=crop&w=1400&q=85)", backgroundSize: "cover" }} />
        </div>
        <div className="absolute inset-x-0 bottom-0 p-3" style={{ background: "linear-gradient(transparent, #010409cc)" }}>
          <p className="text-[10px]" style={{ color: "#58a6ff" }}>{tx("צילום · חוף")}</p>
