...
[data-template-id="horizonix"] .tpl-ken, [data-template-id="horizonix"] .tpl-ken {
  animation: horizonix-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="horizonix"] .tpl-rise, [data-template-id="horizonix"] .tpl-rise {
  animation: horizonix-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="horizonix"] .tpl-rise-2, [data-template-id="horizonix"] .tpl-rise-2 {
  animation: horizonix-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="horizonix"] .tpl-rise-3, [data-template-id="horizonix"] .tpl-rise-3 {
  animation: horizonix-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="horizonix"] .tpl-marquee-track, [data-template-id="horizonix"] .tpl-marquee-track {
  display: flex; width: max-content; animation: horizonix-marquee 28s linear infinite;
}
[data-template-id="horizonix"] .tpl-float, [data-template-id="horizonix"] .tpl-float {
  animation: horizonix-float 5s ease-in-out infinite;
}
[data-template-id="horizonix"] .tpl-sweep, [data-template-id="horizonix"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="horizonix"] .tpl-sweep::after, [data-template-id="horizonix"] .tpl-sweep::after {
...
[data-template-id="horizonix"] .tpl-climb, [data-template-id="horizonix"] .tpl-climb {
...
[data-template-id="horizonix"] .tpl-pan-track, [data-template-id="horizonix"] .tpl-pan-track {
  display: flex; width: 300%; animation: horizonix-pan-slide 18s ease-in-out infinite;
}
[data-template-id="horizonix"] .tpl-pan-panel, [data-template-id="horizonix"] .tpl-pan-panel {
  flex: 0 0 33.333%; min-height: 72vh;
}
[data-template-id="horizonix"] .tpl-gallery-zoom img, [data-template-id="horizonix"] .tpl-gallery-zoom img {
  transition: transform .6s cubic-bezier(.22,1,.36,1);
}
[data-template-id="horizonix"] .tpl-gallery-zoom:hover img, [data-template-id="horizonix"] .tpl-gallery-zoom:hover img {
