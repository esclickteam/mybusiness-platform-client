...
export const brunchhausSeed = {
  ...
  blocks: [
    ...
    { type: "gallery", variant: "polaroid-scatter", title: "Polaroid featured brunch" },
    { type: "process", variant: "sunny-process", title: "Sunny process" },
    { type: "photos", variant: "sunny-gallery", title: "Sunny gallery" },
    { type: "reviews", variant: "sunny-reviews", title: "Sunny reviews" },
    { type: "hours", variant: "weekend-stats-hours", title: "Weekend stats + hours" },
    { type: "cta", variant: "sunny-home-cta", title: "Home CTA teaser" },
    { type: "brunchPage", variant: "full-brunch-menu", title: "Full brunch menu page" },
    { type: "coffeePage", variant: "coffee-story", title: "Coffee story page" },
    { type: "about", variant: "note-timeline-chef", title: "Note timeline + chef" },
    { type: "contact", variant: "postcard-reserve-faq", title: "Postcard reserve + FAQ" },
