export const ledgerDefaultData = {
  templateId: "ledger",
  name: "Ledger",
  brandName: "Ledger",
  logoText: "LE",
  tagline: "פיננסים והנהלת חשבונות",
  navHome: "בית",
  navAbout: "אודות",
  navServices: "שירותים",
  navWork: "פרויקטים",
  ...
  navContact: "צור קשר",
  heroEyebrow: "פיננסים והנהלת חשבונות",
  heroTitle: "מספרים עם הקשר עסקי.",
  ...
  phone: "03-000-0000",
  email: "hello@ledger.co.il",
  address: "תל אביב, ישראל",
  footerText: "תבנית Ledger — אתר רב-עמודי מקצועי עם עיצוב מלבני ותנועה.",
