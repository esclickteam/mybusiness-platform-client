...
[data-template-id="propnex"] .tpl-ken, [data-template-id="propnex"] .tpl-ken {
  animation: propnex-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="propnex"] .tpl-rise, [data-template-id="propnex"] .tpl-rise {
  animation: propnex-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="propnex"] .tpl-rise-2, [data-template-id="propnex"] .tpl-rise-2 {
  animation: propnex-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="propnex"] .tpl-rise-3, [data-template-id="propnex"] .tpl-rise-3 {
  animation: propnex-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="propnex"] .tpl-marquee-track, [data-template-id="propnex"] .tpl-marquee-track {
  display: flex; width: max-content; animation: propnex-marquee 28s linear infinite;
}
[data-template-id="propnex"] .tpl-float, [data-template-id="propnex"] .tpl-float {
  animation: propnex-float 5s ease-in-out infinite;
}
[data-template-id="propnex"] .tpl-sweep, [data-template-id="propnex"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="propnex"] .tpl-sweep::after, [data-template-id="propnex"] .tpl-sweep::after {
...
[data-template-id="propnex"] .tpl-climb, [data-template-id="propnex"] .tpl-climb {
  animation: propnex-climb .85s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="propnex"] .tpl-bento, [data-template-id="propnex"] .tpl-bento { display:grid;gap:.75rem;grid-template-columns:repeat(6,1fr); }
@keyframes propnex-draw { from { transform:scaleX(0); } to { transform:scaleX(1); } }
[data-template-id="propnex"] .tpl-line-draw, [data-template-id="propnex"] .tpl-line-draw { transform-origin:right;animation:propnex-draw 1.2s both; }
@keyframes propnex-testi { to { transform:translateX(-50%); } }
[data-template-id="propnex"] .tpl-testi-track, [data-template-id="propnex"] .tpl-testi-track {
