...
function ContactForm({ data, onCta }: { data: Record<string, any>; onCta: () => void }) {
  ...
  return (
    <form className="grid gap-3"  data-bizuply-block="lead-form" data-bizuply-form-id="propnex-contact-1" data-bizuply-crm-lead="true" data-bizuply-success-message="תודה! קיבלנו את הפנייה ונחזור אליכם בהקדם." >
      <input name="name" data-bizuply-form-field-id="name" autoComplete="name"  className={field} style={{ borderColor: "rgba(17,24,39,0.1)", color: "#111827" }} placeholder="שם מלא" />
      <input name="phone" data-bizuply-form-field-id="phone" type="tel" autoComplete="tel"  className={field} style={{ borderColor: "rgba(17,24,39,0.1)", color: "#111827" }} placeholder="טלפון" />
      <input name="email" data-bizuply-form-field-id="email" type="email" autoComplete="email"  className={field} style={{ borderColor: "rgba(17,24,39,0.1)", color: "#111827" }} placeholder="אימייל" />
      <textarea name="message" data-bizuply-form-field-id="message"  className={cx(field, "min-h-28")} style={{ borderColor: "rgba(17,24,39,0.1)", color: "#111827" }} placeholder="מה אתם מחפשים?" />
