...
[data-template-id="shawarmia"] .tpl-ken, [data-template-id="shawarmia"] .tpl-ken {
  animation: shawarmia-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="shawarmia"] .tpl-rise, [data-template-id="shawarmia"] .tpl-rise {
  animation: shawarmia-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="shawarmia"] .tpl-rise-2, [data-template-id="shawarmia"] .tpl-rise-2 {
  animation: shawarmia-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="shawarmia"] .tpl-rise-3, [data-template-id="shawarmia"] .tpl-rise-3 {
...
[data-template-id="shawarmia"] .tpl-spit, [data-template-id="shawarmia"] .tpl-spit { animation: shawarmia-spit 18s linear infinite; transform-origin: center top; }
