...
[data-template-id="pulsefit-preview"] a,
[data-template-id="pulsefit"] button,
[data-template-id="pulsefit-preview"] button {
  transition: background .22s ease, color .22s ease, border-color .22s ease, transform .22s ease;
}

[data-template-id="pulsefit"] a:hover,
[data-template-id="pulsefit-preview"] a:hover,
[data-template-id="pulsefit"] button:hover,
[data-template-id="pulsefit-preview"] button:hover {
  transform: translateY(-2px);
}

[data-template-id="pulsefit"] .pulsefit-hero-image,
[data-template-id="pulsefit-preview"] .pulsefit-hero-image {
...
[data-template-id="pulsefit-preview"] .pulsefit-slash {
  transform: skewX(-14deg);
  box-shadow: 18px 0 0 rgba(200, 255, 61, 0.18);
}

[data-template-id="pulsefit"] .pulsefit-program-row,
[data-template-id="pulsefit-preview"] .pulsefit-program-row {
  position: relative;
  overflow: hidden;
...
[data-template-id="pulsefit-preview"] .pulsefit-program-row::before {
  content: "";
  position: absolute;
  inset: 0;
  background: var(--p);
...
[data-template-id="pulsefit-preview"] .pulsefit-program-row:hover {
  color: #000;
  transform: translateX(-8px);
}

[data-template-id="pulsefit"] .pulsefit-program-row:hover::before,
[data-template-id="pulsefit-preview"] .pulsefit-program-row:hover::before {
  transform: scaleX(1);
}

[data-template-id="pulsefit"] .pulsefit-program-row:hover h3,
[data-template-id="pulsefit-preview"] .pulsefit-program-row:hover h3,
[data-template-id="pulsefit"] .pulsefit-program-row:hover p,
[data-template-id="pulsefit-preview"] .pulsefit-program-row:hover p,
[data-template-id="pulsefit"] .pulsefit-program-row:hover span,
[data-template-id="pulsefit-preview"] .pulsefit-program-row:hover span {
  color: #000 !important;
}

[data-template-id="pulsefit"] .pulsefit-method-panel,
[data-template-id="pulsefit-preview"] .pulsefit-method-panel {
...
[data-template-id="pulsefit-preview"] .pulsefit-method-panel:hover {
  background: #232323;
  border-color: var(--p);
...
[data-template-id="pulsefit-preview"] input,
[data-template-id="pulsefit"] textarea,
[data-template-id="pulsefit-preview"] textarea {
  font-family: "IBM Plex Sans", sans-serif;
}

[data-template-id="pulsefit"] input::placeholder,
[data-template-id="pulsefit-preview"] input::placeholder,
[data-template-id="pulsefit"] textarea::placeholder,
[data-template-id="pulsefit-preview"] textarea::placeholder {
