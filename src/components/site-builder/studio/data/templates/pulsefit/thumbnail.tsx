...
export default function PulsefitThumbnail() {
  ...
  return (
    <div dir={getTextDirection(i18n.language)} className="relative h-full min-h-[260px] w-full overflow-hidden p-5" style={{ background: "#121212", color: "#F4F4F4" }}>
      ...
      <div className="relative z-10 flex items-center justify-between">
        ...
        <span className="px-3 py-2 text-[9px] font-black uppercase tracking-[0.18em]" style={{ background: "#C8FF3D", color: "#000" }}>{tx("התחלה")}</span>
      </div>
      ...
      <div className="relative z-10 mt-7 space-y-2">
        {[tx("חיטוב 90"), "Build Strong", "Hybrid Engine"].map((item, index) => (
