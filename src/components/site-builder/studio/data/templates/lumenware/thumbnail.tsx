...
export default function LumenwareThumbnail() {
  ...
  return (
    <div dir={getTextDirection(i18n.language)} className="relative flex h-full min-h-[260px] w-full flex-col justify-between overflow-hidden p-5 text-right" style={{ background: "#07111A", color: "#E8F4FF", fontFamily: "Heebo, sans-serif" }}>
      ...
      <div className="relative">
        <div className="inline-flex px-2 py-1 text-[10px] font-black uppercase tracking-[0.2em]" style={{ background: "#0EA5E9", color: "#041018" }}>{tx("אלקטרוניקה וגאדג׳טים")}</div>
        <h3 className="mt-4 text-3xl font-black leading-none" style={{ fontFamily: "Space Grotesk, serif" }}>Lumenware</h3>
        <p className="mt-2 text-xs font-semibold opacity-70">{tx("טכנולוגיה שמאירה קדימה")}</p>
      </div>
