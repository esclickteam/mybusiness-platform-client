...
[data-template-id="smokepit"], [data-template-id="smokepit-preview"] {
...
[data-template-id="smokepit-preview"] .tpl-display {
...
[data-template-id="smokepit"] .tpl-ken, [data-template-id="smokepit-preview"] .tpl-ken {
  animation: smokepit-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="smokepit"] .tpl-rise, [data-template-id="smokepit-preview"] .tpl-rise {
  animation: smokepit-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="smokepit"] .tpl-rise-2, [data-template-id="smokepit-preview"] .tpl-rise-2 {
  animation: smokepit-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="smokepit"] .tpl-rise-3, [data-template-id="smokepit-preview"] .tpl-rise-3 {
...
[data-template-id="smokepit"] .tpl-smoke, [data-template-id="smokepit-preview"] .tpl-smoke { animation: smokepit-smoke 7s ease-out infinite; }
