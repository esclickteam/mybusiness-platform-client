      ...
      <div className="mx-auto max-w-4xl border border-white/15 bg-[var(--surface)] p-6 md:p-10">
        ...
        <Reveal variant="up" delayMs={100} className="mx-auto mt-10 max-w-2xl">
          <form className="grid gap-3" data-bizuply-block="lead-form" data-bizuply-crm-lead="true" data-bizuply-form-builder="true" data-bizuply-form-skin="template" data-bizuply-form-id="eventide-contact" data-bizuply-success-message={tx("תודה! קיבלנו את הפנייה ונחזור אלייך בהקדם.")}>
            ...
            <input className="border border-white/15 bg-[var(--bg)] px-4 py-4 text-right outline-none" placeholder={tx("שם האירוע")}  name="name_2" data-bizuply-form-field-id="name_2" type="text" autoComplete="name" />
            <textarea className="min-h-32 border border-white/15 bg-[var(--bg)] px-4 py-4 text-right outline-none" placeholder={tx("כמה אורחים ומה הקצב?")}  name="guests" data-bizuply-form-field-id="guests"></textarea>
