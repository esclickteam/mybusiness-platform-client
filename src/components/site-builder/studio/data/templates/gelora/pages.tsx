    ...
    <>
      ...
      <section data-template-section-type="confirmationForm" data-section-kind="confirmationForm" className="beauty-glassGel-confirmationForm-frame-2 overflow-hidden px-4 py-20 text-center sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl rounded-[3rem] border border-[var(--p)]/25 bg-[var(--surface)] px-6 py-14 shadow-2xl md:px-12">
          ...
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]"><Reveal><div><h2 className="t-display text-2xl sm:text-4xl text-[var(--p)]">{getValue(data,"confirmTitle")}</h2><p className="mt-4 text-[var(--muted)]">{getValue(data,"contactText")}</p></div></Reveal><form className="relative z-20 grid gap-3 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-[var(--p)]/20" data-bizuply-block="lead-form" data-bizuply-crm-lead="true" data-bizuply-form-builder="true" data-bizuply-form-skin="template" data-bizuply-form-id="beauty-contact" data-bizuply-success-message={tx("תודה! קיבלנו את הפנייה ונחזור אלייך בהקדם.")}><input name="name" data-bizuply-form-field-id="name" autoComplete="name" className="rounded-xl border border-[var(--p)]/40 bg-white px-4 py-3 text-right text-[var(--text)] outline-none placeholder:text-[var(--muted)] focus:border-[var(--p)]" placeholder={tx("שם מלא")} /><input name="phone" type="tel" data-bizuply-form-field-id="phone" autoComplete="tel" className="rounded-xl border border-[var(--p)]/40 bg-white px-4 py-3 text-right text-[var(--text)] outline-none placeholder:text-[var(--muted)] focus:border-[var(--p)]" placeholder={tx("טלפון")} /><textarea name="message" data-bizuply-form-field-id="message" className="min-h-28 rounded-xl border border-[var(--p)]/40 bg-white px-4 py-3 text-right text-[var(--text)] outline-none placeholder:text-[var(--muted)] focus:border-[var(--p)]" placeholder={tx("הערות")} /><button type="submit" className="rounded-xl bg-[var(--p)] py-3.5 text-sm font-bold text-[var(--dark)] transition hover:opacity-95">{getValue(data,"contactButton")}</button></form></div>
        </div>
      </section>
