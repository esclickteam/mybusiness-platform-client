...
function HomePage({ data, goTo }: { data: Record<string, any>; goTo: (id: string) => void }) {
  return (
    <>
      <section data-template-section-type="hero" data-section-kind="hero" className="beauty-glassGel-hero-v10 overflow-hidden bg-[var(--bg)] px-5 py-14 lg:px-8"><div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center"><Reveal><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">GEL</p><h1 className="t-display t-anim mt-4 whitespace-pre-line text-5xl leading-tight md:text-7xl">{getValue(data,"heroTitle")}</h1><p className="mt-5 max-w-lg text-[var(--muted)]">{getValue(data,"heroSubtitle")}</p><button type="button" onClick={() => goTo("booking")} className="mt-8 rounded-full bg-[var(--p)] px-8 py-3.5 text-sm font-bold text-white">{getValue(data,"heroPrimaryButton")}</button></Reveal><Reveal variant="scale" delayMs={120}><div className="grid grid-cols-2 gap-3"><img src={getValue(data,"heroImage")} alt="" className="t-ken row-span-2 h-full min-h-[520px] w-full rounded-[2rem] object-cover" /><img src={getValue(data,"itemOneImage")} alt="" className="h-64 rounded-[2rem] object-cover" /><img src={getValue(data,"galleryImage2")} alt="" className="h-64 rounded-[2rem] object-cover" /></div></Reveal></div></section>
      <section data-template-section-type="servicesPreview" data-section-kind="servicesPreview" className="beauty-glassGel-servicesPreview-frame-0 relative isolate overflow-hidden px-5 py-24 lg:px-8">
      ...
      <section data-template-section-type="ritual" data-section-kind="ritual" className="beauty-glassGel-ritual-frame-1 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.72fr_1.28fr]">
          <aside className="lg:sticky lg:top-28 lg:h-fit"><div className="t-shimmer mb-5 h-px w-32 bg-[var(--p)]" /><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">GEL / ritual</p><div className="mt-6 t-display text-5xl leading-none text-[var(--p)]">02</div></aside>
      ...
      <section data-template-section-type="team" data-section-kind="team" className="beauty-glassGel-team-frame-3 px-5 py-24 lg:px-8">
      ...
      <section data-template-section-type="testimonials" data-section-kind="testimonials" className="beauty-glassGel-testimonials-frame-4 relative overflow-hidden bg-[var(--dark)] px-5 py-24 text-[var(--text)] lg:px-8">
      ...
      <section data-template-section-type="whyUs" data-section-kind="whyUs" className="beauty-glassGel-whyUs-frame-6 overflow-hidden px-5 py-24 lg:px-8">
      ...
      <section data-template-section-type="bookingTeaser" data-section-kind="bookingTeaser" className="beauty-glassGel-bookingTeaser-frame-7 px-5 py-24 lg:px-8">
...
function AboutPage({ data, goTo }: { data: Record<string, any>; goTo: (id: string) => void }) {
  return (
    <>
      <section data-template-section-type="aboutHero" data-section-kind="aboutHero" className="beauty-glassGel-aboutHero-frame-8 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--a)_16%,transparent),transparent)] px-5 py-24 text-center lg:px-8">
      ...
      <section data-template-section-type="spaceTour" data-section-kind="spaceTour" className="beauty-glassGel-spaceTour-frame-0 relative isolate overflow-hidden px-5 py-24 lg:px-8">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_15%,color-mix(in_srgb,var(--p)_28%,transparent),transparent_34%),linear-gradient(135deg,color-mix(in_srgb,var(--surface)_70%,transparent),transparent_58%)]" />
        <div className="relative mx-auto max-w-7xl">
      ...
      <section data-template-section-type="values" data-section-kind="values" className="beauty-glassGel-values-frame-1 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.72fr_1.28fr]">
          <aside className="lg:sticky lg:top-28 lg:h-fit"><div className="t-shimmer mb-5 h-px w-32 bg-[var(--p)]" /><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">GEL / values</p><div className="mt-6 t-display text-5xl leading-none text-[var(--p)]">02</div></aside>
      ...
      <section data-template-section-type="certifications" data-section-kind="certifications" className="beauty-glassGel-certifications-frame-3 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
      ...
      <section data-template-section-type="timeline" data-section-kind="timeline" className="beauty-glassGel-timeline-frame-4 relative overflow-hidden bg-[var(--dark)] px-5 py-24 text-[var(--text)] lg:px-8">
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,transparent,color-mix(in_srgb,var(--p)_18%,transparent),transparent)]" />
        <div className="relative mx-auto max-w-7xl border border-[var(--p)]/45 p-6 shadow-[0_0_44px_color-mix(in_srgb,var(--p)_18%,transparent)] md:p-10">
      ...
      <section data-template-section-type="aboutCta" data-section-kind="aboutCta" className="beauty-glassGel-aboutCta-frame-6 overflow-hidden px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-[0.85fr_1.15fr_0.55fr]">
...
function ServicesPage({ data, goTo }: { data: Record<string, any>; goTo: (id: string) => void }) {
  return (
    <>
      <section data-template-section-type="servicesHero" data-section-kind="servicesHero" className="beauty-glassGel-servicesHero-frame-7 px-5 py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
      ...
      <section data-template-section-type="catalog" data-section-kind="catalog" className="beauty-glassGel-catalog-frame-8 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--a)_16%,transparent),transparent)] px-5 py-24 text-center lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="mx-auto mb-8 h-16 w-px bg-[var(--p)]" />
      ...
      <section data-template-section-type="durationGuide" data-section-kind="durationGuide" className="beauty-glassGel-durationGuide-frame-0 relative isolate overflow-hidden px-5 py-24 lg:px-8">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_15%,color-mix(in_srgb,var(--p)_28%,transparent),transparent_34%),linear-gradient(135deg,color-mix(in_srgb,var(--surface)_70%,transparent),transparent_58%)]" />
        <div className="relative mx-auto max-w-7xl">
      ...
      <section data-template-section-type="addons" data-section-kind="addons" className="beauty-glassGel-addons-frame-1 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.72fr_1.28fr]">
          <aside className="lg:sticky lg:top-28 lg:h-fit"><div className="t-shimmer mb-5 h-px w-32 bg-[var(--p)]" /><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">GEL / addons</p><div className="mt-6 t-display text-5xl leading-none text-[var(--p)]">02</div></aside>
      ...
      <section data-template-section-type="priceTable" data-section-kind="priceTable" className="beauty-glassGel-priceTable-frame-3 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
      ...
      <section data-template-section-type="serviceFaq" data-section-kind="serviceFaq" className="beauty-glassGel-serviceFaq-frame-4 relative overflow-hidden bg-[var(--dark)] px-5 py-24 text-[var(--text)] lg:px-8">
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,transparent,color-mix(in_srgb,var(--p)_18%,transparent),transparent)]" />
        <div className="relative mx-auto max-w-7xl border border-[var(--p)]/45 p-6 shadow-[0_0_44px_color-mix(in_srgb,var(--p)_18%,transparent)] md:p-10">
...
function BookingPage({ data, goTo }: { data: Record<string, any>; goTo: (id: string) => void }) {
  return (
    <>
      <section data-template-section-type="bookingHero" data-section-kind="bookingHero" className="beauty-glassGel-bookingHero-frame-6 overflow-hidden px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-[0.85fr_1.15fr_0.55fr]">
      ...
      <section data-section-kind="booking" data-bizuply-block="booking" data-template-section-type="booking" className="beauty-glassGel-calendar-frame-7 px-5 py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
      ...
      <section data-template-section-type="servicePicker" data-section-kind="servicePicker" className="beauty-glassGel-servicePicker-frame-8 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--a)_16%,transparent),transparent)] px-5 py-24 text-center lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="mx-auto mb-8 h-16 w-px bg-[var(--p)]" />
      ...
      <section data-template-section-type="hoursPanel" data-section-kind="hoursPanel" className="beauty-glassGel-hoursPanel-frame-0 relative isolate overflow-hidden px-5 py-24 lg:px-8">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_15%,color-mix(in_srgb,var(--p)_28%,transparent),transparent_34%),linear-gradient(135deg,color-mix(in_srgb,var(--surface)_70%,transparent),transparent_58%)]" />
        <div className="relative mx-auto max-w-7xl">
      ...
      <section data-template-section-type="policies" data-section-kind="policies" className="beauty-glassGel-policies-frame-1 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.72fr_1.28fr]">
          <aside className="lg:sticky lg:top-28 lg:h-fit"><div className="t-shimmer mb-5 h-px w-32 bg-[var(--p)]" /><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">GEL / policies</p><div className="mt-6 t-display text-5xl leading-none text-[var(--p)]">02</div></aside>
      ...
      <section data-template-section-type="locationMap" data-section-kind="locationMap" className="beauty-glassGel-locationMap-frame-3 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
      ...
      <section data-template-section-type="bookingFaq" data-section-kind="bookingFaq" className="beauty-glassGel-bookingFaq-frame-4 relative overflow-hidden bg-[var(--dark)] px-5 py-24 text-[var(--text)] lg:px-8">
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,transparent,color-mix(in_srgb,var(--p)_18%,transparent),transparent)]" />
        <div className="relative mx-auto max-w-7xl border border-[var(--p)]/45 p-6 shadow-[0_0_44px_color-mix(in_srgb,var(--p)_18%,transparent)] md:p-10">
...
export default function GeloraPages(props: GeloraPagesProps) {
  ...
  return (
    <div dir="rtl" data-template-id={mode === "preview" ? "gelora-preview" : "gelora"} className="min-h-screen w-full overflow-x-hidden" style={{ background: "#FFF7FB", color: "#4C0F2E" }}>
