...
export default function BagoraThumbnail() {
  ...
  return (
    <div dir={getTextDirection(i18n.language)} className="relative flex h-full min-h-[260px] w-full flex-col justify-between overflow-hidden p-5 text-right" style={{ background: "#FFF7ED", color: "#431407", fontFamily: "Heebo, sans-serif" }}>
      ...
      <div className="relative">
        <div className="inline-flex px-2 py-1 text-[10px] font-black uppercase tracking-[0.2em]" style={{ background: "#7C2D12", color: "#FFF7ED" }}>{tx("תיקים ואקססוריז")}</div>
        <h3 className="mt-4 text-3xl font-black leading-none" style={{ fontFamily: "Playfair Display, serif" }}>Bagora</h3>
        <p className="mt-2 text-xs font-semibold opacity-70">{tx("רצועה חזקה. צורה נקייה.")}</p>
      </div>
