...
[data-template-id="bagora"], [data-template-id="bagora-preview"] {
  --p: #7C2D12;
  --accent: #FB923C;
  --on-p: #FFF7ED;
  --bg: #FFF7ED;
...
[data-template-id="bagora-preview"] .store-display {
  font-family: "Playfair Display", "Heebo", serif;
}
[data-template-id="bagora"] .store-card,
[data-template-id="bagora-preview"] .store-card {
...
[data-template-id="bagora-preview"] .store-card:hover {
  transform: translateY(-8px);
  box-shadow: 0 24px 60px rgba(0,0,0,0.18);
  border-color: var(--p);
}
[data-template-id="bagora"] .store-marquee,
[data-template-id="bagora-preview"] .store-marquee {
