...
[data-template-id="skyhold"] .tpl-ken, [data-template-id="skyhold"] .tpl-ken {
  animation: skyhold-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="skyhold"] .tpl-rise, [data-template-id="skyhold"] .tpl-rise {
  animation: skyhold-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="skyhold"] .tpl-rise-2, [data-template-id="skyhold"] .tpl-rise-2 {
  animation: skyhold-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="skyhold"] .tpl-rise-3, [data-template-id="skyhold"] .tpl-rise-3 {
  animation: skyhold-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="skyhold"] .tpl-marquee-track, [data-template-id="skyhold"] .tpl-marquee-track {
  display: flex; width: max-content; animation: skyhold-marquee 28s linear infinite;
}
[data-template-id="skyhold"] .tpl-float, [data-template-id="skyhold"] .tpl-float {
  animation: skyhold-float 5s ease-in-out infinite;
}
[data-template-id="skyhold"] .tpl-sweep, [data-template-id="skyhold"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="skyhold"] .tpl-sweep::after, [data-template-id="skyhold"] .tpl-sweep::after {
...
[data-template-id="skyhold"] .tpl-climb, [data-template-id="skyhold"] .tpl-climb {
...
[data-template-id="skyhold"] .tpl-elevator-digits, [data-template-id="skyhold"] .tpl-elevator-digits { animation:skyhold-elevator 8s infinite; }
@keyframes skyhold-testi { to { transform:translateX(-50%); } }
[data-template-id="skyhold"] .tpl-testi-track, [data-template-id="skyhold"] .tpl-testi-track {
