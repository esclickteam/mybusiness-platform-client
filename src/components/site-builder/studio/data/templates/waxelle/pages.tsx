...
function HomePage({ data, goTo }: { data: Record<string, any>; goTo: (id: string) => void }) {
  return (
    <>
      ...
      <section data-template-section-type="servicesPreview" data-section-kind="servicesPreview" className="beauty-sandBloom-servicesPreview-frame-6 overflow-hidden px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-[0.85fr_1.15fr_0.55fr]">
          ...
          <div className="t-float hidden border border-[var(--p)]/35 p-5 md:block"><span className="text-xs text-[var(--muted)]">סטודיו מהיר</span></div>
        </div>
      </section>
      <section data-template-section-type="ritual" data-section-kind="ritual" className="beauty-sandBloom-ritual-frame-7 px-5 py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">WAX / ritual</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">סטודיו מהיר</span></div>
      ...
      <section data-template-section-type="gallery" data-section-kind="gallery" className="beauty-sandBloom-gallery-frame-8 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--a)_16%,transparent),transparent)] px-5 py-24 text-center lg:px-8">
      ...
      <section data-template-section-type="testimonials" data-section-kind="testimonials" className="beauty-sandBloom-testimonials-frame-0 relative isolate overflow-hidden px-5 py-24 lg:px-8">
      ...
      <section data-template-section-type="packages" data-section-kind="packages" className="beauty-sandBloom-packages-frame-1 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.72fr_1.28fr]">
          <aside className="lg:sticky lg:top-28 lg:h-fit"><div className="t-shimmer mb-5 h-px w-32 bg-[var(--p)]" /><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">WAX / packages</p><div className="mt-6 t-display text-5xl leading-none text-[var(--p)]">02</div></aside>
      ...
      <section data-template-section-type="bookingTeaser" data-section-kind="bookingTeaser" className="beauty-sandBloom-bookingTeaser-frame-3 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">WAX / bookingTeaser</p></div><span className="text-xs text-[var(--muted)]">סטודיו מהיר</span></div>
        </div>
      </section>
...
function AboutPage({ data, goTo }: { data: Record<string, any>; goTo: (id: string) => void }) {
  return (
    <>
      <section data-template-section-type="aboutHero" data-section-kind="aboutHero" className="beauty-sandBloom-aboutHero-frame-4 relative overflow-hidden bg-[var(--dark)] px-5 py-24 text-[var(--text)] lg:px-8">
      ...
      <section data-template-section-type="spaceTour" data-section-kind="spaceTour" className="beauty-sandBloom-spaceTour-frame-6 overflow-hidden px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-[0.85fr_1.15fr_0.55fr]">
      ...
      <section data-template-section-type="values" data-section-kind="values" className="beauty-sandBloom-values-frame-7 px-5 py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">WAX / values</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">סטודיו מהיר</span></div>
      ...
      <section data-template-section-type="specialistsDeep" data-section-kind="specialistsDeep" className="beauty-sandBloom-specialistsDeep-frame-8 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--a)_16%,transparent),transparent)] px-5 py-24 text-center lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="mx-auto mb-8 h-16 w-px bg-[var(--p)]" />
      ...
      <section data-template-section-type="timeline" data-section-kind="timeline" className="beauty-sandBloom-timeline-frame-0 relative isolate overflow-hidden px-5 py-24 lg:px-8">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_15%,color-mix(in_srgb,var(--p)_28%,transparent),transparent_34%),linear-gradient(135deg,color-mix(in_srgb,var(--surface)_70%,transparent),transparent_58%)]" />
        <div className="relative mx-auto max-w-7xl">
      ...
      <section data-template-section-type="pressQuotes" data-section-kind="pressQuotes" className="beauty-sandBloom-pressQuotes-frame-1 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.72fr_1.28fr]">
          <aside className="lg:sticky lg:top-28 lg:h-fit"><div className="t-shimmer mb-5 h-px w-32 bg-[var(--p)]" /><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">WAX / pressQuotes</p><div className="mt-6 t-display text-5xl leading-none text-[var(--p)]">02</div></aside>
...
function ServicesPage({ data, goTo }: { data: Record<string, any>; goTo: (id: string) => void }) {
  return (
    <>
      <section data-template-section-type="servicesHero" data-section-kind="servicesHero" className="beauty-sandBloom-servicesHero-frame-3 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">WAX / servicesHero</p></div><span className="text-xs text-[var(--muted)]">סטודיו מהיר</span></div>
        </div>
      </section>
      <section data-template-section-type="catalog" data-section-kind="catalog" className="beauty-sandBloom-catalog-frame-4 relative overflow-hidden bg-[var(--dark)] px-5 py-24 text-[var(--text)] lg:px-8">
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,transparent,color-mix(in_srgb,var(--p)_18%,transparent),transparent)]" />
        <div className="relative mx-auto max-w-7xl border border-[var(--p)]/45 p-6 shadow-[0_0_44px_color-mix(in_srgb,var(--p)_18%,transparent)] md:p-10">
      ...
      <section data-template-section-type="durationGuide" data-section-kind="durationGuide" className="beauty-sandBloom-durationGuide-frame-6 overflow-hidden px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-[0.85fr_1.15fr_0.55fr]">
      ...
      <section data-template-section-type="addons" data-section-kind="addons" className="beauty-sandBloom-addons-frame-7 px-5 py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">WAX / addons</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">סטודיו מהיר</span></div>
      ...
      <section data-template-section-type="beforeAfter" data-section-kind="beforeAfter" className="beauty-sandBloom-beforeAfter-frame-8 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--a)_16%,transparent),transparent)] px-5 py-24 text-center lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="mx-auto mb-8 h-16 w-px bg-[var(--p)]" />
      ...
      <section data-template-section-type="serviceFaq" data-section-kind="serviceFaq" className="beauty-sandBloom-serviceFaq-frame-0 relative isolate overflow-hidden px-5 py-24 lg:px-8">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_15%,color-mix(in_srgb,var(--p)_28%,transparent),transparent_34%),linear-gradient(135deg,color-mix(in_srgb,var(--surface)_70%,transparent),transparent_58%)]" />
        <div className="relative mx-auto max-w-7xl">
      ...
      <section data-template-section-type="bookCta" data-section-kind="bookCta" className="beauty-sandBloom-bookCta-frame-1 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.72fr_1.28fr]">
          <aside className="lg:sticky lg:top-28 lg:h-fit"><div className="t-shimmer mb-5 h-px w-32 bg-[var(--p)]" /><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">WAX / bookCta</p><div className="mt-6 t-display text-5xl leading-none text-[var(--p)]">02</div></aside>
...
function BookingPage({ data, goTo }: { data: Record<string, any>; goTo: (id: string) => void }) {
  return (
    <>
      ...
      <section data-section-kind="booking" data-bizuply-block="booking" data-template-section-type="booking" className="beauty-sandBloom-calendar-frame-3 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          <div className="order-2 md:order-1"><div className="grid gap-8 lg:grid-cols-[0.75fr_1.25fr] lg:items-start"><Reveal><h2 className="t-display text-4xl text-[var(--p)]">{getValue(data,"calendarTitle")}</h2><p className="mt-4 text-[var(--muted)]">בחרו יום ושעה פנויה. הלוח כאן לשמירת תור מהירה מתוך התבנית.</p></Reveal><Reveal delayMs={100} className="t-glow bg-[var(--surface)]/80 p-5"><BookingCalendarPanel bold /></Reveal></div></div>
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">WAX / calendar</p></div><span className="text-xs text-[var(--muted)]">סטודיו מהיר</span></div>
        </div>
      </section>
      <section data-template-section-type="servicePicker" data-section-kind="servicePicker" className="beauty-sandBloom-servicePicker-frame-4 relative overflow-hidden bg-[var(--dark)] px-5 py-24 text-[var(--text)] lg:px-8">
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,transparent,color-mix(in_srgb,var(--p)_18%,transparent),transparent)]" />
        <div className="relative mx-auto max-w-7xl border border-[var(--p)]/45 p-6 shadow-[0_0_44px_color-mix(in_srgb,var(--p)_18%,transparent)] md:p-10">
      ...
      <section data-template-section-type="hoursPanel" data-section-kind="hoursPanel" className="beauty-sandBloom-hoursPanel-frame-6 overflow-hidden px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-[0.85fr_1.15fr_0.55fr]">
      ...
      <section data-template-section-type="policies" data-section-kind="policies" className="beauty-sandBloom-policies-frame-7 px-5 py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">WAX / policies</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">סטודיו מהיר</span></div>
      ...
      <section data-template-section-type="confirmationForm" data-section-kind="confirmationForm" className="beauty-sandBloom-confirmationForm-frame-8 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--a)_16%,transparent),transparent)] px-5 py-24 text-center lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="mx-auto mb-8 h-16 w-px bg-[var(--p)]" />
