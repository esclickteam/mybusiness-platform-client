      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-8 grid gap-4">
            {["בריף ויזואלי", "יום צילום", "עריכה ומסירה"].map((step, i) => (
...
export default function LenscraftPages(props: LenscraftPagesProps) {
  ...
  return (
    <div dir="rtl" data-template-id={mode === "preview" ? "lenscraft-preview" : "lenscraft"} className="min-h-screen w-full overflow-x-hidden">
