...
[data-template-id="kickora"], [data-template-id="kickora-preview"] {
  --p: #111827;
  --accent: #F43F5E;
  --on-p: #FFFFFF;
  --bg: #0B0B0F;
...
[data-template-id="kickora-preview"] .store-display {
  font-family: "Anton", "Heebo", serif;
}
[data-template-id="kickora"] .store-card,
[data-template-id="kickora-preview"] .store-card {
...
[data-template-id="kickora-preview"] .store-card:hover {
  transform: translateY(-8px);
  box-shadow: 0 24px 60px rgba(0,0,0,0.18);
  border-color: var(--p);
}
[data-template-id="kickora"] .store-marquee,
[data-template-id="kickora-preview"] .store-marquee {
