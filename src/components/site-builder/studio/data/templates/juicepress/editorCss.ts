...
[data-template-id="juicepress"] .tpl-ken, [data-template-id="juicepress"] .tpl-ken {
  animation: juicepress-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="juicepress"] .tpl-rise, [data-template-id="juicepress"] .tpl-rise {
  animation: juicepress-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="juicepress"] .tpl-rise-2, [data-template-id="juicepress"] .tpl-rise-2 {
  animation: juicepress-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="juicepress"] .tpl-rise-3, [data-template-id="juicepress"] .tpl-rise-3 {
...
[data-template-id="juicepress"] .tpl-burst, [data-template-id="juicepress"] .tpl-burst { animation: juicepress-burst 22s linear infinite; }
