    ...
    <>
      ...
      <section data-template-section-type="gallery" data-section-kind="gallery" className="beauty-archBrow-gallery-frame-6 overflow-hidden px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-[0.85fr_1.15fr_0.55fr]">
          ...
          <div className="t-float hidden border border-[var(--p)]/35 p-5 md:block"><span className="text-xs text-[var(--muted)]">סרגל גבות</span></div>
        </div>
      </section>
      <section data-template-section-type="team" data-section-kind="team" className="beauty-archBrow-team-frame-7 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">BROW / team</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">סרגל גבות</span></div>
    ...
    <>
      ...
      <section data-template-section-type="story" data-section-kind="story" className="beauty-archBrow-story-frame-3 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">BROW / story</p></div><span className="text-xs text-[var(--muted)]">סרגל גבות</span></div>
        </div>
      </section>
      ...
      <section data-template-section-type="certifications" data-section-kind="certifications" className="beauty-archBrow-certifications-frame-7 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">BROW / certifications</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">סרגל גבות</span></div>
    ...
    <>
      ...
      <section data-template-section-type="featuredTreatment" data-section-kind="featuredTreatment" className="beauty-archBrow-featuredTreatment-frame-3 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">BROW / featuredTreatment</p></div><span className="text-xs text-[var(--muted)]">סרגל גבות</span></div>
        </div>
      </section>
      ...
      <section data-template-section-type="priceTable" data-section-kind="priceTable" className="beauty-archBrow-priceTable-frame-7 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">BROW / priceTable</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">סרגל גבות</span></div>
    ...
    <>
      ...
      <section data-section-kind="booking" data-bizuply-block="booking" data-template-section-type="booking" className="beauty-archBrow-calendar-frame-1 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.72fr_1.28fr]">
          ...
          <div><div className="grid gap-8 lg:grid-cols-[0.75fr_1.25fr] lg:items-start"><Reveal><h2 className="t-display text-2xl sm:text-4xl text-[var(--p)]">{getValue(data,"calendarTitle")}</h2><p className="mt-4 text-[var(--muted)]">בחרו יום ושעה פנויה. הלוח כאן לשמירת תור מהירה מתוך התבנית.</p></Reveal><Reveal delayMs={100} className="t-glow bg-[var(--surface)]/80 p-5"><BookingCalendarPanel compact /></Reveal></div></div>
        </div>
      </section>
      ...
      <section data-template-section-type="specialistPicker" data-section-kind="specialistPicker" className="beauty-archBrow-specialistPicker-frame-3 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">BROW / specialistPicker</p></div><span className="text-xs text-[var(--muted)]">סרגל גבות</span></div>
        </div>
      </section>
      ...
      <section data-template-section-type="locationMap" data-section-kind="locationMap" className="beauty-archBrow-locationMap-frame-7 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">BROW / locationMap</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">סרגל גבות</span></div>
...
export default function BrowlinePages(props: BrowlinePagesProps) {
  ...
  const mergedData = useMemo(() => ({ ...browlineDefaultData, ...(data ?? {}) }), [data]);
  ...
  return (
    <div dir="rtl" data-template-id={mode === "preview" ? "browline-preview" : "browline"} className="min-h-screen w-full overflow-x-hidden" style={{ background: "#FBF7F4", color: "#3E2723" }}>
