...
export const spiceforgeSeed = {
  ...
  blocks: [
    ...
    { type: "process", variant: "spice-process", title: "Spice process" },
    { type: "gallery", variant: "spice-gallery", title: "Spice gallery" },
    { type: "reviews", variant: "spice-reviews", title: "Spice reviews" },
    { type: "stats", variant: "spice-stats", title: "Spice stats + hours" },
    { type: "cta", variant: "spice-home-cta", title: "Home CTA teaser" },
    { type: "thaliPage", variant: "full-thali-menu", title: "Full thali menu page" },
    { type: "spicesPage", variant: "spice-room-story", title: "Spice room story page" },
    { type: "about", variant: "terra-timeline", title: "Terracotta timeline + chef" },
    { type: "contact", variant: "thali-reserve-faq", title: "Thali reserve + FAQ" },
