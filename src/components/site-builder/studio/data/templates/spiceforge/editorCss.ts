...
[data-template-id="spiceforge"] .tpl-ken, [data-template-id="spiceforge"] .tpl-ken {
  animation: spiceforge-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="spiceforge"] .tpl-rise, [data-template-id="spiceforge"] .tpl-rise {
  animation: spiceforge-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="spiceforge"] .tpl-rise-2, [data-template-id="spiceforge"] .tpl-rise-2 {
  animation: spiceforge-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="spiceforge"] .tpl-rise-3, [data-template-id="spiceforge"] .tpl-rise-3 {
  animation: spiceforge-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="spiceforge"] .tpl-marquee-track, [data-template-id="spiceforge"] .tpl-marquee-track {
  display: flex; width: max-content; animation: spiceforge-marquee 28s linear infinite;
}
[data-template-id="spiceforge"] .tpl-float, [data-template-id="spiceforge"] .tpl-float {
  animation: spiceforge-float 5s ease-in-out infinite;
}
[data-template-id="spiceforge"] .tpl-sweep, [data-template-id="spiceforge"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="spiceforge"] .tpl-sweep::after, [data-template-id="spiceforge"] .tpl-sweep::after {
...
[data-template-id="spiceforge"] .tpl-climb, [data-template-id="spiceforge"] .tpl-climb {
...
[data-template-id="spiceforge"] .tpl-spice, [data-template-id="spiceforge"] .tpl-spice {
  animation: spiceforge-spice-fall var(--spice-dur, 9s) linear infinite;
}
[data-template-id="spiceforge"] .tpl-spice-wheel, [data-template-id="spiceforge"] .tpl-spice-wheel {
...
[data-template-id="spiceforge"] .tpl-spiral-step, [data-template-id="spiceforge"] .tpl-spiral-step {
