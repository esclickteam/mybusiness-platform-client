    ...
    <>
      ...
      <section data-template-section-type="packages" data-section-kind="packages" className="beauty-bridalPearl-packages-frame-3 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">PEARL / packages</p></div><span className="text-xs text-[var(--muted)]">כלה רגועה</span></div>
        </div>
      </section>
    ...
    <>
      <section data-template-section-type="aboutHero" data-section-kind="aboutHero" className="beauty-bridalPearl-aboutHero-frame-6 overflow-hidden px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-[0.85fr_1.15fr_0.55fr]">
          ...
          <div className="t-float hidden border border-[var(--p)]/35 p-5 md:block"><span className="text-xs text-[var(--muted)]">כלה רגועה</span></div>
        </div>
      </section>
      <section data-template-section-type="story" data-section-kind="story" className="beauty-bridalPearl-story-frame-7 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">PEARL / story</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">כלה רגועה</span></div>
      ...
      <section data-template-section-type="pressQuotes" data-section-kind="pressQuotes" className="beauty-bridalPearl-pressQuotes-frame-3 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">PEARL / pressQuotes</p></div><span className="text-xs text-[var(--muted)]">כלה רגועה</span></div>
        </div>
      </section>
  ...
  return (
    <>
      ...
      <section data-template-section-type="featuredTreatment" data-section-kind="featuredTreatment" className="beauty-bridalPearl-featuredTreatment-frame-7 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">PEARL / featuredTreatment</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">כלה רגועה</span></div>
      ...
      <section data-template-section-type="bookCta" data-section-kind="bookCta" className="beauty-bridalPearl-bookCta-frame-3 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">PEARL / bookCta</p></div><span className="text-xs text-[var(--muted)]">כלה רגועה</span></div>
        </div>
      </section>
      <footer data-template-section-type="footer" data-section-kind="footer" className="beauty-bridalPearl-footer-pearl px-5 py-12 text-center lg:px-8"><p className="t-display text-2xl sm:text-4xl text-[var(--p)]">{getValue(data,"brandName")}</p><p className="mt-3 text-sm text-[var(--muted)]">{getValue(data,"phone")} · {getValue(data,"email")}</p></footer>
    </>
  ...
  return (
    <>
      ...
      <section data-template-section-type="specialistPicker" data-section-kind="specialistPicker" className="beauty-bridalPearl-specialistPicker-frame-7 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">PEARL / specialistPicker</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">כלה רגועה</span></div>
