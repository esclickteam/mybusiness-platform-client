...
[data-template-id="advisora-preview"] .a-ken {
  animation: advisora-ken-burns 18s ease-out both;
  transform-origin: center;
}

[data-template-id="advisora"] .a-hero-in,
[data-template-id="advisora-preview"] .a-hero-in {
  animation: advisora-hero-rise .9s cubic-bezier(0.22, 1, 0.36, 1) both;
}

[data-template-id="advisora"] .a-d1,
[data-template-id="advisora-preview"] .a-d1 { animation-delay: .12s; }
[data-template-id="advisora"] .a-d2,
[data-template-id="advisora-preview"] .a-d2 { animation-delay: .24s; }
[data-template-id="advisora"] .a-d3,
[data-template-id="advisora-preview"] .a-d3 { animation-delay: .36s; }

[data-template-id="advisora"] .a-nav-link,
[data-template-id="advisora-preview"] .a-nav-link {
  position: relative;
  padding-block: .35rem;
...
[data-template-id="advisora-preview"] .a-nav-link::after {
  position: absolute;
  right: 0;
  bottom: 0;
  width: 100%;
...
[data-template-id="advisora-preview"] .a-nav-link:hover {
  color: var(--p);
}

[data-template-id="advisora"] .a-nav-link:hover::after,
[data-template-id="advisora-preview"] .a-nav-link:hover::after {
  transform: scaleX(1);
}

[data-template-id="advisora"] .a-service-viewport,
[data-template-id="advisora-preview"] .a-service-viewport {
...
[data-template-id="advisora-preview"] .a-service-viewport::-webkit-scrollbar {
  display: none;
}

[data-template-id="advisora"] .a-service-track,
[data-template-id="advisora-preview"] .a-service-track {
  display: flex;
  width: max-content;
  gap: 1rem;
...
[data-template-id="advisora-preview"] .a-image-frame img {
...
[data-template-id="advisora-preview"] .a-case-card:hover .a-image-frame img {
  filter: saturate(1.08);
  transform: scale(1.08);
}

[data-template-id="advisora"] .a-timeline-item span,
[data-template-id="advisora-preview"] .a-timeline-item span {
  box-shadow: 0 0 0 0 rgba(201, 162, 39, .45);
  transition: box-shadow .35s ease, transform .35s ease;
}

[data-template-id="advisora"] .a-timeline-item:hover span,
[data-template-id="advisora-preview"] .a-timeline-item:hover span {
