...
[data-template-id="seora"], [data-template-id="seora"] {
  --p: #2DD4BF;
  --a: #A3E635;
  --bg: #071513;
  --surface: #0F2421;
...
[data-template-id="seora"] .text-center { text-align: center; }
[data-template-id="seora"] .ag-display,
[data-template-id="seora"] .ag-display { font-family: "JetBrains Mono", "Frank Ruhl Libre", sans-serif; }
...
[data-template-id="seora"] .ag-ken { animation: seoraKen 19s ease-in-out infinite alternate; }
[data-template-id="seora"] .ag-float,
[data-template-id="seora"] .ag-float { animation: seoraFloat 8s ease-in-out infinite; }
[data-template-id="seora"] .ag-pulse,
[data-template-id="seora"] .ag-pulse { animation: seoraPulse 3.4s ease-in-out infinite; }
[data-template-id="seora"] .ag-scan,
[data-template-id="seora"] .ag-scan { animation: seoraScan 12s linear infinite; }
[data-template-id="seora"] .ag-drift,
[data-template-id="seora"] .ag-drift { animation: seoraDrift 13s ease-in-out infinite alternate; }
...
@media (prefers-reduced-motion: reduce) {
  ...
  [data-template-id="seora"] .ag-scan,
  [data-template-id="seora"] .ag-drift,
  [data-template-id="seora"] .ag-drift { animation: none; }
}
`;
