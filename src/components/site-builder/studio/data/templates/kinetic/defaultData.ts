export const kineticDefaultData = {
  templateId: "kinetic",
  name: "Kinetic",
  brandName: "Kinetic",
  logoText: "KI",
  ...
  navContact: "צור קשר",
  heroEyebrow: "Fitness Studio",
  heroTitle: "תנועה שמייצרת תוצאות.",
  ...
  phone: "03-000-0000",
  email: "hello@kinetic.co.il",
  address: "תל אביב, ישראל",
  footerText: "תבנית Kinetic — אתר רב-עמודי מקצועי עם עיצוב מלבני ותנועה.",
