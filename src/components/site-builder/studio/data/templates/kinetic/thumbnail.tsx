...
export default function KineticThumbnail() {
  ...
  return (
    <div dir={getTextDirection(i18n.language)} className="relative h-full min-h-[260px] w-full overflow-hidden p-5" style={{ background: "#0b0b0b", color: "#ffffff" }}>
      ...
      <div className="mt-10">
        <p className="mb-3 text-[10px] font-bold uppercase tracking-[0.24em]" style={{ color: "#ff2d2d" }}>
          {tx("סטודיו כושר")}</p>
        <h3 className="max-w-[220px] text-2xl font-black leading-tight">{tx("תנועה שמייצרת תוצאות.")}</h3>
