...
export const streetbiteSeed = {
  ...
  blocks: [
    ...
    { type: "map", variant: "bouncing-map-pins", title: "Bouncing map pins" },
    { type: "about", variant: "comic-panel-story", title: "Comic panel about" },
    { type: "contact", variant: "sms-chat-form", title: "SMS chat contact" },
