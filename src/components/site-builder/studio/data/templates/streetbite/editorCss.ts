...
[data-template-id="streetbite"], [data-template-id="streetbite-preview"] {
...
[data-template-id="streetbite-preview"] .tpl-display {
...
[data-template-id="streetbite"] .tpl-ken, [data-template-id="streetbite-preview"] .tpl-ken {
  animation: streetbite-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="streetbite"] .tpl-rise, [data-template-id="streetbite-preview"] .tpl-rise {
  animation: streetbite-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="streetbite"] .tpl-rise-2, [data-template-id="streetbite-preview"] .tpl-rise-2 {
  animation: streetbite-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="streetbite"] .tpl-rise-3, [data-template-id="streetbite-preview"] .tpl-rise-3 {
  animation: streetbite-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="streetbite"] .tpl-marquee-track, [data-template-id="streetbite-preview"] .tpl-marquee-track {
  display: flex; width: max-content; animation: streetbite-marquee 28s linear infinite;
}
[data-template-id="streetbite"] .tpl-float, [data-template-id="streetbite-preview"] .tpl-float {
  animation: streetbite-float 5s ease-in-out infinite;
}
[data-template-id="streetbite"] .tpl-sweep, [data-template-id="streetbite-preview"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="streetbite"] .tpl-sweep::after, [data-template-id="streetbite-preview"] .tpl-sweep::after {
...
[data-template-id="streetbite"] .tpl-climb, [data-template-id="streetbite-preview"] .tpl-climb {
...
[data-template-id="streetbite"] .tpl-truck, [data-template-id="streetbite-preview"] .tpl-truck {
  animation: streetbite-truck-slide 18s linear infinite;
}
[data-template-id="streetbite"] .tpl-neon-title, [data-template-id="streetbite-preview"] .tpl-neon-title {
  animation: streetbite-neon-flicker 3.5s linear infinite; color: #39d353;
}
[data-template-id="streetbite"] .tpl-pin, [data-template-id="streetbite-preview"] .tpl-pin {
  animation: streetbite-pin-bounce 1.8s ease-in-out infinite;
}
[data-template-id="streetbite"] .tpl-stack-card, [data-template-id="streetbite-preview"] .tpl-stack-card {
  animation: streetbite-stack-in .8s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="streetbite"] .tpl-ticket-tear, [data-template-id="streetbite-preview"] .tpl-ticket-tear {
