    ...
    <section className="border-t px-5 py-16 lg:px-8 lg:py-20" style={{ borderColor: "rgba(230,237,243,0.12)", background: "#161b22" }}>
      <div className="mx-auto max-w-md">
        <div className="rounded-2xl border p-4" style={{ borderColor: "rgba(230,237,243,0.12)", background: "#0d1117" }}>
          ...
          <form className="grid gap-2"  data-bizuply-block="lead-form" data-bizuply-form-id="streetbite-contact-1" data-bizuply-crm-lead="true" data-bizuply-success-message="תודה! קיבלנו את הפנייה ונחזור אליכם בהקדם." >
            <input name="message" data-bizuply-form-field-id="message"  className="w-full rounded-full border bg-transparent px-4 py-3 text-right text-sm outline-none" style={{ borderColor: "rgba(230,237,243,0.12)" }} placeholder="הקלידו הודעה..." />
