...
function Header({ data, currentPage, goTo }: { data: Record<string, any>; currentPage: string; goTo: (id: string) => void }) {
  return (
    ...
    <div className="mx-auto flex max-w-7xl items-center gap-5 px-5 py-4 lg:px-8">
      ...
      <button type="button" onClick={() => goTo("booking")} className="mr-auto px-4 py-2 text-xs font-bold t-glow bg-[var(--p)] text-white">{getValue(data,"heroPrimaryButton")}</button>
    </div>
  </header>
  );
}
    ...
    <>
      ...
      <section data-template-section-type="packages" data-section-kind="packages" className="beauty-colorHaus-packages-frame-3 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">CHROMA / packages</p></div><span className="text-xs text-[var(--muted)]">בר צבע</span></div>
        </div>
      </section>
    ...
    <>
      <section data-template-section-type="aboutHero" data-section-kind="aboutHero" className="beauty-colorHaus-aboutHero-frame-6 overflow-hidden px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-[0.85fr_1.15fr_0.55fr]">
          ...
          <div className="t-float hidden border border-[var(--p)]/35 p-5 md:block"><span className="text-xs text-[var(--muted)]">בר צבע</span></div>
        </div>
      </section>
      <section data-template-section-type="story" data-section-kind="story" className="beauty-colorHaus-story-frame-7 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">CHROMA / story</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">בר צבע</span></div>
      ...
      <section data-template-section-type="pressQuotes" data-section-kind="pressQuotes" className="beauty-colorHaus-pressQuotes-frame-3 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">CHROMA / pressQuotes</p></div><span className="text-xs text-[var(--muted)]">בר צבע</span></div>
        </div>
      </section>
  ...
  return (
    <>
      ...
      <section data-template-section-type="featuredTreatment" data-section-kind="featuredTreatment" className="beauty-colorHaus-featuredTreatment-frame-7 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">CHROMA / featuredTreatment</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">בר צבע</span></div>
      ...
      <section data-template-section-type="bookCta" data-section-kind="bookCta" className="beauty-colorHaus-bookCta-frame-3 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">CHROMA / bookCta</p></div><span className="text-xs text-[var(--muted)]">בר צבע</span></div>
        </div>
      </section>
      <footer data-template-section-type="footer" data-section-kind="footer" className="beauty-colorHaus-footer-pearl px-5 py-12 text-center lg:px-8"><p className="t-display text-2xl sm:text-4xl text-[var(--p)]">{getValue(data,"brandName")}</p><p className="mt-3 text-sm text-[var(--muted)]">{getValue(data,"phone")} · {getValue(data,"email")}</p></footer>
    </>
    ...
    <>
      ...
      <section data-section-kind="booking" data-bizuply-block="booking" data-template-section-type="booking" className="beauty-colorHaus-calendar-frame-5 bg-[var(--bg)] px-5 py-20 lg:px-8">
        <div className="mx-auto max-w-6xl rounded-3xl border border-[var(--p)]/20 bg-[var(--surface)] p-7 shadow-xl md:p-12">
          ...
          <div className="grid gap-8 lg:grid-cols-[0.75fr_1.25fr] lg:items-start"><Reveal><h2 className="t-display text-2xl sm:text-4xl text-[var(--p)]">{getValue(data,"calendarTitle")}</h2><p className="mt-4 text-[var(--muted)]">בחרו יום ושעה פנויה. הלוח כאן לשמירת תור מהירה מתוך התבנית.</p></Reveal><Reveal delayMs={100} className="t-glow bg-[var(--surface)]/80 p-5"><BookingCalendarPanel pill compact /></Reveal></div>
        </div>
      </section>
      ...
      <section data-template-section-type="specialistPicker" data-section-kind="specialistPicker" className="beauty-colorHaus-specialistPicker-frame-7 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">CHROMA / specialistPicker</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">בר צבע</span></div>
...
export default function ChromabarPages(props: ChromabarPagesProps) {
  ...
  const mergedData = useMemo(() => ({ ...chromabarDefaultData, ...(data ?? {}) }), [data]);
  ...
  return (
    <div dir="rtl" data-template-id={mode === "preview" ? "chromabar-preview" : "chromabar"} className="min-h-screen w-full overflow-x-hidden" style={{ background: "#0B1220", color: "#EAF2FF" }}>
