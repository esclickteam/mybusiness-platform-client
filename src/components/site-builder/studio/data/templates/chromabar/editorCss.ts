...
[data-template-id="chromabar"] .t-ken { animation: chromabar-ken 18s ease-in-out infinite alternate; }
[data-template-id="chromabar"] .t-anim,
[data-template-id="chromabar"] .t-anim { animation: chromabar-up 0.9s cubic-bezier(0.22,1,0.36,1) both; }
[data-template-id="chromabar"] .t-d1,
[data-template-id="chromabar"] .t-d1 { animation-delay: .12s; }
[data-template-id="chromabar"] .t-d2,
[data-template-id="chromabar"] .t-d2 { animation-delay: .24s; }
[data-template-id="chromabar"] .t-d3,
[data-template-id="chromabar"] .t-d3 { animation-delay: .36s; }
[data-template-id="chromabar"] .t-fade,
[data-template-id="chromabar"] .t-fade { animation: chromabar-fade 1s ease both; }
[data-template-id="chromabar"] .t-marquee,
[data-template-id="chromabar"] .t-marquee { animation: chromabar-marquee 30s linear infinite; width: max-content; }
[data-template-id="chromabar"] .t-float,
[data-template-id="chromabar"] .t-float { animation: chromabar-float 6s ease-in-out infinite; }
[data-template-id="chromabar"] .t-pulse,
[data-template-id="chromabar"] .t-pulse { animation: chromabar-pulse 2.8s ease-in-out infinite; }
...
[data-template-id="chromabar"] .t-glow { animation: chromabar-glow 3.2s ease-in-out infinite; }
[data-template-id="chromabar"] .t-scalein,
[data-template-id="chromabar"] .t-scalein { animation: chromabar-scalein 0.8s cubic-bezier(0.22,1,0.36,1) both; }
...
[data-template-id="chromabar"] .t-hover:hover { transform: translateY(-5px); }
...
@media (prefers-reduced-motion: reduce) {
  ...
  [data-template-id="chromabar"] .t-scalein,
  [data-template-id="chromabar"] .t-fade,
  [data-template-id="chromabar"] .t-fade { animation: none !important; }
}
`;
