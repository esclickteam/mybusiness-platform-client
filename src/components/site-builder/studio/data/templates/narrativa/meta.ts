...
export const narrativaSeed = {
  ...
  name: "Narrativa",
  title: "Narrativa",
  description: "אתר מלא לסוכנות יחסי ציבור: 8 עמודים, תנועה, אפקטים ועיצוב ייחודי.",
  category: "portfolio",
...
export const narrativaTemplate = {
  ...
  categoryLabel: "פורטפוליו וסוכנות",
  badge: "חדש",
  description: "אתר מלא לסוכנות יחסי ציבור עם 8 עמודים, תנועה ואפקטים — עיצוב ייחודי.",
