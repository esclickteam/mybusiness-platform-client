  ...
  return (
    <section className="px-5 py-20 lg:px-8 lg:py-28">
      <Reveal className="mx-auto max-w-4xl border border-black/10 bg-[var(--surface)] p-6 text-right md:p-10">
        ...
        <form className="grid gap-3" data-bizuply-block="lead-form" data-bizuply-crm-lead="true" data-bizuply-form-builder="true" data-bizuply-form-id="narrativa-contact" data-bizuply-success-message="תודה! קיבלנו את הפנייה ונחזור אלייך בהקדם.">
