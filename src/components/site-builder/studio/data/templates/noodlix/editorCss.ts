...
[data-template-id="noodlix"], [data-template-id="noodlix-preview"] {
...
[data-template-id="noodlix-preview"] .tpl-display {
...
[data-template-id="noodlix"] .tpl-ken, [data-template-id="noodlix-preview"] .tpl-ken {
  animation: noodlix-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="noodlix"] .tpl-rise, [data-template-id="noodlix-preview"] .tpl-rise {
  animation: noodlix-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="noodlix"] .tpl-rise-2, [data-template-id="noodlix-preview"] .tpl-rise-2 {
  animation: noodlix-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="noodlix"] .tpl-rise-3, [data-template-id="noodlix-preview"] .tpl-rise-3 {
  animation: noodlix-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="noodlix"] .tpl-marquee-track, [data-template-id="noodlix-preview"] .tpl-marquee-track {
  display: flex; width: max-content; animation: noodlix-marquee 28s linear infinite;
}
[data-template-id="noodlix"] .tpl-float, [data-template-id="noodlix-preview"] .tpl-float {
  animation: noodlix-float 5s ease-in-out infinite;
}
[data-template-id="noodlix"] .tpl-sweep, [data-template-id="noodlix-preview"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="noodlix"] .tpl-sweep::after, [data-template-id="noodlix-preview"] .tpl-sweep::after {
...
[data-template-id="noodlix"] .tpl-climb, [data-template-id="noodlix-preview"] .tpl-climb {
...
[data-template-id="noodlix"] .tpl-steam, [data-template-id="noodlix-preview"] .tpl-steam {
  animation: noodlix-steam var(--steam-dur, 6s) ease-in infinite;
}
[data-template-id="noodlix"] .tpl-bowl-float, [data-template-id="noodlix-preview"] .tpl-bowl-float {
  animation: noodlix-bowl-float 5s ease-in-out infinite;
}
[data-template-id="noodlix"] .tpl-radial-orbit, [data-template-id="noodlix-preview"] .tpl-radial-orbit {
  animation: noodlix-radial-spin 40s linear infinite;
}
[data-template-id="noodlix"] .tpl-steam-card, [data-template-id="noodlix-preview"] .tpl-steam-card {
