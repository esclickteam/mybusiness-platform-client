...
[data-template-id="blushlab"] .t-ken { animation: blushlab-ken 18s ease-in-out infinite alternate; }
[data-template-id="blushlab"] .t-anim,
[data-template-id="blushlab"] .t-anim { animation: blushlab-up 0.9s cubic-bezier(0.22,1,0.36,1) both; }
[data-template-id="blushlab"] .t-d1,
[data-template-id="blushlab"] .t-d1 { animation-delay: .12s; }
[data-template-id="blushlab"] .t-d2,
[data-template-id="blushlab"] .t-d2 { animation-delay: .24s; }
[data-template-id="blushlab"] .t-d3,
[data-template-id="blushlab"] .t-d3 { animation-delay: .36s; }
[data-template-id="blushlab"] .t-fade,
[data-template-id="blushlab"] .t-fade { animation: blushlab-fade 1s ease both; }
[data-template-id="blushlab"] .t-marquee,
[data-template-id="blushlab"] .t-marquee { animation: blushlab-marquee 30s linear infinite; width: max-content; }
[data-template-id="blushlab"] .t-float,
[data-template-id="blushlab"] .t-float { animation: blushlab-float 6s ease-in-out infinite; }
[data-template-id="blushlab"] .t-pulse,
[data-template-id="blushlab"] .t-pulse { animation: blushlab-pulse 2.8s ease-in-out infinite; }
...
[data-template-id="blushlab"] .t-glow { animation: blushlab-glow 3.2s ease-in-out infinite; }
[data-template-id="blushlab"] .t-scalein,
[data-template-id="blushlab"] .t-scalein { animation: blushlab-scalein 0.8s cubic-bezier(0.22,1,0.36,1) both; }
...
[data-template-id="blushlab"] .t-hover:hover { transform: translateY(-5px); }
...
@media (prefers-reduced-motion: reduce) {
  ...
  [data-template-id="blushlab"] .t-scalein,
  [data-template-id="blushlab"] .t-fade,
  [data-template-id="blushlab"] .t-fade { animation: none !important; }
}
`;
