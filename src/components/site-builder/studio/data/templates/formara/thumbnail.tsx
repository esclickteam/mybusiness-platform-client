...
export default function FormaraThumbnail() {
  ...
  return (
    <div dir={getTextDirection(i18n.language)} className="relative h-full min-h-[260px] w-full overflow-hidden" style={{ background: "#1E1C1A", color: "#F3EEE7" }}>
      <img
      ...
      <div className="relative z-10 flex h-full flex-col justify-between p-5">
        <div className="flex items-center justify-between border-b border-white/15 pb-3">
          <span className="text-[10px] font-bold tracking-[0.22em]" style={{ color: "#C4A484" }}>{tx("עיצוב פנים")}</span>
        ...
        <div className="border-t-4 p-4" style={{ borderColor: "#8B5E3C", background: "rgba(30,28,26,.88)" }}>
          ...
          <p className="mt-2 max-w-[210px] text-xs leading-5" style={{ color: "#B6AAA0" }}>{tx("חללים שקטים, חומרים עם עומק.")}</p>
