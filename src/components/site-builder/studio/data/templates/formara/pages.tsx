    ...
    <section data-template-section-type="contact" className="bg-[#1E1C1A] px-5 py-24 lg:px-8 lg:py-32">
      <div className="mx-auto grid max-w-7xl gap-10 border border-[var(--p)]/30 bg-[#28231F] p-6 lg:grid-cols-[0.85fr_1.15fr] lg:p-12">
        ...
        <Reveal variant="left" delayMs={120}>
          <form className="grid gap-4 bg-[#1E1C1A] p-6 lg:p-8" data-bizuply-block="lead-form" data-bizuply-crm-lead="true" data-bizuply-form-builder="true" data-bizuply-form-id="formara-contact" data-bizuply-success-message="תודה! קיבלנו את הפנייה ונחזור אלייך בהקדם.">
  ...
  return (
    <div className="fixed inset-0 z-[80] grid place-items-center bg-black/75 px-4 backdrop-blur-sm">
      <div className="relative w-full max-w-md border border-[var(--p)]/40 bg-[#1E1C1A] p-8 text-white">
        ...
        <form className="mt-6 grid gap-3" data-bizuply-block="lead-form" data-bizuply-crm-lead="true" data-bizuply-form-builder="true" data-bizuply-form-id="formara-contact-2" data-bizuply-success-message="תודה! קיבלנו את הפנייה ונחזור אלייך בהקדם.">
