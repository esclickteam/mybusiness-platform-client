      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-8 grid gap-4">
            {["מדידות והשראה", "תוכנית עיצוב", "ליווי ביצוע"].map((step, i) => (
...
export default function FormaraPages(props: FormaraPagesProps) {
  ...
  return (
    <div dir="rtl" data-template-id={mode === "preview" ? "formara-preview" : "formara"} className="min-h-screen w-full overflow-x-hidden">
