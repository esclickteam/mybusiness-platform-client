...
[data-template-id="spajade"] .t-ken { animation: spajade-ken 18s ease-in-out infinite alternate; }
[data-template-id="spajade"] .t-anim,
[data-template-id="spajade"] .t-anim { animation: spajade-up 0.9s cubic-bezier(0.22,1,0.36,1) both; }
[data-template-id="spajade"] .t-d1,
[data-template-id="spajade"] .t-d1 { animation-delay: .12s; }
[data-template-id="spajade"] .t-d2,
[data-template-id="spajade"] .t-d2 { animation-delay: .24s; }
[data-template-id="spajade"] .t-d3,
[data-template-id="spajade"] .t-d3 { animation-delay: .36s; }
[data-template-id="spajade"] .t-fade,
[data-template-id="spajade"] .t-fade { animation: spajade-fade 1s ease both; }
[data-template-id="spajade"] .t-marquee,
[data-template-id="spajade"] .t-marquee { animation: spajade-marquee 30s linear infinite; width: max-content; }
[data-template-id="spajade"] .t-float,
[data-template-id="spajade"] .t-float { animation: spajade-float 6s ease-in-out infinite; }
[data-template-id="spajade"] .t-pulse,
[data-template-id="spajade"] .t-pulse { animation: spajade-pulse 2.8s ease-in-out infinite; }
...
[data-template-id="spajade"] .t-glow { animation: spajade-glow 3.2s ease-in-out infinite; }
[data-template-id="spajade"] .t-scalein,
[data-template-id="spajade"] .t-scalein { animation: spajade-scalein 0.8s cubic-bezier(0.22,1,0.36,1) both; }
...
[data-template-id="spajade"] .t-hover:hover { transform: translateY(-5px); }
...
@media (prefers-reduced-motion: reduce) {
  ...
  [data-template-id="spajade"] .t-scalein,
  [data-template-id="spajade"] .t-fade,
  [data-template-id="spajade"] .t-fade { animation: none !important; }
}
`;
