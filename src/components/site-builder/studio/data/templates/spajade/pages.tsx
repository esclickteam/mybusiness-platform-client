...
function HomePage({ data, goTo }: { data: Record<string, any>; goTo: (id: string) => void }) {
  return (
    <>
      ...
      <section data-template-section-type="servicesPreview" data-section-kind="servicesPreview" className="beauty-jadeSpa-servicesPreview-frame-4 relative overflow-hidden bg-[var(--dark)] px-5 py-24 text-[var(--text)] lg:px-8">
      ...
      <section data-template-section-type="gallery" data-section-kind="gallery" className="beauty-jadeSpa-gallery-frame-6 overflow-hidden px-5 py-24 lg:px-8">
      ...
      <section data-template-section-type="team" data-section-kind="team" className="beauty-jadeSpa-team-frame-7 px-5 py-24 lg:px-8">
      ...
      <section data-template-section-type="testimonials" data-section-kind="testimonials" className="beauty-jadeSpa-testimonials-frame-8 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--a)_16%,transparent),transparent)] px-5 py-24 text-center lg:px-8">
      ...
      <section data-template-section-type="whyUs" data-section-kind="whyUs" className="beauty-jadeSpa-whyUs-frame-0 relative isolate overflow-hidden px-5 py-24 lg:px-8">
      ...
      <section data-template-section-type="bookingTeaser" data-section-kind="bookingTeaser" className="beauty-jadeSpa-bookingTeaser-frame-1 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.72fr_1.28fr]">
          <aside className="lg:sticky lg:top-28 lg:h-fit"><div className="t-shimmer mb-5 h-px w-32 bg-[var(--p)]" /><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">JADE / bookingTeaser</p><div className="mt-6 t-display text-5xl leading-none text-[var(--p)]">02</div></aside>
...
function AboutPage({ data, goTo }: { data: Record<string, any>; goTo: (id: string) => void }) {
  return (
    <>
      ...
      <section data-template-section-type="story" data-section-kind="story" className="beauty-jadeSpa-story-frame-3 px-5 py-24 lg:px-8">
      ...
      <section data-template-section-type="spaceTour" data-section-kind="spaceTour" className="beauty-jadeSpa-spaceTour-frame-4 relative overflow-hidden bg-[var(--dark)] px-5 py-24 text-[var(--text)] lg:px-8">
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,transparent,color-mix(in_srgb,var(--p)_18%,transparent),transparent)]" />
        <div className="relative mx-auto max-w-7xl border border-[var(--p)]/45 p-6 shadow-[0_0_44px_color-mix(in_srgb,var(--p)_18%,transparent)] md:p-10">
      ...
      <section data-template-section-type="specialistsDeep" data-section-kind="specialistsDeep" className="beauty-jadeSpa-specialistsDeep-frame-6 overflow-hidden px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-[0.85fr_1.15fr_0.55fr]">
      ...
      <section data-template-section-type="certifications" data-section-kind="certifications" className="beauty-jadeSpa-certifications-frame-7 px-5 py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
      ...
      <section data-template-section-type="timeline" data-section-kind="timeline" className="beauty-jadeSpa-timeline-frame-8 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--a)_16%,transparent),transparent)] px-5 py-24 text-center lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="mx-auto mb-8 h-16 w-px bg-[var(--p)]" />
      ...
      <section data-template-section-type="aboutCta" data-section-kind="aboutCta" className="beauty-jadeSpa-aboutCta-frame-0 relative isolate overflow-hidden px-5 py-24 lg:px-8">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_15%,color-mix(in_srgb,var(--p)_28%,transparent),transparent_34%),linear-gradient(135deg,color-mix(in_srgb,var(--surface)_70%,transparent),transparent_58%)]" />
        <div className="relative mx-auto max-w-7xl">
...
function ServicesPage({ data, goTo }: { data: Record<string, any>; goTo: (id: string) => void }) {
  return (
    <>
      <section data-template-section-type="servicesHero" data-section-kind="servicesHero" className="beauty-jadeSpa-servicesHero-frame-1 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.72fr_1.28fr]">
          <aside className="lg:sticky lg:top-28 lg:h-fit"><div className="t-shimmer mb-5 h-px w-32 bg-[var(--p)]" /><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">JADE / servicesHero</p><div className="mt-6 t-display text-5xl leading-none text-[var(--p)]">02</div></aside>
      ...
      <section data-template-section-type="featuredTreatment" data-section-kind="featuredTreatment" className="beauty-jadeSpa-featuredTreatment-frame-3 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
      ...
      <section data-template-section-type="durationGuide" data-section-kind="durationGuide" className="beauty-jadeSpa-durationGuide-frame-4 relative overflow-hidden bg-[var(--dark)] px-5 py-24 text-[var(--text)] lg:px-8">
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,transparent,color-mix(in_srgb,var(--p)_18%,transparent),transparent)]" />
        <div className="relative mx-auto max-w-7xl border border-[var(--p)]/45 p-6 shadow-[0_0_44px_color-mix(in_srgb,var(--p)_18%,transparent)] md:p-10">
      ...
      <section data-template-section-type="beforeAfter" data-section-kind="beforeAfter" className="beauty-jadeSpa-beforeAfter-frame-6 overflow-hidden px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-[0.85fr_1.15fr_0.55fr]">
      ...
      <section data-template-section-type="priceTable" data-section-kind="priceTable" className="beauty-jadeSpa-priceTable-frame-7 px-5 py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
      ...
      <section data-template-section-type="serviceFaq" data-section-kind="serviceFaq" className="beauty-jadeSpa-serviceFaq-frame-8 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--a)_16%,transparent),transparent)] px-5 py-24 text-center lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="mx-auto mb-8 h-16 w-px bg-[var(--p)]" />
...
function BookingPage({ data, goTo }: { data: Record<string, any>; goTo: (id: string) => void }) {
  return (
    <>
      <section data-template-section-type="bookingHero" data-section-kind="bookingHero" className="beauty-jadeSpa-bookingHero-frame-0 relative isolate overflow-hidden px-5 py-24 lg:px-8">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_20%_15%,color-mix(in_srgb,var(--p)_28%,transparent),transparent_34%),linear-gradient(135deg,color-mix(in_srgb,var(--surface)_70%,transparent),transparent_58%)]" />
        <div className="relative mx-auto max-w-7xl">
      ...
      <section data-section-kind="booking" data-bizuply-block="booking" data-template-section-type="booking" className="beauty-jadeSpa-calendar-frame-1 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.72fr_1.28fr]">
          <aside className="lg:sticky lg:top-28 lg:h-fit"><div className="t-shimmer mb-5 h-px w-32 bg-[var(--p)]" /><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">JADE / calendar</p><div className="mt-6 t-display text-5xl leading-none text-[var(--p)]">02</div></aside>
      ...
      <section data-template-section-type="specialistPicker" data-section-kind="specialistPicker" className="beauty-jadeSpa-specialistPicker-frame-3 px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
      ...
      <section data-template-section-type="hoursPanel" data-section-kind="hoursPanel" className="beauty-jadeSpa-hoursPanel-frame-4 relative overflow-hidden bg-[var(--dark)] px-5 py-24 text-[var(--text)] lg:px-8">
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,transparent,color-mix(in_srgb,var(--p)_18%,transparent),transparent)]" />
        <div className="relative mx-auto max-w-7xl border border-[var(--p)]/45 p-6 shadow-[0_0_44px_color-mix(in_srgb,var(--p)_18%,transparent)] md:p-10">
      ...
      <section data-template-section-type="confirmationForm" data-section-kind="confirmationForm" className="beauty-jadeSpa-confirmationForm-frame-6 overflow-hidden px-5 py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-[0.85fr_1.15fr_0.55fr]">
      ...
      <section data-template-section-type="locationMap" data-section-kind="locationMap" className="beauty-jadeSpa-locationMap-frame-7 px-5 py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
      ...
      <section data-template-section-type="bookingFaq" data-section-kind="bookingFaq" className="beauty-jadeSpa-bookingFaq-frame-8 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--a)_16%,transparent),transparent)] px-5 py-24 text-center lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="mx-auto mb-8 h-16 w-px bg-[var(--p)]" />
