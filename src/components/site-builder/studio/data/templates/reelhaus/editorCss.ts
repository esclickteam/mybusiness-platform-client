...
[data-template-id="reelhaus"], [data-template-id="reelhaus-preview"] {
  --p: #D4AF37;
  --a: #E11D48;
  --bg: #0C0A09;
  --surface: #1C1917;
...
[data-template-id="reelhaus-preview"] .text-center { text-align: center; }
[data-template-id="reelhaus"] .ag-display,
[data-template-id="reelhaus-preview"] .ag-display { font-family: "Playfair Display", "David Libre", sans-serif; }
[data-template-id="reelhaus"] .ag-card,
[data-template-id="reelhaus-preview"] .ag-card {
...
[data-template-id="reelhaus-preview"] .ag-card:hover {
  transform: translateY(-16px) rotate(-0.7deg);
  border-color: var(--a);
  box-shadow: 0 24px 70px rgba(0,0,0,0.28);
}
[data-template-id="reelhaus"] .ag-ken,
[data-template-id="reelhaus-preview"] .ag-ken { animation: reelhausKen 26s ease-in-out infinite alternate; }
[data-template-id="reelhaus"] .ag-float,
[data-template-id="reelhaus-preview"] .ag-float { animation: reelhausFloat 5s ease-in-out infinite; }
[data-template-id="reelhaus"] .ag-pulse,
[data-template-id="reelhaus-preview"] .ag-pulse { animation: reelhausPulse 3.1s ease-in-out infinite; }
[data-template-id="reelhaus"] .ag-scan,
[data-template-id="reelhaus-preview"] .ag-scan { animation: reelhausScan 19s linear infinite; }
[data-template-id="reelhaus"] .ag-drift,
[data-template-id="reelhaus-preview"] .ag-drift { animation: reelhausDrift 20s ease-in-out infinite alternate; }
...
@media (prefers-reduced-motion: reduce) {
  [data-template-id="reelhaus"] .ag-ken,
  [data-template-id="reelhaus-preview"] .ag-ken,
  [data-template-id="reelhaus"] .ag-float,
  [data-template-id="reelhaus-preview"] .ag-float,
  [data-template-id="reelhaus"] .ag-pulse,
  [data-template-id="reelhaus-preview"] .ag-pulse,
  [data-template-id="reelhaus"] .ag-scan,
  [data-template-id="reelhaus-preview"] .ag-scan,
  [data-template-id="reelhaus"] .ag-drift,
  [data-template-id="reelhaus-preview"] .ag-drift { animation: none; }
}
`;
