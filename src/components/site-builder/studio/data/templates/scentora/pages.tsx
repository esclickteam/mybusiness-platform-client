...
import { scentoraDefaultData, scentoraDemoProducts } from "./defaultData";
import { scentoraEditorCss } from "./editorCss";

export const scentoraPages = [
...
export default function ScentoraPages(props: any) {
  return (
    <RichStoreSiteRuntime
      ...
      demoProducts={scentoraDemoProducts}
      pages={scentoraPages}
    />
  );
}
