export const prismDefaultData = {
  templateId: "prism",
  name: "Prism",
  brandName: "Prism",
  logoText: "PR",
  tagline: "סוכנות עיצוב",
  navHome: "בית",
  navAbout: "אודות",
  navServices: "שירותים",
  navWork: "פרויקטים",
  navInsights: "תובנות",
  navContact: "צור קשר",
  heroEyebrow: "סוכנות עיצוב",
  heroTitle: "צורה. צבע. מסר.",
  ...
  phone: "03-000-0000",
  email: "hello@prism.co.il",
  address: "תל אביב, ישראל",
  footerText: "תבנית Prism — אתר רב-עמודי מקצועי עם עיצוב מלבני ותנועה.",
