...
export default function PrismThumbnail() {
  ...
  return (
    <div dir={getTextDirection(i18n.language)} className="relative h-full min-h-[260px] w-full overflow-hidden p-5" style={{ background: "#fffef8", color: "#0a0a0a" }}>
      <div className="flex items-center justify-between">
        ...
        <span className="text-[10px] font-bold uppercase tracking-[0.2em]" style={{ color: "#0057ff" }}>
          {tx("סוכנות עיצוב")}</span>
      </div>
      <div className="mt-10">
        <p className="mb-3 text-[10px] font-bold uppercase tracking-[0.24em]" style={{ color: "#0057ff" }}>
          {tx("סוכנות עיצוב")}</p>
        <h3 className="max-w-[220px] text-2xl font-black leading-tight">{tx("צורה. צבע. מסר.")}</h3>
