      ...
      <div className="mx-auto max-w-5xl border border-black/10 bg-[var(--surface)] p-4">
        <div className="grid gap-8 border border-black/10 p-6 md:p-10 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <Reveal variant="left" delayMs={100}>
            <form className="grid gap-3" data-bizuply-block="lead-form" data-bizuply-form-id="summitops-contact-1" data-bizuply-crm-lead="true" data-bizuply-success-message="תודה! קיבלנו את הפנייה ונחזור אליכם בהקדם.">
              ...
              <textarea name="message" data-bizuply-form-field-id="message"  className="min-h-32 border border-black/10 bg-[var(--bg)] px-4 py-4 text-right outline-none" placeholder="מה נרצה לפתור בפגישה?" />
...
export default function SummitopsPages({
  ...
  return (
    <div dir="rtl" data-template-id={mode === "preview" ? "summitops-preview" : "summitops"} className="min-h-screen w-full overflow-x-hidden">
