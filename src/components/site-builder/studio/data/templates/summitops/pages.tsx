      ...
      <div className="mx-auto max-w-5xl border border-black/10 bg-[var(--surface)] p-4">
        <div className="grid gap-8 border border-black/10 p-6 md:p-10 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <Reveal variant="left" delayMs={100}>
            <form className="grid gap-3" data-bizuply-block="lead-form" data-bizuply-crm-lead="true" data-bizuply-form-builder="true" data-bizuply-form-id="summitops-contact" data-bizuply-success-message="תודה! קיבלנו את הפנייה ונחזור אלייך בהקדם.">
