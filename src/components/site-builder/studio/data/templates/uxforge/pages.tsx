        ...
        <div className="mt-14 grid gap-5 lg:grid-cols-4">
          {steps.map(([title, text], i) => (
            <Reveal key={title} delayMs={i * 100} variant="scale">
              <article className="ag-card rounded-[2rem] border border-current/10 bg-[var(--surface)]/80 p-6 text-right ">
...
export default function UxforgePages({
  ...
  return (
    <div dir="rtl" data-template-id="uxforge" className="min-h-screen w-full overflow-x-hidden">
