...
[data-template-id="uxforge"], [data-template-id="uxforge"] {
  --p: #111827;
  --a: #06B6D4;
  --bg: #F3F4F6;
  --surface: #FFFFFF;
...
[data-template-id="uxforge"] .text-center { text-align: center; }
[data-template-id="uxforge"] .ag-display,
[data-template-id="uxforge"] .ag-display { font-family: "Syne", "Miriam Libre", sans-serif; }
...
[data-template-id="uxforge"] .ag-ken { animation: uxforgeKen 25s ease-in-out infinite alternate; }
[data-template-id="uxforge"] .ag-float,
[data-template-id="uxforge"] .ag-float { animation: uxforgeFloat 9s ease-in-out infinite; }
[data-template-id="uxforge"] .ag-pulse,
[data-template-id="uxforge"] .ag-pulse { animation: uxforgePulse 2.8s ease-in-out infinite; }
[data-template-id="uxforge"] .ag-scan,
[data-template-id="uxforge"] .ag-scan { animation: uxforgeScan 18s linear infinite; }
[data-template-id="uxforge"] .ag-drift,
[data-template-id="uxforge"] .ag-drift { animation: uxforgeDrift 19s ease-in-out infinite alternate; }
...
@media (prefers-reduced-motion: reduce) {
  ...
  [data-template-id="uxforge"] .ag-scan,
  [data-template-id="uxforge"] .ag-drift,
  [data-template-id="uxforge"] .ag-drift { animation: none; }
}
`;
