      ...
      <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-12">
        <Reveal variant="scale" className="lg:col-span-7">
          <div className="grid gap-4 md:grid-cols-6">
            ...
            <div className="flex min-h-[260px] flex-col justify-between border border-black/10 bg-[var(--surface)] p-6 text-start md:col-span-2">
            ...
            <div className="flex min-h-[180px] flex-col justify-center border border-black/10 bg-[var(--p)] p-6 text-start text-white md:col-span-2">
        ...
        <Reveal variant="right" className="flex flex-col justify-center border border-black/10 bg-[var(--surface)] p-7 text-start lg:col-span-5 lg:mt-16">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-2">
          {items.map(([title, text, image], i) => (
            <Reveal key={title} delayMs={i * 90} variant="up">
              <article className={`ag-card grid overflow-hidden border border-black/10 bg-[var(--surface)] text-start md:grid-cols-[0.8fr_1.2fr] ${i === 0 ? "lg:col-span-2 lg:max-w-5xl" : ""} ${i === 1 ? "lg:mt-12" : ""}`}>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-[1fr_0.72fr]">
          <div className="border border-black/10 bg-[var(--bg)]">
            {items.map(([name, role, image], i) => (
              <Reveal key={name} delayMs={i * 90} variant="right">
                <article className="flex flex-col gap-5 border-b border-black/10 p-5 text-start last:border-b-0 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Reveal variant="left" delayMs={120}>
            <aside className="flex h-full flex-col justify-between border border-black/10 bg-[var(--p)] p-7 text-start text-white">
              <div>
  ...
  return (
    <section className="bg-[var(--surface)] px-5 py-20 lg:px-8 lg:py-28">
      <div className="mx-auto grid max-w-7xl gap-0 border border-black/10 lg:grid-cols-2 lg:[direction:ltr]">
        <Reveal variant="right" className="flex flex-col justify-between bg-[var(--p)] p-7 text-start text-white md:p-10 lg:[direction:rtl]">
          <div>
        ...
        <Reveal variant="left" delayMs={100} className="bg-[var(--bg)] p-7 md:p-10 lg:[direction:rtl]">
          <form className="grid gap-3" data-bizuply-block="lead-form" data-bizuply-crm-lead="true" data-bizuply-form-builder="true" data-bizuply-form-skin="template" data-bizuply-form-id="talentix-contact" data-bizuply-success-message={tx("תודה! קיבלנו את הפנייה ונחזור אלייך בהקדם.")}>
            <input className="border border-black/10 bg-[var(--surface)] px-4 py-4 text-start outline-none" placeholder={tx("שם מלא")}  name="name" data-bizuply-form-field-id="name" type="text" autoComplete="name" />
            <input className="border border-black/10 bg-[var(--surface)] px-4 py-4 text-start outline-none" placeholder={tx("טלפון")}  name="phone" data-bizuply-form-field-id="phone" type="tel" autoComplete="tel" />
            <input className="border border-black/10 bg-[var(--surface)] px-4 py-4 text-start outline-none" placeholder={tx("תפקיד / חברה")}  name="company" data-bizuply-form-field-id="company" />
            <textarea className="min-h-36 border border-black/10 bg-[var(--surface)] px-4 py-4 text-start outline-none" placeholder={tx("לשלוח קורות חיים או לדבר עם מגייס/ת?")}  name="other" data-bizuply-form-field-id="other"></textarea>
...
function PageHero({ data, title }: { data: Record<string, any>; title: string }) {
  ...
  return (
    <section className="border-b border-black/10 bg-[var(--surface)] px-5 py-14 lg:px-8 lg:py-20">
      <Reveal className="mx-auto grid max-w-7xl gap-8 text-start lg:grid-cols-[1fr_0.72fr] lg:items-end">
        <div>
