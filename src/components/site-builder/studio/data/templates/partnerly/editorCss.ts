...
[data-template-id="partnerly"], [data-template-id="partnerly-preview"] {
  --p: #16A34A;
  --a: #38BDF8;
  --bg: #F0FDF4;
  --surface: #FFFFFF;
...
[data-template-id="partnerly-preview"] .text-center { text-align: center; }
[data-template-id="partnerly"] .ag-display,
[data-template-id="partnerly-preview"] .ag-display { font-family: "Montserrat", "Secular One", sans-serif; }
[data-template-id="partnerly"] .ag-card,
[data-template-id="partnerly-preview"] .ag-card {
...
[data-template-id="partnerly-preview"] .ag-card:hover {
  transform: translateY(-13px) rotate(1.0499999999999998deg);
  border-color: var(--a);
  box-shadow: 0 24px 70px rgba(15,23,42,0.16);
}
[data-template-id="partnerly"] .ag-ken,
[data-template-id="partnerly-preview"] .ag-ken { animation: partnerlyKen 23s ease-in-out infinite alternate; }
[data-template-id="partnerly"] .ag-float,
[data-template-id="partnerly-preview"] .ag-float { animation: partnerlyFloat 7s ease-in-out infinite; }
[data-template-id="partnerly"] .ag-pulse,
[data-template-id="partnerly-preview"] .ag-pulse { animation: partnerlyPulse 3.4s ease-in-out infinite; }
[data-template-id="partnerly"] .ag-scan,
[data-template-id="partnerly-preview"] .ag-scan { animation: partnerlyScan 16s linear infinite; }
[data-template-id="partnerly"] .ag-drift,
[data-template-id="partnerly-preview"] .ag-drift { animation: partnerlyDrift 17s ease-in-out infinite alternate; }
...
@media (prefers-reduced-motion: reduce) {
  [data-template-id="partnerly"] .ag-ken,
  [data-template-id="partnerly-preview"] .ag-ken,
  [data-template-id="partnerly"] .ag-float,
  [data-template-id="partnerly-preview"] .ag-float,
  [data-template-id="partnerly"] .ag-pulse,
  [data-template-id="partnerly-preview"] .ag-pulse,
  [data-template-id="partnerly"] .ag-scan,
  [data-template-id="partnerly-preview"] .ag-scan,
  [data-template-id="partnerly"] .ag-drift,
  [data-template-id="partnerly-preview"] .ag-drift { animation: none; }
}
`;
