...
export default function PartnerlyThumbnail() {
  ...
  return (
    <div dir={getTextDirection(i18n.language)} className="flex h-full w-full flex-col justify-between overflow-hidden p-5 text-right" style={{ background: "#F0FDF4", color: "#052E16", fontFamily: "Secular One, sans-serif" }}>
      <div>
        <div className="inline-flex rounded-full px-3 py-1 text-[10px] font-black" style={{ background: "#16A34A", color: "#fff" }}>{tx("סוכנות שותפויות ואפיליאציה")}</div>
