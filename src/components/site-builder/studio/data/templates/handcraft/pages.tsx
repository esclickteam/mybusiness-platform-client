    ...
    <div className="fixed inset-0 z-[80] grid place-items-center bg-black/70 px-4 backdrop-blur-sm">
      <div className="relative w-full max-w-lg border border-[var(--h-primary)] bg-[var(--h-secondary)] p-8 text-[var(--h-background)] shadow-2xl shadow-black/40">
        ...
        <form className="mt-7 grid gap-3" data-bizuply-block="lead-form" data-bizuply-crm-lead="true" data-bizuply-form-builder="true" data-bizuply-form-skin="template" data-bizuply-form-id="handcraft-contact" data-bizuply-success-message={tx("תודה! קיבלנו את הפנייה ונחזור אלייך בהקדם.")}>
          <input className="h-input px-5 py-4 text-start" placeholder={tx("שם מלא")}  name="name" data-bizuply-form-field-id="name" type="text" autoComplete="name" />
          <input className="h-input px-5 py-4 text-start" placeholder={tx("טלפון")}  name="phone" data-bizuply-form-field-id="phone" type="tel" autoComplete="tel" />
          <input className="h-input px-5 py-4 text-start" placeholder={tx("מה התקלה?")}  name="other" data-bizuply-form-field-id="other" />
          <button
            type="submit"
