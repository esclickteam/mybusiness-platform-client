...
[data-template-id="pitchora"], [data-template-id="pitchora"] {
  --p: #FFB703;
  --a: #FB8500;
  --bg: #05070F;
  --surface: #101522;
...
[data-template-id="pitchora"] .text-center { text-align: center; }
[data-template-id="pitchora"] .ag-display,
[data-template-id="pitchora"] .ag-display { font-family: "Space Grotesk", "Assistant", sans-serif; }
...
[data-template-id="pitchora"] .ag-ken { animation: pitchoraKen 16s ease-in-out infinite alternate; }
[data-template-id="pitchora"] .ag-float,
[data-template-id="pitchora"] .ag-float { animation: pitchoraFloat 5s ease-in-out infinite; }
[data-template-id="pitchora"] .ag-pulse,
[data-template-id="pitchora"] .ag-pulse { animation: pitchoraPulse 2.5s ease-in-out infinite; }
[data-template-id="pitchora"] .ag-scan,
[data-template-id="pitchora"] .ag-scan { animation: pitchoraScan 9s linear infinite; }
[data-template-id="pitchora"] .ag-drift,
[data-template-id="pitchora"] .ag-drift { animation: pitchoraDrift 10s ease-in-out infinite alternate; }
...
@media (prefers-reduced-motion: reduce) {
  ...
  [data-template-id="pitchora"] .ag-scan,
  [data-template-id="pitchora"] .ag-drift,
  [data-template-id="pitchora"] .ag-drift { animation: none; }
}
`;
