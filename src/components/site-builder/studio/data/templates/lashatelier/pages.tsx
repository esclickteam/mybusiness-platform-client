  ...
  return (
    <header data-visual-flow-lock="true" data-template-section-type="header" data-section-kind="header" className="sticky top-0 z-50 beauty-lashCraft-header-v3 bg-[var(--dark)]/88 text-[var(--text)] backdrop-blur-xl">
      ...
      />
        ...
        <button type="button" onClick={() => goTo("booking")} className="justify-self-end px-4 py-2 text-sm font-bold border border-[var(--p)] text-[var(--p)]" data-editable="button" data-visual-edit-id="global.header.primaryCta" data-visual-edit-type="button" data-visual-label="כפתור ראשי בכותרת">{getValue(data,"heroPrimaryButton")}</button>
      </div>
    </header>
  );
}
