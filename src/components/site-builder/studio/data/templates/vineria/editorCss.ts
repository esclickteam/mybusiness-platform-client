...
[data-template-id="vineria"], [data-template-id="vineria-preview"] {
...
[data-template-id="vineria-preview"] .tpl-display {
...
[data-template-id="vineria"] .tpl-ken, [data-template-id="vineria-preview"] .tpl-ken {
  animation: vineria-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="vineria"] .tpl-rise, [data-template-id="vineria-preview"] .tpl-rise {
  animation: vineria-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="vineria"] .tpl-rise-2, [data-template-id="vineria-preview"] .tpl-rise-2 {
  animation: vineria-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="vineria"] .tpl-rise-3, [data-template-id="vineria-preview"] .tpl-rise-3 {
  animation: vineria-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="vineria"] .tpl-marquee-track, [data-template-id="vineria-preview"] .tpl-marquee-track {
  display: flex; width: max-content; animation: vineria-marquee 28s linear infinite;
}
[data-template-id="vineria"] .tpl-float, [data-template-id="vineria-preview"] .tpl-float {
  animation: vineria-float 5s ease-in-out infinite;
}
[data-template-id="vineria"] .tpl-sweep, [data-template-id="vineria-preview"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="vineria"] .tpl-sweep::after, [data-template-id="vineria-preview"] .tpl-sweep::after {
...
[data-template-id="vineria"] .tpl-climb, [data-template-id="vineria-preview"] .tpl-climb {
...
[data-template-id="vineria"] .tpl-depth-1, [data-template-id="vineria-preview"] .tpl-depth-1 {
  animation: vineria-depth-drift 16s ease-in-out infinite alternate;
}
[data-template-id="vineria"] .tpl-depth-2, [data-template-id="vineria-preview"] .tpl-depth-2 {
  animation: vineria-depth-drift 12s ease-in-out infinite alternate-reverse;
}
[data-template-id="vineria"] .tpl-cork, [data-template-id="vineria-preview"] .tpl-cork {
  animation: vineria-cork-float 5.5s ease-in-out infinite;
}
[data-template-id="vineria"] .tpl-stamp, [data-template-id="vineria-preview"] .tpl-stamp {
