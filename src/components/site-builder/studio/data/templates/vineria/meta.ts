...
export const vineriaSeed = {
  ...
  blocks: [
    ...
    { type: "corks", variant: "floating-cork-badges", title: "Floating cork badges" },
    { type: "about", variant: "letterpress-story", title: "Letterpress about" },
    { type: "contact", variant: "elegant-reservation", title: "Elegant reservation contact" },
