...
[data-template-id="productix"], [data-template-id="productix"] {
  --p: #2563EB;
  --a: #F97316;
  --bg: #F8FAFC;
  --surface: #FFFFFF;
...
[data-template-id="productix"] .ag-display { font-family: "Sora", "Noto Sans Hebrew", sans-serif; }
...
[data-template-id="productix"] .ag-ken { animation: productixKen 21s ease-in-out infinite alternate; }
[data-template-id="productix"] .ag-float,
[data-template-id="productix"] .ag-float { animation: productixFloat 5s ease-in-out infinite; }
[data-template-id="productix"] .ag-pulse,
[data-template-id="productix"] .ag-pulse { animation: productixPulse 2.8s ease-in-out infinite; }
[data-template-id="productix"] .ag-scan,
[data-template-id="productix"] .ag-scan { animation: productixScan 14s linear infinite; }
[data-template-id="productix"] .ag-drift,
[data-template-id="productix"] .ag-drift { animation: productixDrift 15s ease-in-out infinite alternate; }
...
@media (prefers-reduced-motion: reduce) {
  ...
  [data-template-id="productix"] .ag-scan,
  [data-template-id="productix"] .ag-drift,
  [data-template-id="productix"] .ag-drift { animation: none; }
}
`;
