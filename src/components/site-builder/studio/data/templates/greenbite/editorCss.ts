...
[data-template-id="greenbite"], [data-template-id="greenbite"] {
  --p: #15803D;
  --accent: #4ADE80;
  --on-p: #F0FDF4;
  --bg: #F7FBF4;
...
[data-template-id="greenbite"] .store-float-a { animation: greenbite-float 7s ease-in-out infinite; }
[data-template-id="greenbite"] .store-float-b,
[data-template-id="greenbite"] .store-float-b { animation: greenbite-float 8.5s ease-in-out infinite reverse; }
[data-template-id="greenbite"] .store-float-c,
[data-template-id="greenbite"] .store-float-c { animation: greenbite-float 6.5s ease-in-out infinite 0.4s; }
