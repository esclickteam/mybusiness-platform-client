...
@keyframes estateo-ken { 0% { transform: scale(1); } 100% { transform: scale(1.09); } }
@keyframes estateo-rise { from { opacity: 0; transform: translateY(30px); } to { opacity: 1; transform: translateY(0); } }
