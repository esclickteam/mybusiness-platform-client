...
export default function EstateoThumbnail() {
  ...
  return (
    <div dir={getTextDirection(i18n.language)} className="relative h-full min-h-[260px] w-full overflow-hidden" style={{ background: "#100e0c", color: "#f4ecdf" }}>
      ...
      <div className="grid h-full min-h-[260px] grid-cols-[0.44fr_0.56fr] pt-12">
        <div className="flex flex-col justify-between p-4">
          ...
          <h3 className="text-3xl font-bold leading-none" style={{ fontFamily: '"Playfair Display"' }}>{tx("נכסים שלא מפרסמים.")}</h3>
