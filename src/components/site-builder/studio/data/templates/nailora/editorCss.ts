...
[data-template-id="nailora"] .t-ken { animation: nailora-ken 18s ease-in-out infinite alternate; }
[data-template-id="nailora"] .t-anim,
[data-template-id="nailora"] .t-anim { animation: nailora-up 0.9s cubic-bezier(0.22,1,0.36,1) both; }
[data-template-id="nailora"] .t-d1,
[data-template-id="nailora"] .t-d1 { animation-delay: .12s; }
[data-template-id="nailora"] .t-d2,
[data-template-id="nailora"] .t-d2 { animation-delay: .24s; }
[data-template-id="nailora"] .t-d3,
[data-template-id="nailora"] .t-d3 { animation-delay: .36s; }
[data-template-id="nailora"] .t-fade,
[data-template-id="nailora"] .t-fade { animation: nailora-fade 1s ease both; }
[data-template-id="nailora"] .t-marquee,
[data-template-id="nailora"] .t-marquee { animation: nailora-marquee 30s linear infinite; width: max-content; }
[data-template-id="nailora"] .t-float,
[data-template-id="nailora"] .t-float { animation: nailora-float 6s ease-in-out infinite; }
[data-template-id="nailora"] .t-pulse,
[data-template-id="nailora"] .t-pulse { animation: nailora-pulse 2.8s ease-in-out infinite; }
...
[data-template-id="nailora"] .t-glow { animation: nailora-glow 3.2s ease-in-out infinite; }
[data-template-id="nailora"] .t-scalein,
[data-template-id="nailora"] .t-scalein { animation: nailora-scalein 0.8s cubic-bezier(0.22,1,0.36,1) both; }
...
[data-template-id="nailora"] .t-hover:hover { transform: translateY(-5px); }
...
@media (prefers-reduced-motion: reduce) {
  ...
  [data-template-id="nailora"] .t-scalein,
  [data-template-id="nailora"] .t-fade,
  [data-template-id="nailora"] .t-fade { animation: none !important; }
}
`;
