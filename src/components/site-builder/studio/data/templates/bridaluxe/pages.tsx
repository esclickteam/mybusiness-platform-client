...
function Header({ data, currentPage, goTo }: { data: Record<string, any>; currentPage: string; goTo: (id: string) => void }) {
  return (
    ...
    <div className="mx-auto flex max-w-7xl items-center gap-5 px-5 py-4 lg:px-8">
      ...
      <button type="button" onClick={() => goTo("booking")} className="mr-auto px-4 py-2 text-xs font-bold rounded-full bg-[var(--p)] text-white">{getValue(data,"heroPrimaryButton")}</button>
    </div>
  </header>
  );
}
    ...
    <>
      ...
      <section data-template-section-type="testimonials" data-section-kind="testimonials" className="beauty-brideGlow-testimonials-frame-3 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">BRIDE / testimonials</p></div><span className="text-xs text-[var(--muted)]">סוויטת כלה</span></div>
        </div>
      </section>
      ...
      <section data-template-section-type="bookingTeaser" data-section-kind="bookingTeaser" className="beauty-brideGlow-bookingTeaser-frame-6 overflow-hidden px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-[0.85fr_1.15fr_0.55fr]">
          ...
          <div className="t-float hidden border border-[var(--p)]/35 p-5 md:block"><span className="text-xs text-[var(--muted)]">סוויטת כלה</span></div>
        </div>
      </section>
    ...
    <>
      <section data-template-section-type="aboutHero" data-section-kind="aboutHero" className="beauty-brideGlow-aboutHero-frame-7 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">BRIDE / aboutHero</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">סוויטת כלה</span></div>
      ...
      <section data-template-section-type="timeline" data-section-kind="timeline" className="beauty-brideGlow-timeline-frame-3 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">BRIDE / timeline</p></div><span className="text-xs text-[var(--muted)]">סוויטת כלה</span></div>
        </div>
      </section>
  ...
  return (
    <>
      ...
      <section data-template-section-type="catalog" data-section-kind="catalog" className="beauty-brideGlow-catalog-frame-7 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">BRIDE / catalog</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">סוויטת כלה</span></div>
      ...
      <section data-template-section-type="serviceFaq" data-section-kind="serviceFaq" className="beauty-brideGlow-serviceFaq-frame-3 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">BRIDE / serviceFaq</p></div><span className="text-xs text-[var(--muted)]">סוויטת כלה</span></div>
        </div>
      </section>
    ...
    <>
      ...
      <section data-section-kind="booking" data-bizuply-block="booking" data-template-section-type="booking" className="beauty-brideGlow-calendar-frame-6 overflow-hidden px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-[0.85fr_1.15fr_0.55fr]">
          ...
          <div className="bg-[var(--surface)] p-6 md:p-10"><div className="grid gap-8 lg:grid-cols-[0.75fr_1.25fr] lg:items-start"><Reveal><h2 className="t-display text-2xl sm:text-4xl text-[var(--p)]">{getValue(data,"calendarTitle")}</h2><p className="mt-4 text-[var(--muted)]">בחרו יום ושעה פנויה. הלוח כאן לשמירת תור מהירה מתוך התבנית.</p></Reveal><Reveal delayMs={100} className="t-glow bg-[var(--surface)]/80 p-5"><BookingCalendarPanel bold compact /></Reveal></div></div>
          <div className="t-float hidden border border-[var(--p)]/35 p-5 md:block"><span className="text-xs text-[var(--muted)]">סוויטת כלה</span></div>
        </div>
      </section>
      <section data-template-section-type="servicePicker" data-section-kind="servicePicker" className="beauty-brideGlow-servicePicker-frame-7 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">BRIDE / servicePicker</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">סוויטת כלה</span></div>
      ...
      <section data-template-section-type="bookingFaq" data-section-kind="bookingFaq" className="beauty-brideGlow-bookingFaq-frame-3 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">BRIDE / bookingFaq</p></div><span className="text-xs text-[var(--muted)]">סוויטת כלה</span></div>
        </div>
      </section>
      <footer data-template-section-type="footer" data-section-kind="footer" className="beauty-brideGlow-footer-sculpt border-t border-[var(--p)]/30 px-5 py-10 lg:px-8"><div className="mx-auto flex max-w-7xl items-center gap-4">{getValue(data,"logoImage") ? (<img src={getValue(data,"logoImage")} alt="" className="h-10 w-10 object-cover" />) : null}<span className="font-bold">{getValue(data,"brandName")}</span><span className="mr-auto text-sm text-[var(--muted)]">{getValue(data,"email")}</span></div></footer>
    </>
...
export default function BridaluxePages(props: BridaluxePagesProps) {
  ...
  const mergedData = useMemo(() => ({ ...bridaluxeDefaultData, ...(data ?? {}) }), [data]);
  ...
  return (
    <div dir="rtl" data-template-id={mode === "preview" ? "bridaluxe-preview" : "bridaluxe"} className="min-h-screen w-full overflow-x-hidden" style={{ background: "#FFF7F8", color: "#4C0519" }}>
