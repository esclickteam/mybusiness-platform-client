...
export default function AudioluxThumbnail() {
  ...
  return (
    <div dir={getTextDirection(i18n.language)} className="relative flex h-full min-h-[260px] w-full flex-col justify-between overflow-hidden p-5 text-right" style={{ background: "#050915", color: "#E0F2FE", fontFamily: "Heebo, sans-serif" }}>
      ...
      <div className="relative">
        <div className="inline-flex px-2 py-1 text-[10px] font-black uppercase tracking-[0.2em]" style={{ background: "#06B6D4", color: "#041016" }}>{tx("אודיו וסאונד")}</div>
        <h3 className="mt-4 text-3xl font-black leading-none" style={{ fontFamily: "Space Grotesk, serif" }}>Audiolux</h3>
        <p className="mt-2 text-xs font-semibold opacity-70">{tx("במה פרטית בבית.")}</p>
      </div>
