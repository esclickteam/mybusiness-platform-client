...
[data-template-id="lobbyhaus"], [data-template-id="lobbyhaus"] {
  --p: #1E3A8A;
  --a: #B45309;
  --bg: #F8FAFC;
  --surface: #FFFFFF;
...
[data-template-id="lobbyhaus"] .ag-display { font-family: "Cinzel", "IBM Plex Sans Hebrew", sans-serif; }
...
[data-template-id="lobbyhaus"] .ag-ken { animation: lobbyhausKen 29s ease-in-out infinite alternate; }
[data-template-id="lobbyhaus"] .ag-float,
[data-template-id="lobbyhaus"] .ag-float { animation: lobbyhausFloat 8s ease-in-out infinite; }
[data-template-id="lobbyhaus"] .ag-pulse,
[data-template-id="lobbyhaus"] .ag-pulse { animation: lobbyhausPulse 2.8s ease-in-out infinite; }
[data-template-id="lobbyhaus"] .ag-scan,
[data-template-id="lobbyhaus"] .ag-scan { animation: lobbyhausScan 22s linear infinite; }
[data-template-id="lobbyhaus"] .ag-drift,
[data-template-id="lobbyhaus"] .ag-drift { animation: lobbyhausDrift 23s ease-in-out infinite alternate; }
...
@media (prefers-reduced-motion: reduce) {
  ...
  [data-template-id="lobbyhaus"] .ag-scan,
  [data-template-id="lobbyhaus"] .ag-drift,
  [data-template-id="lobbyhaus"] .ag-drift { animation: none; }
}
`;
