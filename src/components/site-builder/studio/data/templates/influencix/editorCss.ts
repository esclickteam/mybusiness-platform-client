...
[data-template-id="influencix"], [data-template-id="influencix"] {
  --p: #FF4D6D;
  --a: #FFD166;
  --bg: #14070C;
  --surface: #241018;
...
[data-template-id="influencix"] .ag-display { font-family: "Cormorant Garamond", "Alef", sans-serif; }
...
[data-template-id="influencix"] .ag-ken { animation: influencixKen 18s ease-in-out infinite alternate; }
[data-template-id="influencix"] .ag-float,
[data-template-id="influencix"] .ag-float { animation: influencixFloat 7s ease-in-out infinite; }
[data-template-id="influencix"] .ag-pulse,
[data-template-id="influencix"] .ag-pulse { animation: influencixPulse 3.1s ease-in-out infinite; }
[data-template-id="influencix"] .ag-scan,
[data-template-id="influencix"] .ag-scan { animation: influencixScan 11s linear infinite; }
[data-template-id="influencix"] .ag-drift,
[data-template-id="influencix"] .ag-drift { animation: influencixDrift 12s ease-in-out infinite alternate; }
...
@media (prefers-reduced-motion: reduce) {
  ...
  [data-template-id="influencix"] .ag-scan,
  [data-template-id="influencix"] .ag-drift,
  [data-template-id="influencix"] .ag-drift { animation: none; }
}
`;
