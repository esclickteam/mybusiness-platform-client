...
[data-template-id="seafoodix"], [data-template-id="seafoodix-preview"] {
...
[data-template-id="seafoodix-preview"] .tpl-display {
...
[data-template-id="seafoodix"] .tpl-ken, [data-template-id="seafoodix-preview"] .tpl-ken {
  animation: seafoodix-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="seafoodix"] .tpl-rise, [data-template-id="seafoodix-preview"] .tpl-rise {
  animation: seafoodix-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="seafoodix"] .tpl-rise-2, [data-template-id="seafoodix-preview"] .tpl-rise-2 {
  animation: seafoodix-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="seafoodix"] .tpl-rise-3, [data-template-id="seafoodix-preview"] .tpl-rise-3 {
...
[data-template-id="seafoodix"] .tpl-wave, [data-template-id="seafoodix-preview"] .tpl-wave { animation: seafoodix-wave 14s linear infinite; }
