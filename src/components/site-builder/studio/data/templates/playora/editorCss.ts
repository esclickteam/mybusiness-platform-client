...
[data-template-id="playora"], [data-template-id="playora-preview"] {
  --p: #DB2777;
  --accent: #FDE047;
  --on-p: #FFFFFF;
  --bg: #FFF7FB;
...
[data-template-id="playora-preview"] .store-display {
  font-family: "Fredoka", "Heebo", serif;
}
[data-template-id="playora"] .store-card,
[data-template-id="playora-preview"] .store-card {
...
[data-template-id="playora-preview"] .store-card:hover {
  transform: translateY(-8px);
  box-shadow: 0 24px 60px rgba(0,0,0,0.18);
  border-color: var(--p);
}
[data-template-id="playora"] .store-marquee,
[data-template-id="playora-preview"] .store-marquee {
