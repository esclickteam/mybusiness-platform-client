...
import { playoraDefaultData, playoraDemoProducts } from "./defaultData";
import { playoraEditorCss } from "./editorCss";

export const playoraPages = [
...
export default function PlayoraPages(props: any) {
  return (
    <RichStoreSiteRuntime
      ...
      demoProducts={playoraDemoProducts}
      pages={playoraPages}
    />
  );
}
