...
[data-template-id="podcastix"], [data-template-id="podcastix-preview"] {
  --p: #8B5CF6;
  --a: #22D3EE;
  --bg: #0F0A1F;
  --surface: #1D1235;
...
[data-template-id="podcastix-preview"] .text-center { text-align: center; }
[data-template-id="podcastix"] .ag-display,
[data-template-id="podcastix-preview"] .ag-display { font-family: "DM Sans", "Arimo", sans-serif; }
[data-template-id="podcastix"] .ag-card,
[data-template-id="podcastix-preview"] .ag-card {
...
[data-template-id="podcastix-preview"] .ag-card:hover {
  transform: translateY(-17px) rotate(1.0499999999999998deg);
  border-color: var(--a);
  box-shadow: 0 24px 70px rgba(15,23,42,0.16);
}
[data-template-id="podcastix"] .ag-ken,
[data-template-id="podcastix-preview"] .ag-ken { animation: podcastixKen 27s ease-in-out infinite alternate; }
[data-template-id="podcastix"] .ag-float,
[data-template-id="podcastix-preview"] .ag-float { animation: podcastixFloat 6s ease-in-out infinite; }
[data-template-id="podcastix"] .ag-pulse,
[data-template-id="podcastix-preview"] .ag-pulse { animation: podcastixPulse 3.4s ease-in-out infinite; }
[data-template-id="podcastix"] .ag-scan,
[data-template-id="podcastix-preview"] .ag-scan { animation: podcastixScan 20s linear infinite; }
[data-template-id="podcastix"] .ag-drift,
[data-template-id="podcastix-preview"] .ag-drift { animation: podcastixDrift 21s ease-in-out infinite alternate; }
...
@media (prefers-reduced-motion: reduce) {
  [data-template-id="podcastix"] .ag-ken,
  [data-template-id="podcastix-preview"] .ag-ken,
  [data-template-id="podcastix"] .ag-float,
  [data-template-id="podcastix-preview"] .ag-float,
  [data-template-id="podcastix"] .ag-pulse,
  [data-template-id="podcastix-preview"] .ag-pulse,
  [data-template-id="podcastix"] .ag-scan,
  [data-template-id="podcastix-preview"] .ag-scan,
  [data-template-id="podcastix"] .ag-drift,
  [data-template-id="podcastix-preview"] .ag-drift { animation: none; }
}
`;
