export const framehausDefaultData = {
  ...
  phone: "03-000-0000",
  email: "hello@framehaus.co.il",
  address: "תל אביב, ישראל",
  footerText: "תבנית Framehaus — אתר רב-עמודי מקצועי עם עיצוב מלבני ותנועה.",
