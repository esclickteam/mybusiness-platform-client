...
[data-template-id="insightix"], [data-template-id="insightix-preview"] {
  --p: #0F766E;
  --a: #F59E0B;
  --bg: #F8FAFC;
  --surface: #FFFFFF;
...
[data-template-id="insightix-preview"] .text-center { text-align: center; }
[data-template-id="insightix"] .ag-display,
[data-template-id="insightix-preview"] .ag-display { font-family: "IBM Plex Sans Hebrew", "Suez One", sans-serif; }
[data-template-id="insightix"] .ag-card,
[data-template-id="insightix-preview"] .ag-card {
...
[data-template-id="insightix-preview"] .ag-card:hover {
  transform: translateY(-14px) rotate(-0deg);
  border-color: var(--a);
  box-shadow: 0 24px 70px rgba(0,0,0,0.28);
}
[data-template-id="insightix"] .ag-ken,
[data-template-id="insightix-preview"] .ag-ken { animation: insightixKen 24s ease-in-out infinite alternate; }
[data-template-id="insightix"] .ag-float,
[data-template-id="insightix-preview"] .ag-float { animation: insightixFloat 8s ease-in-out infinite; }
[data-template-id="insightix"] .ag-pulse,
[data-template-id="insightix-preview"] .ag-pulse { animation: insightixPulse 2.5s ease-in-out infinite; }
[data-template-id="insightix"] .ag-scan,
[data-template-id="insightix-preview"] .ag-scan { animation: insightixScan 17s linear infinite; }
[data-template-id="insightix"] .ag-drift,
[data-template-id="insightix-preview"] .ag-drift { animation: insightixDrift 18s ease-in-out infinite alternate; }
...
@media (prefers-reduced-motion: reduce) {
  [data-template-id="insightix"] .ag-ken,
  [data-template-id="insightix-preview"] .ag-ken,
  [data-template-id="insightix"] .ag-float,
  [data-template-id="insightix-preview"] .ag-float,
  [data-template-id="insightix"] .ag-pulse,
  [data-template-id="insightix-preview"] .ag-pulse,
  [data-template-id="insightix"] .ag-scan,
  [data-template-id="insightix-preview"] .ag-scan,
  [data-template-id="insightix"] .ag-drift,
  [data-template-id="insightix-preview"] .ag-drift { animation: none; }
}
`;
