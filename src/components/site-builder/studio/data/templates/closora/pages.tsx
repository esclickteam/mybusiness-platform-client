    ...
    <section className="px-5 py-20 lg:px-8 lg:py-28">
      <div className="mx-auto grid max-w-7xl gap-6 border border-white/15 bg-[var(--surface)] p-4 md:p-6 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        <Reveal variant="left" delayMs={100}>
          <form className="grid gap-3 border border-white/15 bg-[var(--bg)] p-4" data-bizuply-block="lead-form" data-bizuply-form-id="closora-contact-1" data-bizuply-crm-lead="true" data-bizuply-success-message="תודה! קיבלנו את הפנייה ונחזור אליכם בהקדם.">
            ...
            <textarea name="message" data-bizuply-form-field-id="message"  className={`min-h-32 border border-white/15 bg-[var(--bg)] px-4 py-4 text-right outline-none`} placeholder="במה נוכל לעזור?" />
