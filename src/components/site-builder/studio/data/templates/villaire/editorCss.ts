...
[data-template-id="villaire"] .tpl-ken, [data-template-id="villaire"] .tpl-ken {
  animation: villaire-ken 22s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="villaire"] .tpl-rise, [data-template-id="villaire"] .tpl-rise {
  animation: villaire-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="villaire"] .tpl-rise-2, [data-template-id="villaire"] .tpl-rise-2 {
  animation: villaire-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="villaire"] .tpl-rise-3, [data-template-id="villaire"] .tpl-rise-3 {
  animation: villaire-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="villaire"] .tpl-draw, [data-template-id="villaire"] .tpl-draw {
  transform-origin: center; animation: villaire-draw 1.2s cubic-bezier(.22,1,.36,1) .18s both;
}
[data-template-id="villaire"] .tpl-marquee-track, [data-template-id="villaire"] .tpl-marquee-track {
  display: flex; width: max-content; animation: villaire-marquee 34s linear infinite;
}
[data-template-id="villaire"] .tpl-float, [data-template-id="villaire"] .tpl-float {
  animation: villaire-float 5.8s ease-in-out infinite;
}
[data-template-id="villaire"] .tpl-pulse-line, [data-template-id="villaire"] .tpl-pulse-line {
  animation: villaire-pulse 2.4s ease-in-out infinite;
}
[data-template-id="villaire"] .tpl-sweep, [data-template-id="villaire"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="villaire"] .tpl-sweep::after, [data-template-id="villaire"] .tpl-sweep::after {
...
[data-template-id="villaire"] .tpl-climb, [data-template-id="villaire"] .tpl-climb {
