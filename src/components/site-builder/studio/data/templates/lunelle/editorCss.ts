...
[data-template-id="lunelle"] .t-display,
[data-template-id="lunelle-preview"] .lunelle-serif,
[data-template-id="lunelle-preview"] .t-display {
...
/* Preview alias — same boutique tokens */
[data-template-id="lunelle-preview"] {
  direction: rtl;
  background: #fff7f1;
  color: #2a171c;
...
[data-template-id="lunelle-preview"] .lunelle-contact-form,
[data-template-id="lunelle-preview"] .lunelle-contact-form:hover,
[data-template-id="lunelle-preview"] form[data-bizuply-block="lead-form"] {
  transform: none !important;
  box-shadow: 0 25px 80px rgba(42, 23, 28, 0.08) !important;
}

[data-template-id="lunelle-preview"] .lunelle-gallery-tile {
  position: relative;
  min-height: 240px;
  overflow: hidden;
}

[data-template-id="lunelle-preview"] .lunelle-gallery-tile img {
  position: absolute;
  inset: 0;
  width: 100%;
  height: 100%;
