...
export default function WheeloraThumbnail() {
  return (
    <div className="relative flex h-full min-h-[260px] w-full flex-col justify-between overflow-hidden p-5 text-right" style={{ background: "#FAFAFA", color: "#111827", fontFamily: "Heebo, sans-serif" }}>
      ...
      <div className="relative">
        <div className="inline-flex px-2 py-1 text-[10px] font-black uppercase tracking-[0.2em]" style={{ background: "#DC2626", color: "#FFFFFF" }}>אופניים וציוד רכיבה</div>
        <h3 className="mt-4 text-3xl font-black leading-none" style={{ fontFamily: "Barlow Condensed, serif" }}>Wheelora</h3>
        <p className="mt-2 text-xs font-semibold opacity-70">קילומטרים מתחילים כאן.</p>
      </div>
