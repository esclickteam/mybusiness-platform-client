...
[data-template-id="blockwise"] .tpl-ken, [data-template-id="blockwise"] .tpl-ken {
  animation: blockwise-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="blockwise"] .tpl-rise, [data-template-id="blockwise"] .tpl-rise {
  animation: blockwise-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="blockwise"] .tpl-rise-2, [data-template-id="blockwise"] .tpl-rise-2 {
  animation: blockwise-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="blockwise"] .tpl-rise-3, [data-template-id="blockwise"] .tpl-rise-3 {
  animation: blockwise-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="blockwise"] .tpl-marquee-track, [data-template-id="blockwise"] .tpl-marquee-track {
  display: flex; width: max-content; animation: blockwise-marquee 28s linear infinite;
}
[data-template-id="blockwise"] .tpl-float, [data-template-id="blockwise"] .tpl-float {
  animation: blockwise-float 5s ease-in-out infinite;
}
[data-template-id="blockwise"] .tpl-sweep, [data-template-id="blockwise"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="blockwise"] .tpl-sweep::after, [data-template-id="blockwise"] .tpl-sweep::after {
...
[data-template-id="blockwise"] .tpl-climb, [data-template-id="blockwise"] .tpl-climb {
...
[data-template-id="blockwise"] .tpl-block, [data-template-id="blockwise"] .tpl-block { animation:blockwise-stack .7s both; }
@keyframes blockwise-testi { to { transform:translateX(-50%); } }
[data-template-id="blockwise"] .tpl-testi-track, [data-template-id="blockwise"] .tpl-testi-track {
