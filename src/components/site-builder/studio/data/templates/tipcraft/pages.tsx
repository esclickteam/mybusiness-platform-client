...
export default function TipcraftPages(props: TipcraftPagesProps) {
  ...
  const mergedData = useMemo(() => ({ ...tipcraftDefaultData, ...(data ?? {}) }), [data]);
