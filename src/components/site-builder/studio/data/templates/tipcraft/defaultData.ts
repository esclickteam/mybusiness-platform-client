export const tipcraftDefaultData = {
  templateId: "tipcraft",
  name: "Tipcraft",
  brandName: "Tipcraft",
  ...
  navServices: "שירותים",
  navBooking: "תורים",
  heroEyebrow: "בונת ציפורניים",
  heroTitle: "Tipcraft\nמבנה שנראה טבעי ומרגיש חזק.",
  heroSubtitle: "בנייה בג׳ל, מילוי ותיקוני שברים עם דגש על אנטומיה, איזון וקו נקי.",
  heroPrimaryButton: "מילוי הבא",
  heroSecondaryButton: "לתיק עבודות",
  heroImage: "https://images.unsplash.com/photo-1516975080664-ed2fc6a32937?auto=format&fit=crop&w=2200&q=85",
  sectionImage: "https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?auto=format&fit=crop&w=1400&q=85",
  galleryImage1: "https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?auto=format&fit=crop&w=1400&q=85",
  galleryImage2: "https://images.unsplash.com/photo-1512496015851-a90fb38ba796?auto=format&fit=crop&w=1400&q=85",
  galleryImage3: "https://images.unsplash.com/photo-1522338140262-f46f5913618a?auto=format&fit=crop&w=1400&q=85",
  galleryImage4: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?auto=format&fit=crop&w=1400&q=85",
  aboutImage: "https://images.unsplash.com/photo-1556228720-195a672e8a03?auto=format&fit=crop&w=1400&q=85",
  mapImage: "https://images.unsplash.com/photo-1556228578-0d85b1a4d571?auto=format&fit=crop&w=1400&q=85",
  ...
  itemOneImage: "https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?auto=format&fit=crop&w=1400&q=85",
  itemTwoImage: "https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=1400&q=85",
  itemThreeImage: "https://images.unsplash.com/photo-1519823551278-64ac92734fb1?auto=format&fit=crop&w=1400&q=85",
  itemFourImage: "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?auto=format&fit=crop&w=1400&q=85",
  heroStatOne: "4.9",
  ...
  aboutHeroTitle: "הסיפור מאחורי Tipcraft",
  aboutStoryTitle: "מאיפה הכל התחיל",
  aboutStoryText: "Tipcraft נבנה כמקום שמחבר בין טיפול מקצועי לחוויה רגועה: כל ביקור מתחיל בשיחה קצרה, ממשיך בבחירת פרוטוקול מדויק ומסתיים בהנחיות ברורות להמשך בבית. הצוות מתעד העדפות, רגישויות ותוצאות כדי שכל מפגש הבא יהיה אישי יותר, נעים יותר ומדויק יותר.",
  ...
  servicesIntroText: "קטלוג הטיפולים של Tipcraft מפרט מה מקבלים בכל שירות, כמה זמן כדאי לפנות, למי הוא מתאים ואילו תוספות יכולות לשדרג את התוצאה. המטרה היא שתבחרו טיפול מתוך ידע מלא ולא מתוך ניחוש.",
  ...
  itemOneTitle: "בנייה חדשה",
  itemOneText: "הארכה מדויקת עם מבנה מותאם לאצבע. כולל אבחון קצר, התאמה אישית, עבודה מדויקת והמלצות המשך כתובות כדי שהתוצאה תישאר יפה גם אחרי היציאה מהסטודיו.",
  itemTwoTitle: "מילוי אנטומי",
  itemTwoText: "איזון מחדש ושמירה על חוזק טבעי. כולל אבחון קצר, התאמה אישית, עבודה מדויקת והמלצות המשך כתובות כדי שהתוצאה תישאר יפה גם אחרי היציאה מהסטודיו.",
  itemThreeTitle: "תיקון שבר",
  itemThreeText: "חיזוק מקומי בלי לפגוע במראה הכללי. כולל אבחון קצר, התאמה אישית, עבודה מדויקת והמלצות המשך כתובות כדי שהתוצאה תישאר יפה גם אחרי היציאה מהסטודיו.",
  itemFourTitle: "הסרה ושיקום",
  itemFourText: "הסרה בטוחה ותוכנית חיזוק לציפורן. כולל אבחון קצר, התאמה אישית, עבודה מדויקת והמלצות המשך כתובות כדי שהתוצאה תישאר יפה גם אחרי היציאה מהסטודיו.",
  team1Name: "מאיה לב",
