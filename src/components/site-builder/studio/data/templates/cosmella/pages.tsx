  ...
  return (
    <header data-visual-flow-lock="true" data-template-section-type="header" data-section-kind="header" className="sticky top-0 z-50 beauty-skinStudio-header-v3 bg-[var(--surface)]/90 text-[var(--text)] shadow-sm backdrop-blur">
      ...
      />
        ...
        <button type="button" onClick={() => goTo("booking")} className="justify-self-end px-4 py-2 text-sm font-bold rounded-2xl bg-[var(--p)] text-white" data-editable="button" data-visual-edit-id="global.header.primaryCta" data-visual-edit-type="button" data-visual-label="כפתור ראשי בכותרת">{getValue(data,"heroPrimaryButton")}</button>
      </div>
    </header>
  );
}
