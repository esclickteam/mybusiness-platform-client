export const cosmellaDefaultData = {
  templateId: "cosmella",
  name: "Cosmella",
  brandName: "Cosmella",
  ...
  navServices: "שירותים",
  navBooking: "תורים",
  heroEyebrow: "קוסמטיקאית",
  heroTitle: "Cosmella\nעור רגוע מתחיל באבחון.",
  heroSubtitle: "טיפולי פנים מותאמים אישית, חומרים פעילים במינון נכון ושיחה שמתרגמת לשגרה אפשרית בבית.",
  heroPrimaryButton: "אבחון ראשון",
  heroSecondaryButton: "לטיפולים",
  heroImage: "https://images.unsplash.com/photo-1519823551278-64ac92734fb1?auto=format&fit=crop&w=2200&q=85",
  sectionImage: "https://images.unsplash.com/photo-1560066984-138dadb4c035?auto=format&fit=crop&w=1400&q=85",
  galleryImage1: "https://images.unsplash.com/photo-1522337660859-02fbefca4702?auto=format&fit=crop&w=1400&q=85",
  galleryImage2: "https://images.unsplash.com/photo-1598440947619-2c35fc9aa908?auto=format&fit=crop&w=1400&q=85",
  galleryImage3: "https://images.unsplash.com/photo-1580618672591-eb180b1a973f?auto=format&fit=crop&w=1400&q=85",
  ...
  aboutHeroTitle: "הסיפור מאחורי Cosmella",
  aboutStoryTitle: "מאיפה הכל התחיל",
  aboutStoryText: "Cosmella נבנה כמקום שמחבר בין טיפול מקצועי לחוויה רגועה: כל ביקור מתחיל בשיחה קצרה, ממשיך בבחירת פרוטוקול מדויק ומסתיים בהנחיות ברורות להמשך בבית. הצוות מתעד העדפות, רגישויות ותוצאות כדי שכל מפגש הבא יהיה אישי יותר, נעים יותר ומדויק יותר.",
  ...
  servicesIntroText: "קטלוג הטיפולים של Cosmella מפרט מה מקבלים בכל שירות, כמה זמן כדאי לפנות, למי הוא מתאים ואילו תוספות יכולות לשדרג את התוצאה. המטרה היא שתבחרו טיפול מתוך ידע מלא ולא מתוך ניחוש.",
  ...
  itemOneTitle: "ניקוי עמוק",
  itemOneText: "ניקוי נקבוביות, מסכה והרגעה. כולל אבחון קצר, התאמה אישית, עבודה מדויקת והמלצות המשך כתובות כדי שהתוצאה תישאר יפה גם אחרי היציאה מהסטודיו.",
  itemTwoTitle: "לחות משקמת",
  itemTwoText: "שכבות לחות לעור מיובש ורגיש. כולל אבחון קצר, התאמה אישית, עבודה מדויקת והמלצות המשך כתובות כדי שהתוצאה תישאר יפה גם אחרי היציאה מהסטודיו.",
  itemThreeTitle: "זוהר עדין",
  itemThreeText: "חידוש מרקם בלי עומס על העור. כולל אבחון קצר, התאמה אישית, עבודה מדויקת והמלצות המשך כתובות כדי שהתוצאה תישאר יפה גם אחרי היציאה מהסטודיו.",
  itemFourTitle: "שגרת בית",
  itemFourText: "התאמת מוצרים לפי תקציב וסדר שימוש. כולל אבחון קצר, התאמה אישית, עבודה מדויקת והמלצות המשך כתובות כדי שהתוצאה תישאר יפה גם אחרי היציאה מהסטודיו.",
  team1Name: "מאיה לב",
