...
[data-template-id="tapasora"], [data-template-id="tapasora-preview"] {
...
[data-template-id="tapasora-preview"] .tpl-display {
...
[data-template-id="tapasora"] .tpl-ken, [data-template-id="tapasora-preview"] .tpl-ken {
  animation: tapasora-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="tapasora"] .tpl-rise, [data-template-id="tapasora-preview"] .tpl-rise {
  animation: tapasora-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="tapasora"] .tpl-rise-2, [data-template-id="tapasora-preview"] .tpl-rise-2 {
  animation: tapasora-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="tapasora"] .tpl-rise-3, [data-template-id="tapasora-preview"] .tpl-rise-3 {
  animation: tapasora-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="tapasora"] .tpl-marquee-track, [data-template-id="tapasora-preview"] .tpl-marquee-track {
  display: flex; width: max-content; animation: tapasora-marquee 28s linear infinite;
}
[data-template-id="tapasora"] .tpl-float, [data-template-id="tapasora-preview"] .tpl-float {
  animation: tapasora-float 5s ease-in-out infinite;
}
[data-template-id="tapasora"] .tpl-sweep, [data-template-id="tapasora-preview"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="tapasora"] .tpl-sweep::after, [data-template-id="tapasora-preview"] .tpl-sweep::after {
...
[data-template-id="tapasora"] .tpl-climb, [data-template-id="tapasora-preview"] .tpl-climb {
...
@keyframes tapasora-marquee { from { transform: translateX(0); } to { transform: translateX(50%); } }
[data-template-id="tapasora"] .tpl-plate-rise, [data-template-id="tapasora-preview"] .tpl-plate-rise {
  animation: tapasora-plate-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="tapasora"] .tpl-neon, [data-template-id="tapasora-preview"] .tpl-neon {
  animation: tapasora-neon-flicker 4s linear infinite; color: #ff2d95;
}
[data-template-id="tapasora"] .tpl-wine-fill, [data-template-id="tapasora-preview"] .tpl-wine-fill {
