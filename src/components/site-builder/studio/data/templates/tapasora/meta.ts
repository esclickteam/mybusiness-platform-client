...
export const tapasoraSeed = {
  ...
  blocks: [
    ...
    { type: "process", variant: "neon-process", title: "Neon process" },
    { type: "gallery", variant: "neon-gallery", title: "Neon gallery" },
    { type: "reviews", variant: "neon-reviews", title: "Neon reviews" },
    { type: "stats", variant: "neon-stats", title: "Neon stats + hours" },
    { type: "cta", variant: "neon-home-cta", title: "Home CTA teaser" },
    { type: "tapasPage", variant: "full-tapas-menu", title: "Full tapas menu page" },
    { type: "barPage", variant: "bar-story", title: "Bar story page" },
    { type: "about", variant: "chalk-timeline", title: "Chalk timeline + chef" },
    { type: "contact", variant: "bar-tab-reserve-faq", title: "Bar-tab reserve + FAQ" },
