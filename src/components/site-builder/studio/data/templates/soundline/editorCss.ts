...
[data-template-id="soundline-preview"] .t-display {
  font-family: "Bebas Neue", sans-serif;
  letter-spacing: .02em;
}

[data-template-id="soundline"] a,
[data-template-id="soundline-preview"] a,
[data-template-id="soundline"] button,
[data-template-id="soundline-preview"] button {
  transition: background .2s ease, border-color .2s ease, color .2s ease, transform .2s ease, box-shadow .2s ease;
}

[data-template-id="soundline"] a:hover,
[data-template-id="soundline-preview"] a:hover,
[data-template-id="soundline"] button:hover,
[data-template-id="soundline-preview"] button:hover {
  transform: translateY(-3px);
}

[data-template-id="soundline"] .sound-nav-link,
[data-template-id="soundline-preview"] .sound-nav-link {
  position: relative;
}

[data-template-id="soundline"] .sound-nav-link::before,
[data-template-id="soundline-preview"] .sound-nav-link::before {
  content: "";
  position: absolute;
  top: 50%;
...
[data-template-id="soundline-preview"] .sound-nav-link:hover::before {
  opacity: 1;
  transform: translateY(-50%) scale(1);
}

[data-template-id="soundline"] .sound-ken,
[data-template-id="soundline-preview"] .sound-ken {
...
[data-template-id="soundline-preview"] .sound-vinyl {
...
[data-template-id="soundline-preview"] .sound-vinyl::after {
  content: "";
  position: absolute;
  inset: 50%;
  width: 18px;
...
[data-template-id="soundline-preview"] .sound-program-row {
  position: relative;
  overflow: hidden;
...
[data-template-id="soundline-preview"] .sound-program-row::before {
  content: "";
  position: absolute;
  inset: 0;
  background: var(--p);
...
[data-template-id="soundline-preview"] .sound-program-row:hover {
  box-shadow: 0 0 48px rgba(255, 77, 109, .28);
  transform: translateX(-8px);
}

[data-template-id="soundline"] .sound-program-row:hover::before,
[data-template-id="soundline-preview"] .sound-program-row:hover::before {
  transform: scaleX(1);
}

[data-template-id="soundline"] .sound-program-row:hover h3,
[data-template-id="soundline-preview"] .sound-program-row:hover h3,
[data-template-id="soundline"] .sound-program-row:hover p,
[data-template-id="soundline-preview"] .sound-program-row:hover p {
  color: #000 !important;
}

[data-template-id="soundline"] .sound-marquee-track,
[data-template-id="soundline-preview"] .sound-marquee-track {
...
[data-template-id="soundline-preview"] .sound-teacher-strip,
[data-template-id="soundline"] .sound-gallery-strip,
[data-template-id="soundline-preview"] .sound-gallery-strip {
...
[data-template-id="soundline-preview"] .sound-teacher-strip::before {
  content: "";
  position: absolute;
  inset: 0;
...
[data-template-id="soundline-preview"] .sound-teacher-strip img,
[data-template-id="soundline"] .sound-gallery-strip img,
[data-template-id="soundline-preview"] .sound-gallery-strip img {
...
[data-template-id="soundline-preview"] .sound-teacher-strip:hover,
[data-template-id="soundline"] .sound-gallery-strip:hover,
[data-template-id="soundline-preview"] .sound-gallery-strip:hover {
  border-color: var(--p);
  transform: translateY(-10px);
}

[data-template-id="soundline"] .sound-teacher-strip:hover img,
[data-template-id="soundline-preview"] .sound-teacher-strip:hover img,
[data-template-id="soundline"] .sound-gallery-strip:hover img,
[data-template-id="soundline-preview"] .sound-gallery-strip:hover img {
  filter: grayscale(0) contrast(1.18);
  transform: scale(1.08);
}

[data-template-id="soundline"] .sound-event-row,
[data-template-id="soundline-preview"] .sound-event-row {
  transition: background .24s ease, padding-inline .24s ease;
}

[data-template-id="soundline"] .sound-event-row:hover,
[data-template-id="soundline-preview"] .sound-event-row:hover {
  background: rgba(255, 77, 109, .08);
  padding-inline: 1rem;
}

[data-template-id="soundline"] .sound-counter,
[data-template-id="soundline-preview"] .sound-counter {
  box-shadow: 12px 12px 0 #000;
  transition: transform .24s ease, box-shadow .24s ease;
}

[data-template-id="soundline"] .sound-counter:hover,
[data-template-id="soundline-preview"] .sound-counter:hover {
  box-shadow: 18px 18px 0 #000;
  transform: translate(-6px, -6px);
}

[data-template-id="soundline"] input,
[data-template-id="soundline-preview"] input,
[data-template-id="soundline"] textarea,
[data-template-id="soundline-preview"] textarea,
[data-template-id="soundline"] select,
[data-template-id="soundline-preview"] select {
  font-family: "DM Sans", sans-serif;
}

[data-template-id="soundline"] input::placeholder,
[data-template-id="soundline-preview"] input::placeholder,
[data-template-id="soundline"] textarea::placeholder,
[data-template-id="soundline-preview"] textarea::placeholder {
