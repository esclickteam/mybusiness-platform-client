...
@keyframes keyora-rise { from { opacity: 0; transform: translateY(26px); } to { opacity: 1; transform: translateY(0); } }
...
@keyframes keyora-float { 0%,100% { transform: translateY(0); } 50% { transform: translateY(-8px); } }
