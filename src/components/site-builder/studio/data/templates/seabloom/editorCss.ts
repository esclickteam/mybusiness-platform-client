...
[data-template-id="seabloom"] .tpl-ken, [data-template-id="seabloom"] .tpl-ken {
  animation: seabloom-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="seabloom"] .tpl-rise, [data-template-id="seabloom"] .tpl-rise {
  animation: seabloom-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="seabloom"] .tpl-rise-2, [data-template-id="seabloom"] .tpl-rise-2 {
  animation: seabloom-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="seabloom"] .tpl-rise-3, [data-template-id="seabloom"] .tpl-rise-3 {
  animation: seabloom-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="seabloom"] .tpl-marquee-track, [data-template-id="seabloom"] .tpl-marquee-track {
  display: flex; width: max-content; animation: seabloom-marquee 28s linear infinite;
}
[data-template-id="seabloom"] .tpl-float, [data-template-id="seabloom"] .tpl-float {
  animation: seabloom-float 5s ease-in-out infinite;
}
[data-template-id="seabloom"] .tpl-sweep, [data-template-id="seabloom"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="seabloom"] .tpl-sweep::after, [data-template-id="seabloom"] .tpl-sweep::after {
...
[data-template-id="seabloom"] .tpl-climb, [data-template-id="seabloom"] .tpl-climb {
...
[data-template-id="seabloom"] .tpl-petal, [data-template-id="seabloom"] .tpl-petal {
  animation: seabloom-petal-fall var(--petal-dur, 9s) linear infinite;
}
[data-template-id="seabloom"] .tpl-carousel-track, [data-template-id="seabloom"] .tpl-carousel-track {
