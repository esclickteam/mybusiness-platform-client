...
[data-template-id="dunewave"] .tpl-ken, [data-template-id="dunewave"] .tpl-ken {
  animation: dunewave-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="dunewave"] .tpl-rise, [data-template-id="dunewave"] .tpl-rise {
  animation: dunewave-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="dunewave"] .tpl-rise-2, [data-template-id="dunewave"] .tpl-rise-2 {
  animation: dunewave-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="dunewave"] .tpl-rise-3, [data-template-id="dunewave"] .tpl-rise-3 {
  animation: dunewave-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="dunewave"] .tpl-marquee-track, [data-template-id="dunewave"] .tpl-marquee-track {
  display: flex; width: max-content; animation: dunewave-marquee 28s linear infinite;
}
[data-template-id="dunewave"] .tpl-float, [data-template-id="dunewave"] .tpl-float {
  animation: dunewave-float 5s ease-in-out infinite;
}
[data-template-id="dunewave"] .tpl-sweep, [data-template-id="dunewave"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="dunewave"] .tpl-sweep::after, [data-template-id="dunewave"] .tpl-sweep::after {
...
[data-template-id="dunewave"] .tpl-climb, [data-template-id="dunewave"] .tpl-climb {
...
[data-template-id="dunewave"] .tpl-dune-back, [data-template-id="dunewave"] .tpl-dune-back {
  animation: dunewave-dune-shift 14s ease-in-out infinite alternate;
}
[data-template-id="dunewave"] .tpl-dune-mid, [data-template-id="dunewave"] .tpl-dune-mid {
  animation: dunewave-dune-shift 10s ease-in-out infinite alternate-reverse;
}
[data-template-id="dunewave"] .tpl-villa-rail, [data-template-id="dunewave"] .tpl-villa-rail {
