export const trailhausDefaultData = {
  "templateId": "trailhaus",
  "name": "Trailhaus",
  "brandName": "Trailhaus",
  "logoText": "TR",
  "tagline": "מהשביל עד הבסיס.",
  "nicheLabel": "טיולים וקמפינג",
  "navHome": "בית",
  "navShop": "חנות",
  ...
  "navFaq": "שאלות",
  "navShipping": "משלוחים",
  "promoText": "Trailhaus · מהשביל עד הבסיס. · מוצרים מתוסף החנות",
  "heroEyebrow": "טיולים וקמפינג",
  ...
  "catOne": "אוהלים",
  "catOneImage": "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?auto=format&fit=crop&w=900&q=80",
  "catTwo": "תרמילים",
  ...
  "valueThreeText": "לייאאוט ridgeTrail שלא נראה כמו חנויות אחרות.",
  ...
  "aboutEyebrow": "אודות",
  "aboutTitle": "Trailhaus — טיולים וקמפינג עם חוויית חנות מלאה.",
  "aboutText": "Trailhaus נבנתה כחנות גדולה עם עשרות סקשנים, עמודי תוכן וחיבור מלא לתוסף החנות של Bizuply.",
  "aboutTextTwo": "המוצרים בתצוגה הם דמו עד שתגדירו את הקטלוג האמיתי בניהול החנות.",
  "aboutImage": "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?auto=format&fit=crop&w=1400&q=88",
  ...
  "ctaButton": "לחנות",
  "footerText": "Trailhaus · טיולים וקמפינג · Powered by Bizuply",
  "footerNote": "המוצרים מתעדכנים אוטומטית מתוסף החנות."
} as const;

export const trailhausDemoProducts = [
  {
    "name": "אוהל Ridge 2P",
    "price": 1290,
    "category": "אוהלים",
    "image": "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?auto=format&fit=crop&w=900&q=80",
    "shortDescription": "אוהל Ridge 2P מתוך קטלוג Trailhaus — טיולים וקמפינג.",
    "featured": true,
    "badge": "חדש"
  },
  {
  ...
  {
    "name": "תרמיל Summit 45L",
    "price": 649,
    "category": "תרמילים",
    "image": "https://images.unsplash.com/photo-1622260614153-03223fb72052?auto=format&fit=crop&w=900&q=80",
    "shortDescription": "תרמיל Summit 45L מתוך קטלוג Trailhaus — טיולים וקמפינג.",
    "featured": true
  },
  {
    "name": "תרמיל Daypack 22L",
    "price": 289,
    "category": "תרמילים",
    "image": "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=900&q=80",
    "shortDescription": "תרמיל Daypack 22L מתוך קטלוג Trailhaus — טיולים וקמפינג.",
    "featured": false
  },
  {
    "name": "כירת גז Trail",
  ...
  },
  {
    ...
    "shortDescription": "מעיל Softshell מתוך קטלוג Trailhaus — טיולים וקמפינג.",
    "featured": true
  },
  {
    "name": "כובע Trail Cap",
