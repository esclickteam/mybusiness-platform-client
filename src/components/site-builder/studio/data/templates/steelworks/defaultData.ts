export const steelworksDefaultData = {
  templateId: "steelworks",
  name: "Steelworks",
  brandName: "Steelworks",
  logoText: "ST",
  tagline: "ייצור תעשייתי",
  navHome: "בית",
  navAbout: "אודות",
  navServices: "שירותים",
  navWork: "פרויקטים",
  navInsights: "תובנות",
  navContact: "צור קשר",
  heroEyebrow: "ייצור תעשייתי",
  heroTitle: "חוזק שאפשר למדוד.",
  ...
  phone: "03-000-0000",
  email: "hello@steelworks.co.il",
  address: "תל אביב, ישראל",
  footerText: "תבנית Steelworks — אתר רב-עמודי מקצועי עם עיצוב מלבני ותנועה.",
