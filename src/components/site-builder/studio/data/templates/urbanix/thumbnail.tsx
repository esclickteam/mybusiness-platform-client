...
export default function UrbanixThumbnail() {
  ...
  return (
    <div dir={getTextDirection(i18n.language)} className="relative h-full min-h-[260px] w-full overflow-hidden" style={{ background: "#141516", color: "#f2f2f0" }}>
      ...
      <div className="flex h-full min-h-[260px] flex-col justify-between p-5">
        ...
        <div>
          ...
          <h3 className="mt-2 text-5xl font-black leading-[0.85]" style={{ fontFamily: '"Rubik"', color: "#f2f2f0" }}>{tx("העיר. הדירה. הקצב.")}</h3>
        </div>
        <div className="border-y py-2 text-[10px] font-black tracking-[0.18em]" style={{ borderColor: "rgba(242,242,240,0.12)", color: "#c8f542" }}>{tx("פלורנטין / רוטשילד / הצפון הישן")}</div>
        <div className="grid grid-cols-[1fr_auto] border text-[10px]" style={{ borderColor: "rgba(242,242,240,0.12)" }}>
          <span className="p-2">{tx("דירת 3 רוטשילד")}</span>
