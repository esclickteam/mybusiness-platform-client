export const gridlineDefaultData = {
  ...
  marqueeOne: "מערכות עירוניות",
  marqueeTwo: "לוגיקת חזיתות",
  marqueeThree: "מסגרות פנים",
  marqueeFour: "תכנון אירוח",
  marqueeFive: "תוכניות מסחריות",
  aboutEyebrow: "אודות",
