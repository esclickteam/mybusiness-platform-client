export const citadelDefaultData = {
  templateId: "citadel",
  name: "Citadel",
  brandName: "Citadel",
  logoText: "CI",
  ...
  navInsights: "תובנות",
  navContact: "צור קשר",
  heroEyebrow: "אבטחת מידע",
  heroTitle: "הגנה שמתחילה בקו הקוד.",
  ...
  phone: "03-000-0000",
  email: "hello@citadel.co.il",
  address: "תל אביב, ישראל",
  footerText: "תבנית Citadel — אתר רב-עמודי מקצועי עם עיצוב מלבני ותנועה.",
