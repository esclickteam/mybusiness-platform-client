...
export default function CitadelThumbnail() {
  ...
  return (
    <div dir={getTextDirection(i18n.language)} className="relative h-full min-h-[260px] w-full overflow-hidden p-5" style={{ background: "#030a06", color: "#d7ffd9" }}>
      ...
      <div className="mt-10">
        <p className="mb-3 text-[10px] font-bold uppercase tracking-[0.24em]" style={{ color: "#39ff14" }}>
          {tx("אבטחת מידע")}</p>
        <h3 className="max-w-[220px] text-2xl font-black leading-tight">{tx("הגנה שמתחילה בקו הקוד.")}</h3>
