...
[data-template-id="contentra"], [data-template-id="contentra"] {
  --p: #7C2D12;
  --a: #EAB308;
  --bg: #FFF7ED;
  --surface: #FFFFFF;
...
[data-template-id="contentra"] .text-center { text-align: center; }
[data-template-id="contentra"] .ag-display,
[data-template-id="contentra"] .ag-display { font-family: "Libre Baskerville", "Noto Serif Hebrew", sans-serif; }
...
[data-template-id="contentra"] .ag-ken { animation: contentraKen 20s ease-in-out infinite alternate; }
[data-template-id="contentra"] .ag-float,
[data-template-id="contentra"] .ag-float { animation: contentraFloat 9s ease-in-out infinite; }
[data-template-id="contentra"] .ag-pulse,
[data-template-id="contentra"] .ag-pulse { animation: contentraPulse 2.5s ease-in-out infinite; }
[data-template-id="contentra"] .ag-scan,
[data-template-id="contentra"] .ag-scan { animation: contentraScan 13s linear infinite; }
[data-template-id="contentra"] .ag-drift,
[data-template-id="contentra"] .ag-drift { animation: contentraDrift 14s ease-in-out infinite alternate; }
...
@media (prefers-reduced-motion: reduce) {
  ...
  [data-template-id="contentra"] .ag-scan,
  [data-template-id="contentra"] .ag-drift,
  [data-template-id="contentra"] .ag-drift { animation: none; }
}
`;
