...
[data-template-id="bakora"], [data-template-id="bakora-preview"] {
...
[data-template-id="bakora-preview"] .tpl-display {
...
[data-template-id="bakora"] .tpl-ken, [data-template-id="bakora-preview"] .tpl-ken {
  animation: bakora-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="bakora"] .tpl-rise, [data-template-id="bakora-preview"] .tpl-rise {
  animation: bakora-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="bakora"] .tpl-rise-2, [data-template-id="bakora-preview"] .tpl-rise-2 {
  animation: bakora-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="bakora"] .tpl-rise-3, [data-template-id="bakora-preview"] .tpl-rise-3 {
...
[data-template-id="bakora"] .tpl-lam-layer, [data-template-id="bakora-preview"] .tpl-lam-layer { animation: bakora-lam 5s ease-in-out infinite; }
[data-template-id="bakora"] .tpl-flour, [data-template-id="bakora-preview"] .tpl-flour { animation: bakora-flour var(--flour-dur, 8s) linear infinite; }
