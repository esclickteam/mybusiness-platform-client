...
[data-template-id="gelatix"] .tpl-ken, [data-template-id="gelatix"] .tpl-ken {
  animation: gelatix-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="gelatix"] .tpl-rise, [data-template-id="gelatix"] .tpl-rise {
  animation: gelatix-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="gelatix"] .tpl-rise-2, [data-template-id="gelatix"] .tpl-rise-2 {
  animation: gelatix-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="gelatix"] .tpl-rise-3, [data-template-id="gelatix"] .tpl-rise-3 {
...
[data-template-id="gelatix"] .tpl-drip, [data-template-id="gelatix"] .tpl-drip { animation: gelatix-drip 3.2s ease-in infinite; }
[data-template-id="gelatix"] .tpl-scoop, [data-template-id="gelatix"] .tpl-scoop { animation: gelatix-scoop 4s ease-in-out infinite; }
