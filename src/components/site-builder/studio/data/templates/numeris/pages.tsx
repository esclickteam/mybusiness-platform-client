  ...
  return (
    <section id="contact" data-template-section-type="contact" className="bg-white px-5 py-24 lg:px-8 lg:py-28">
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.85fr_1.15fr]">
        ...
        <Reveal variant="left">
          <form className="grid gap-4 border border-[var(--p)]/14 bg-white p-6 shadow-[0_24px_70px_rgba(15,110,86,0.08)] md:p-8" data-bizuply-block="lead-form" data-bizuply-form-id="numeris-contact-1" data-bizuply-crm-lead="true" data-bizuply-success-message="תודה! קיבלנו את הפנייה ונחזור אליכם בהקדם.">
            <input name="name" data-bizuply-form-field-id="name" autoComplete="name"  className="border border-[var(--p)]/18 bg-white px-5 py-4 text-right outline-none transition placeholder:text-[var(--muted)]/55 focus:border-[var(--p)]" placeholder="שם מלא" />
            <input name="phone" data-bizuply-form-field-id="phone" type="tel" autoComplete="tel"  className="border border-[var(--p)]/18 bg-white px-5 py-4 text-right outline-none transition placeholder:text-[var(--muted)]/55 focus:border-[var(--p)]" placeholder="טלפון" />
            <input name="email" data-bizuply-form-field-id="email" type="email" autoComplete="email"  className="border border-[var(--p)]/18 bg-white px-5 py-4 text-right outline-none transition placeholder:text-[var(--muted)]/55 focus:border-[var(--p)]" placeholder="אימייל" />
            <textarea name="message" data-bizuply-form-field-id="message"  className="min-h-32 border border-[var(--p)]/18 bg-white px-5 py-4 text-right outline-none transition placeholder:text-[var(--muted)]/55 focus:border-[var(--p)]" placeholder="כמה עובדים / חשבוניות בחודש?" />
  ...
  return (
    <div className="fixed inset-0 z-[80] grid place-items-center bg-[var(--dark)]/55 px-4 backdrop-blur-sm">
      <div className="relative w-full max-w-md border border-[var(--p)] bg-white p-8 text-[var(--text)]">
        ...
        <form className="mt-6 grid gap-3" data-bizuply-block="lead-form" data-bizuply-form-id="numeris-contact-2" data-bizuply-crm-lead="true" data-bizuply-success-message="תודה! קיבלנו את הפנייה ונחזור אליכם בהקדם.">
          <input name="name" data-bizuply-form-field-id="name" autoComplete="name"  className="border border-[var(--p)]/18 px-5 py-4 text-right outline-none focus:border-[var(--p)]" placeholder="שם מלא" />
          <input name="phone" data-bizuply-form-field-id="phone" type="tel" autoComplete="tel"  className="border border-[var(--p)]/18 px-5 py-4 text-right outline-none focus:border-[var(--p)]" placeholder="טלפון" />
