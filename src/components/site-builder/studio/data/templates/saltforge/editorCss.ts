...
[data-template-id="saltforge"] .tpl-ken, [data-template-id="saltforge"] .tpl-ken {
  animation: saltforge-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="saltforge"] .tpl-rise, [data-template-id="saltforge"] .tpl-rise {
  animation: saltforge-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="saltforge"] .tpl-rise-2, [data-template-id="saltforge"] .tpl-rise-2 {
  animation: saltforge-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="saltforge"] .tpl-rise-3, [data-template-id="saltforge"] .tpl-rise-3 {
  animation: saltforge-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="saltforge"] .tpl-marquee-track, [data-template-id="saltforge"] .tpl-marquee-track {
  display: flex; width: max-content; animation: saltforge-marquee 28s linear infinite;
}
[data-template-id="saltforge"] .tpl-float, [data-template-id="saltforge"] .tpl-float {
  animation: saltforge-float 5s ease-in-out infinite;
}
[data-template-id="saltforge"] .tpl-sweep, [data-template-id="saltforge"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="saltforge"] .tpl-sweep::after, [data-template-id="saltforge"] .tpl-sweep::after {
...
[data-template-id="saltforge"] .tpl-climb, [data-template-id="saltforge"] .tpl-climb {
...
[data-template-id="saltforge"] .tpl-grain, [data-template-id="saltforge"] .tpl-grain {
...
[data-template-id="saltforge"] .tpl-masonry, [data-template-id="saltforge"] .tpl-masonry {
  columns: 2; column-gap: 1rem;
}
@media (min-width: 768px) {
  [data-template-id="saltforge"] .tpl-masonry, [data-template-id="saltforge"] .tpl-masonry { columns: 3; }
}
`;
