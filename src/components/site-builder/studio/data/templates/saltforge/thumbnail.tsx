    ...
    <div dir={getTextDirection(i18n.language)} className="relative h-full min-h-[260px] w-full overflow-hidden">
      <div className="relative h-full min-h-[260px] overflow-hidden">
        ...
        <div className="relative grid h-full grid-cols-2 gap-1 p-3">
          <div className="col-span-2"><p className="text-[10px]" style={{ color: "#c45c26" }}>{tx("Artisan · חוף")}</p><h3 className="text-2xl font-bold" style={{ fontFamily: '"Oswald"', color: "#fff" }}>Saltforge</h3></div>
