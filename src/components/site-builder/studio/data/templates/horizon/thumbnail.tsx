...
export default function HorizonThumbnail() {
  ...
  return (
    <div dir={getTextDirection(i18n.language)} className="relative h-full min-h-[260px] w-full overflow-hidden p-5" style={{ background: "#f7f3ed", color: "#1c1c1c" }}>
      ...
      <div className="mt-10">
        <p className="mb-3 text-[10px] font-bold uppercase tracking-[0.24em]" style={{ color: "#b8956b" }}>
          {tx("נדל״ן")}</p>
        <h3 className="max-w-[220px] text-2xl font-black leading-tight">{tx("נוף שמשנה החלטות.")}</h3>
