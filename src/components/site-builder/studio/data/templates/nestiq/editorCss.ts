...
[data-template-id="nestiq"] .tpl-ken, [data-template-id="nestiq"] .tpl-ken {
  animation: nestiq-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="nestiq"] .tpl-rise, [data-template-id="nestiq"] .tpl-rise {
  animation: nestiq-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="nestiq"] .tpl-rise-2, [data-template-id="nestiq"] .tpl-rise-2 {
  animation: nestiq-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="nestiq"] .tpl-rise-3, [data-template-id="nestiq"] .tpl-rise-3 {
  animation: nestiq-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="nestiq"] .tpl-marquee-track, [data-template-id="nestiq"] .tpl-marquee-track {
  display: flex; width: max-content; animation: nestiq-marquee 28s linear infinite;
}
[data-template-id="nestiq"] .tpl-float, [data-template-id="nestiq"] .tpl-float {
  animation: nestiq-float 5s ease-in-out infinite;
}
[data-template-id="nestiq"] .tpl-sweep, [data-template-id="nestiq"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="nestiq"] .tpl-sweep::after, [data-template-id="nestiq"] .tpl-sweep::after {
...
[data-template-id="nestiq"] .tpl-climb, [data-template-id="nestiq"] .tpl-climb {
...
[data-template-id="nestiq"] .tpl-counter, [data-template-id="nestiq"] .tpl-counter { animation:nestiq-count 1s both; }
@keyframes nestiq-testi { to { transform:translateX(-50%); } }
[data-template-id="nestiq"] .tpl-testi-track, [data-template-id="nestiq"] .tpl-testi-track {
