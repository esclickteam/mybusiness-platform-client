...
[data-template-id="pastafora"] .tpl-ken, [data-template-id="pastafora"] .tpl-ken {
  animation: pastafora-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="pastafora"] .tpl-rise, [data-template-id="pastafora"] .tpl-rise {
  animation: pastafora-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="pastafora"] .tpl-rise-2, [data-template-id="pastafora"] .tpl-rise-2 {
  animation: pastafora-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="pastafora"] .tpl-rise-3, [data-template-id="pastafora"] .tpl-rise-3 {
...
[data-template-id="pastafora"] .tpl-swirl, [data-template-id="pastafora"] .tpl-swirl { animation: pastafora-swirl 28s linear infinite; }
