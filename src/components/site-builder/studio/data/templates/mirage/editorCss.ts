...
[data-template-id="mirage"] .tpl-ken, [data-template-id="mirage"] .tpl-ken {
  animation: mirage-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="mirage"] .tpl-rise, [data-template-id="mirage"] .tpl-rise {
  animation: mirage-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="mirage"] .tpl-rise-2, [data-template-id="mirage"] .tpl-rise-2 {
  animation: mirage-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="mirage"] .tpl-rise-3, [data-template-id="mirage"] .tpl-rise-3 {
  animation: mirage-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="mirage"] .tpl-marquee-track, [data-template-id="mirage"] .tpl-marquee-track {
  display: flex; width: max-content; animation: mirage-marquee 28s linear infinite;
}
[data-template-id="mirage"] .tpl-float, [data-template-id="mirage"] .tpl-float {
  animation: mirage-float 5s ease-in-out infinite;
}
[data-template-id="mirage"] .tpl-sweep, [data-template-id="mirage"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="mirage"] .tpl-sweep::after, [data-template-id="mirage"] .tpl-sweep::after {
...
[data-template-id="mirage"] .tpl-climb, [data-template-id="mirage"] .tpl-climb {
...
[data-template-id="mirage"] .tpl-shimmer-wobble, [data-template-id="mirage"] .tpl-shimmer-wobble {
  animation: mirage-shimmer-wobble 2.8s ease-in-out infinite;
}
[data-template-id="mirage"] .tpl-temp-band, [data-template-id="mirage"] .tpl-temp-band {
