...
[data-template-id="emberplate"] .tpl-ken, [data-template-id="emberplate"] .tpl-ken {
  animation: emberplate-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="emberplate"] .tpl-rise, [data-template-id="emberplate"] .tpl-rise {
  animation: emberplate-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="emberplate"] .tpl-rise-2, [data-template-id="emberplate"] .tpl-rise-2 {
  animation: emberplate-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="emberplate"] .tpl-rise-3, [data-template-id="emberplate"] .tpl-rise-3 {
  animation: emberplate-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="emberplate"] .tpl-marquee-track, [data-template-id="emberplate"] .tpl-marquee-track {
  display: flex; width: max-content; animation: emberplate-marquee 28s linear infinite;
}
[data-template-id="emberplate"] .tpl-float, [data-template-id="emberplate"] .tpl-float {
  animation: emberplate-float 5s ease-in-out infinite;
}
[data-template-id="emberplate"] .tpl-sweep, [data-template-id="emberplate"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="emberplate"] .tpl-sweep::after, [data-template-id="emberplate"] .tpl-sweep::after {
...
[data-template-id="emberplate"] .tpl-climb, [data-template-id="emberplate"] .tpl-climb {
...
[data-template-id="emberplate"] .tpl-ember, [data-template-id="emberplate"] .tpl-ember {
  animation: emberplate-ember-rise var(--ember-dur, 7s) linear infinite;
}
[data-template-id="emberplate"] .tpl-ember-pulse, [data-template-id="emberplate"] .tpl-ember-pulse {
  animation: emberplate-ember-pulse 2.4s ease-in-out infinite;
}
[data-template-id="emberplate"] .tpl-glow-chip, [data-template-id="emberplate"] .tpl-glow-chip {
  animation: emberplate-glow-chip 2.8s ease-in-out infinite;
}
[data-template-id="emberplate"] .tpl-meat-line, [data-template-id="emberplate"] .tpl-meat-line {
  position: relative;
}
[data-template-id="emberplate"] .tpl-meat-line::before, [data-template-id="emberplate"] .tpl-meat-line::before {
