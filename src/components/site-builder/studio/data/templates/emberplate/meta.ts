...
export const emberplateSeed = {
  ...
  blocks: [
    ...
    { type: "hours", variant: "glowing-hour-chips", title: "Glowing hour chips" },
    { type: "about", variant: "ash-texture-reverse", title: "Ash texture about reverse" },
    { type: "contact", variant: "ember-pulse-form", title: "Ember pulse contact" },
