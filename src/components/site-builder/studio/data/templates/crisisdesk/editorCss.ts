...
[data-template-id="crisisdesk"], [data-template-id="crisisdesk"] {
  --p: #DC2626;
  --a: #FDE047;
  --bg: #111827;
  --surface: #1F2937;
...
[data-template-id="crisisdesk"] .text-center { text-align: center; }
[data-template-id="crisisdesk"] .ag-display,
[data-template-id="crisisdesk"] .ag-display { font-family: "Oswald", "Tinos", sans-serif; }
...
[data-template-id="crisisdesk"] .ag-ken { animation: crisisdeskKen 28s ease-in-out infinite alternate; }
[data-template-id="crisisdesk"] .ag-float,
[data-template-id="crisisdesk"] .ag-float { animation: crisisdeskFloat 7s ease-in-out infinite; }
[data-template-id="crisisdesk"] .ag-pulse,
[data-template-id="crisisdesk"] .ag-pulse { animation: crisisdeskPulse 2.5s ease-in-out infinite; }
[data-template-id="crisisdesk"] .ag-scan,
[data-template-id="crisisdesk"] .ag-scan { animation: crisisdeskScan 21s linear infinite; }
[data-template-id="crisisdesk"] .ag-drift,
[data-template-id="crisisdesk"] .ag-drift { animation: crisisdeskDrift 22s ease-in-out infinite alternate; }
...
@media (prefers-reduced-motion: reduce) {
  ...
  [data-template-id="crisisdesk"] .ag-scan,
  [data-template-id="crisisdesk"] .ag-drift,
  [data-template-id="crisisdesk"] .ag-drift { animation: none; }
}
`;
