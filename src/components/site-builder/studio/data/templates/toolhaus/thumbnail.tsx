...
export default function ToolhausThumbnail() {
  ...
  return (
    <div dir={getTextDirection(i18n.language)} className="relative flex h-full min-h-[260px] w-full flex-col justify-between overflow-hidden p-5 text-right" style={{ background: "#111827", color: "#F8FAFC", fontFamily: "Heebo, sans-serif" }}>
      ...
      <div className="relative">
        <div className="inline-flex px-2 py-1 text-[10px] font-black uppercase tracking-[0.2em]" style={{ background: "#CA8A04", color: "#1C1917" }}>{tx("כלי עבודה ו-DIY")}</div>
        <h3 className="mt-4 text-3xl font-black leading-none" style={{ fontFamily: "IBM Plex Sans, serif" }}>Toolhaus</h3>
        <p className="mt-2 text-xs font-semibold opacity-70">{tx("כלים לעבודה מדויקת")}</p>
      </div>
