    ...
    <section id="bladehaus-booking" data-template-section-type="booking" className="bg-[#070707] px-5 py-24 lg:px-8 lg:py-32">
      <Reveal className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        ...
        <div className="grid gap-4">
          <CrmBookingMount className="min-h-[420px] w-full border-2 border-[var(--a)] bg-black p-3" accent="#f5c518" />
          <form className="grid gap-4 border-2 border-[var(--a)] bg-black p-6 md:p-9" data-bizuply-block="lead-form" data-bizuply-crm-lead="true" data-bizuply-form-builder="true" data-bizuply-form-skin="template" data-bizuply-form-id="bladehaus-contact" data-bizuply-success-message={tx("תודה! קיבלנו את הפנייה ונחזור אלייך בהקדם.")}>
            <div className="grid gap-4 md:grid-cols-2">
              <input className="border border-white/20 bg-[#111] px-5 py-4 text-start font-bold uppercase tracking-wide text-white outline-none focus:border-[var(--a)]" placeholder={tx("שם מלא")} name="name" data-bizuply-form-field-id="name" type="text" autoComplete="name" />
              <input className="border border-white/20 bg-[#111] px-5 py-4 text-start font-bold uppercase tracking-wide text-white outline-none focus:border-[var(--a)]" placeholder={tx("טלפון")} name="phone" data-bizuply-form-field-id="phone" type="tel" autoComplete="tel" />
            </div>
            <input className="border border-white/20 bg-[#111] px-5 py-4 text-start font-bold uppercase tracking-wide text-white outline-none focus:border-[var(--a)]" placeholder={tx("שירות מבוקש")} name="service" data-bizuply-form-field-id="service" />
            <textarea className="min-h-[120px] border border-white/20 bg-[#111] px-5 py-4 text-start font-bold uppercase tracking-wide text-white outline-none focus:border-[var(--a)]" placeholder={tx("הערות")} name="message" data-bizuply-form-field-id="message"></textarea>
            <button type="submit" className="bg-[var(--a)] px-8 py-5 text-sm font-black uppercase tracking-[0.28em] text-black transition hover:bg-white">
  ...
  return (
    <div className="fixed inset-0 z-[80] grid place-items-center bg-black/80 px-4 backdrop-blur-sm">
      <div className="relative w-full max-w-md border-2 border-[var(--a)] bg-black p-8">
        ...
        <form className="mt-6 grid gap-3" data-bizuply-block="lead-form" data-bizuply-crm-lead="true" data-bizuply-form-builder="true" data-bizuply-form-skin="template" data-bizuply-form-id="bladehaus-contact-2" data-bizuply-success-message={tx("תודה! קיבלנו את הפנייה ונחזור אלייך בהקדם.")}>
          <input className="border border-white/20 bg-[#111] px-5 py-4 text-start font-bold text-white outline-none focus:border-[var(--a)]" placeholder={tx("שם מלא")}  name="name" data-bizuply-form-field-id="name" type="text" autoComplete="name" />
          <input className="border border-white/20 bg-[#111] px-5 py-4 text-start font-bold text-white outline-none focus:border-[var(--a)]" placeholder={tx("טלפון")}  name="phone" data-bizuply-form-field-id="phone" type="tel" autoComplete="tel" />
...
export default function BladehausPages(props: BladehausPagesProps) {
  ...
  return (
    <div dir={templateDir()} data-template-id="bladehaus" className="min-h-screen w-full overflow-x-hidden">
