...
[data-template-id="bladehaus-preview"] article,
[data-template-id="bladehaus"] input,
[data-template-id="bladehaus-preview"] input,
[data-template-id="bladehaus"] textarea,
[data-template-id="bladehaus-preview"] textarea,
[data-template-id="bladehaus"] button,
[data-template-id="bladehaus-preview"] button {
  border-radius: 0;
}
...
[data-template-id="bladehaus-preview"] .bh-mark {
...
[data-template-id="bladehaus-preview"] .bh-outline {
...
[data-template-id="bladehaus-preview"] .bh-outline:hover {
...
[data-template-id="bladehaus-preview"] .bh-price-panel,
[data-template-id="bladehaus"] .bh-review,
[data-template-id="bladehaus-preview"] .bh-review {
  position: relative;
  overflow: hidden;
...
[data-template-id="bladehaus-preview"] .bh-price-panel::after,
[data-template-id="bladehaus"] .bh-review::after,
[data-template-id="bladehaus-preview"] .bh-review::after {
  content: "";
  position: absolute;
  inset: -40% auto -40% 70%;
  width: 35%;
...
[data-template-id="bladehaus-preview"] .bh-price-panel:hover,
[data-template-id="bladehaus"] .bh-review:hover,
[data-template-id="bladehaus-preview"] .bh-review:hover {
