...
[data-template-id="skylara"] .tpl-ken, [data-template-id="skylara"] .tpl-ken {
  animation: skylara-ken 20s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="skylara"] .tpl-rise, [data-template-id="skylara"] .tpl-rise {
  animation: skylara-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="skylara"] .tpl-rise-2, [data-template-id="skylara"] .tpl-rise-2 {
  animation: skylara-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="skylara"] .tpl-rise-3, [data-template-id="skylara"] .tpl-rise-3 {
  animation: skylara-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="skylara"] .tpl-draw, [data-template-id="skylara"] .tpl-draw {
  transform-origin: right center; animation: skylara-draw 1.1s cubic-bezier(.22,1,.36,1) .2s both;
}
[data-template-id="skylara"] .tpl-marquee-track, [data-template-id="skylara"] .tpl-marquee-track {
  display: flex; width: max-content; animation: skylara-marquee 28s linear infinite;
}
[data-template-id="skylara"] .tpl-float, [data-template-id="skylara"] .tpl-float {
  animation: skylara-float 5s ease-in-out infinite;
}
[data-template-id="skylara"] .tpl-pulse-line, [data-template-id="skylara"] .tpl-pulse-line {
  animation: skylara-pulse 2.1s ease-in-out infinite;
}
[data-template-id="skylara"] .tpl-sweep, [data-template-id="skylara"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="skylara"] .tpl-sweep::after, [data-template-id="skylara"] .tpl-sweep::after {
...
[data-template-id="skylara"] .tpl-climb, [data-template-id="skylara"] .tpl-climb {
