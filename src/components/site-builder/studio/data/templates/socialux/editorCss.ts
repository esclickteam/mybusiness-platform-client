...
[data-template-id="socialux"], [data-template-id="socialux"] {
  --p: #00C2FF;
  --a: #F72585;
  --bg: #08111F;
  --surface: #0E1B2E;
...
[data-template-id="socialux"] .ag-display { font-family: "Bebas Neue", "Rubik", sans-serif; }
...
[data-template-id="socialux"] .ag-ken { animation: socialuxKen 17s ease-in-out infinite alternate; }
[data-template-id="socialux"] .ag-float,
[data-template-id="socialux"] .ag-float { animation: socialuxFloat 6s ease-in-out infinite; }
[data-template-id="socialux"] .ag-pulse,
[data-template-id="socialux"] .ag-pulse { animation: socialuxPulse 2.8s ease-in-out infinite; }
[data-template-id="socialux"] .ag-scan,
[data-template-id="socialux"] .ag-scan { animation: socialuxScan 10s linear infinite; }
[data-template-id="socialux"] .ag-drift,
[data-template-id="socialux"] .ag-drift { animation: socialuxDrift 11s ease-in-out infinite alternate; }
...
@media (prefers-reduced-motion: reduce) {
  ...
  [data-template-id="socialux"] .ag-scan,
  [data-template-id="socialux"] .ag-drift,
  [data-template-id="socialux"] .ag-drift { animation: none; }
}
`;
