...
export default function SocialuxThumbnail() {
  ...
  return (
    <div dir={getTextDirection(i18n.language)} className="flex h-full w-full flex-col justify-between overflow-hidden p-5 text-right" style={{ background: "#08111F", color: "#F2FBFF", fontFamily: "Rubik, sans-serif" }}>
      <div>
        <div className="inline-flex rounded-full px-3 py-1 text-[10px] font-black" style={{ background: "#00C2FF", color: "#fff" }}>{tx("סוכנות סושיאל")}</div>
