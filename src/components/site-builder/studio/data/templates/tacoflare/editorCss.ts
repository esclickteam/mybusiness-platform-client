...
[data-template-id="tacoflare"] .tpl-ken, [data-template-id="tacoflare"] .tpl-ken {
  animation: tacoflare-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="tacoflare"] .tpl-rise, [data-template-id="tacoflare"] .tpl-rise {
  animation: tacoflare-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="tacoflare"] .tpl-rise-2, [data-template-id="tacoflare"] .tpl-rise-2 {
  animation: tacoflare-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="tacoflare"] .tpl-rise-3, [data-template-id="tacoflare"] .tpl-rise-3 {
...
[data-template-id="tacoflare"] .tpl-papel, [data-template-id="tacoflare"] .tpl-papel { animation: tacoflare-papel 4.5s ease-in-out infinite; }
