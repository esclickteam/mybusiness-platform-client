...
[data-template-id="dimsumix"], [data-template-id="dimsumix-preview"] {
...
[data-template-id="dimsumix-preview"] .tpl-display {
...
[data-template-id="dimsumix"] .tpl-ken, [data-template-id="dimsumix-preview"] .tpl-ken {
  animation: dimsumix-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="dimsumix"] .tpl-rise, [data-template-id="dimsumix-preview"] .tpl-rise {
  animation: dimsumix-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="dimsumix"] .tpl-rise-2, [data-template-id="dimsumix-preview"] .tpl-rise-2 {
  animation: dimsumix-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="dimsumix"] .tpl-rise-3, [data-template-id="dimsumix-preview"] .tpl-rise-3 {
...
[data-template-id="dimsumix"] .tpl-steam, [data-template-id="dimsumix-preview"] .tpl-steam { animation: dimsumix-steam var(--steam-dur, 6s) ease-in infinite; }
[data-template-id="dimsumix"] .tpl-basket, [data-template-id="dimsumix-preview"] .tpl-basket { animation: dimsumix-basket 4s ease-in-out infinite; }
