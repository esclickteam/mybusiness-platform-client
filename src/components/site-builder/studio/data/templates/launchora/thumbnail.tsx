...
export default function LaunchoraThumbnail() {
  ...
  return (
    <div dir={getTextDirection(i18n.language)} className="flex h-full w-full flex-col justify-between overflow-hidden p-5 text-right" style={{ background: "#170B0B", color: "#FFF7ED", fontFamily: "Varela Round, sans-serif" }}>
      <div>
        <div className="inline-flex rounded-full px-3 py-1 text-[10px] font-black" style={{ background: "#EF4444", color: "#fff" }}>{tx("סוכנות השקות מוצר")}</div>
