  ...
  useEffect(() => {
    ...
    function update() {
      ...
      if (node) {
        ...
        /*
          התקדמות אמיתית לפי הסקשן עצמו:
          כשהסקשן מתחיל בראש המסך -> 0.
          כשהסטיקי מגיע לסוף הסקשן -> 1.
          עובד גם בתוך עורך שיש לו scroll פנימי.
        */
...
function HeroWorkMotion({
  ...
  */
  ...
  return (
    <section
      ref={ref}
      className="relative h-[230vh] overflow-visible bg-[#fbfbfa]"
