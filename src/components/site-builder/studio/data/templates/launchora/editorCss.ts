...
[data-template-id="launchora"], [data-template-id="launchora"] {
  --p: #EF4444;
  --a: #FBBF24;
  --bg: #170B0B;
  --surface: #261111;
...
[data-template-id="launchora"] .ag-display { font-family: "Anton", "Varela Round", sans-serif; }
...
[data-template-id="launchora"] .ag-ken { animation: launchoraKen 22s ease-in-out infinite alternate; }
[data-template-id="launchora"] .ag-float,
[data-template-id="launchora"] .ag-float { animation: launchoraFloat 6s ease-in-out infinite; }
[data-template-id="launchora"] .ag-pulse,
[data-template-id="launchora"] .ag-pulse { animation: launchoraPulse 3.1s ease-in-out infinite; }
[data-template-id="launchora"] .ag-scan,
[data-template-id="launchora"] .ag-scan { animation: launchoraScan 15s linear infinite; }
[data-template-id="launchora"] .ag-drift,
[data-template-id="launchora"] .ag-drift { animation: launchoraDrift 16s ease-in-out infinite alternate; }
...
@media (prefers-reduced-motion: reduce) {
  ...
  [data-template-id="launchora"] .ag-scan,
  [data-template-id="launchora"] .ag-drift,
  [data-template-id="launchora"] .ag-drift { animation: none; }
}
`;
