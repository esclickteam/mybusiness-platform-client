...
[data-template-id="sunrift"] .tpl-ken, [data-template-id="sunrift"] .tpl-ken {
  animation: sunrift-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="sunrift"] .tpl-rise, [data-template-id="sunrift"] .tpl-rise {
  animation: sunrift-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="sunrift"] .tpl-rise-2, [data-template-id="sunrift"] .tpl-rise-2 {
  animation: sunrift-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="sunrift"] .tpl-rise-3, [data-template-id="sunrift"] .tpl-rise-3 {
  animation: sunrift-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="sunrift"] .tpl-marquee-track, [data-template-id="sunrift"] .tpl-marquee-track {
  display: flex; width: max-content; animation: sunrift-marquee 28s linear infinite;
}
[data-template-id="sunrift"] .tpl-float, [data-template-id="sunrift"] .tpl-float {
  animation: sunrift-float 5s ease-in-out infinite;
}
[data-template-id="sunrift"] .tpl-sweep, [data-template-id="sunrift"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="sunrift"] .tpl-sweep::after, [data-template-id="sunrift"] .tpl-sweep::after {
...
[data-template-id="sunrift"] .tpl-climb, [data-template-id="sunrift"] .tpl-climb {
...
[data-template-id="sunrift"] .tpl-shimmer, [data-template-id="sunrift"] .tpl-shimmer { position: relative; overflow: hidden; }
[data-template-id="sunrift"] .tpl-shimmer::after, [data-template-id="sunrift"] .tpl-shimmer::after {
