...
[data-template-id="lectora"] .t-ken { animation: lectora-ken 16s ease-in-out infinite alternate; }
[data-template-id="lectora"] .t-anim,
[data-template-id="lectora"] .t-anim { animation: lectora-up 0.9s cubic-bezier(0.22,1,0.36,1) both; }
[data-template-id="lectora"] .t-d1,
[data-template-id="lectora"] .t-d1 { animation-delay: .12s; }
[data-template-id="lectora"] .t-d2,
[data-template-id="lectora"] .t-d2 { animation-delay: .24s; }
[data-template-id="lectora"] .t-d3,
[data-template-id="lectora"] .t-d3 { animation-delay: .36s; }
[data-template-id="lectora"] .t-fade,
[data-template-id="lectora"] .t-fade { animation: lectora-fade 1s ease both; }
[data-template-id="lectora"] .t-marquee,
[data-template-id="lectora"] .t-marquee { animation: lectora-marquee 28s linear infinite; width: max-content; }
[data-template-id="lectora"] .t-float,
[data-template-id="lectora"] .t-float { animation: lectora-float 6.5s ease-in-out infinite; }
[data-template-id="lectora"] .t-pulse,
[data-template-id="lectora"] .t-pulse { animation: lectora-pulse 2.6s ease-in-out infinite; }
[data-template-id="lectora"] .t-wave,
[data-template-id="lectora"] .t-wave { animation: lectora-wave 2.2s ease-in-out infinite; }
...
[data-template-id="lectora"] .t-hover:hover { transform: translateY(-6px); }
...
@media (prefers-reduced-motion: reduce) {
  ...
  [data-template-id="lectora"] .t-wave,
  [data-template-id="lectora"] .t-fade,
  [data-template-id="lectora"] .t-fade { animation: none !important; }
}
`;
