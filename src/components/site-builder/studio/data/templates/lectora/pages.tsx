...
function Curriculum({ data }: { data: Record<string, any> }) {
  return (
    <section data-template-section-type="curriculum" className="px-5 py-12 md:py-24 lg:px-8">
...
function Instructors({ data }: { data: Record<string, any> }) {
  return (
    <section data-template-section-type="instructors" className="bg-[var(--surface)] px-5 py-12 md:py-24 lg:px-8">
...
function Faq({ data }: { data: Record<string, any> }) {
  return (
    <section id="faq" data-template-section-type="faq" className="px-5 py-12 md:py-24 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[280px_1fr]">
        <Reveal><h2 className="t-display sticky top-28 text-2xl sm:text-4xl font-bold">{getValue(data,"sectionSevenTitle")}</h2></Reveal>
    ...
    <section id="contact" data-template-section-type="contact" className="px-5 py-12 md:py-24 lg:px-8">
      <div className="mx-auto grid max-w-7xl overflow-hidden border border-[var(--p)]/30 lg:grid-cols-2">
        <div className="bg-[var(--p)] p-10 text-[var(--dark)] lg:p-14">
          <Reveal><h2 className="t-display text-2xl sm:text-4xl font-bold">{getValue(data,"contactTitle")}</h2>
        ...
        <form className="grid gap-4 bg-[var(--surface)] p-10 lg:p-14" data-bizuply-block="lead-form" data-bizuply-form-id="lectora-contact-1" data-bizuply-crm-lead="true" data-bizuply-success-message="תודה! קיבלנו את הפנייה ונחזור אליכם בהקדם.">
          <input name="name" data-bizuply-form-field-id="name" autoComplete="name"  className="border border-[var(--p)]/30 bg-transparent px-5 py-4 outline-none" placeholder="שם מלא" />
          <input name="phone" data-bizuply-form-field-id="phone" type="tel" autoComplete="tel"  className="border border-[var(--p)]/30 bg-transparent px-5 py-4 outline-none" placeholder="טלפון" />
  ...
  return (
    <div className="fixed inset-0 z-[80] grid place-items-center bg-black/70 px-4 backdrop-blur-sm">
      <div className="relative w-full max-w-md border border-[var(--p)]/30 bg-[var(--surface)] p-8">
        ...
        <form className="mt-6 grid gap-3" data-bizuply-block="lead-form" data-bizuply-form-id="lectora-contact-2" data-bizuply-crm-lead="true" data-bizuply-success-message="תודה! קיבלנו את הפנייה ונחזור אליכם בהקדם.">
