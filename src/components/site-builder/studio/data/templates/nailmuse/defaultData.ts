export const nailmuseDefaultData = {
  templateId: "nailmuse",
  name: "Nailmuse",
  brandName: "Nailmuse",
  ...
  navServices: "שירותים",
  navBooking: "תורים",
  heroEyebrow: "נייל ארט",
  heroTitle: "Nailmuse\nציפורניים עם רעיון.",
  heroSubtitle: "איורים קטנים, טקסטורות, כרום וקולקציות השראה שמתרגמות מצב רוח לסט מושלם.",
  heroPrimaryButton: "עיצוב אישי",
  heroSecondaryButton: "לגלריה",
  heroImage: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?auto=format&fit=crop&w=2200&q=85",
  sectionImage: "https://images.unsplash.com/photo-1519823551278-64ac92734fb1?auto=format&fit=crop&w=1400&q=85",
  galleryImage1: "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?auto=format&fit=crop&w=1400&q=85",
  galleryImage2: "https://images.unsplash.com/photo-1583001931096-959e9a1a6223?auto=format&fit=crop&w=1400&q=85",
  ...
  aboutHeroTitle: "הסיפור מאחורי Nailmuse",
  aboutStoryTitle: "מאיפה הכל התחיל",
  aboutStoryText: "Nailmuse נבנה כמקום שמחבר בין טיפול מקצועי לחוויה רגועה: כל ביקור מתחיל בשיחה קצרה, ממשיך בבחירת פרוטוקול מדויק ומסתיים בהנחיות ברורות להמשך בבית. הצוות מתעד העדפות, רגישויות ותוצאות כדי שכל מפגש הבא יהיה אישי יותר, נעים יותר ומדויק יותר.",
  ...
  servicesIntroText: "קטלוג הטיפולים של Nailmuse מפרט מה מקבלים בכל שירות, כמה זמן כדאי לפנות, למי הוא מתאים ואילו תוספות יכולות לשדרג את התוצאה. המטרה היא שתבחרו טיפול מתוך ידע מלא ולא מתוך ניחוש.",
  ...
  itemOneTitle: "איור מינימלי",
  itemOneText: "פרחים, קווים או סמל קטן לכל יד. כולל אבחון קצר, התאמה אישית, עבודה מדויקת והמלצות המשך כתובות כדי שהתוצאה תישאר יפה גם אחרי היציאה מהסטודיו.",
  itemTwoTitle: "כרום וזכוכית",
  itemTwoText: "אפקט מבריק על בסיס שקוף או צבע. כולל אבחון קצר, התאמה אישית, עבודה מדויקת והמלצות המשך כתובות כדי שהתוצאה תישאר יפה גם אחרי היציאה מהסטודיו.",
  itemThreeTitle: "סט קונספט",
  itemThreeText: "עיצוב מלא לפי תמונת השראה. כולל אבחון קצר, התאמה אישית, עבודה מדויקת והמלצות המשך כתובות כדי שהתוצאה תישאר יפה גם אחרי היציאה מהסטודיו.",
  itemFourTitle: "טופ תלת־ממד",
  itemFourText: "אבנים, פנינים ומרקמים עדינים. כולל אבחון קצר, התאמה אישית, עבודה מדויקת והמלצות המשך כתובות כדי שהתוצאה תישאר יפה גם אחרי היציאה מהסטודיו.",
  team1Name: "מאיה לב",
