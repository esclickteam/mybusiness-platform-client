export const monolithDefaultData = {
  ...
  marqueeOne: "ייעוץ דירקטוריון",
  marqueeTwo: "מוכנות להון",
  marqueeThree: "ממשל צמיחה",
  marqueeFour: "משרד טרנספורמציה",
  marqueeFive: "תקשורת הנהלה",
  aboutEyebrow: "אודות",
