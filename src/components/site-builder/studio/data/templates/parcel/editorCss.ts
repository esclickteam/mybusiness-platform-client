...
[data-template-id="parcel"] .tpl-ken, [data-template-id="parcel"] .tpl-ken {
  animation: parcel-ken 19s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="parcel"] .tpl-rise, [data-template-id="parcel"] .tpl-rise {
  animation: parcel-rise .85s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="parcel"] .tpl-rise-2, [data-template-id="parcel"] .tpl-rise-2 {
  animation: parcel-rise .85s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="parcel"] .tpl-rise-3, [data-template-id="parcel"] .tpl-rise-3 {
  animation: parcel-rise .85s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="parcel"] .tpl-draw, [data-template-id="parcel"] .tpl-draw {
  transform-origin: right center; animation: parcel-draw 1s cubic-bezier(.22,1,.36,1) .15s both;
}
[data-template-id="parcel"] .tpl-marquee-track, [data-template-id="parcel"] .tpl-marquee-track {
  display: flex; width: max-content; animation: parcel-marquee 31s linear infinite;
}
[data-template-id="parcel"] .tpl-float, [data-template-id="parcel"] .tpl-float {
  animation: parcel-float 5.4s ease-in-out infinite;
}
[data-template-id="parcel"] .tpl-pulse-line, [data-template-id="parcel"] .tpl-pulse-line {
  animation: parcel-pulse 2.5s ease-in-out infinite;
}
[data-template-id="parcel"] .tpl-sweep, [data-template-id="parcel"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="parcel"] .tpl-sweep::after, [data-template-id="parcel"] .tpl-sweep::after {
...
[data-template-id="parcel"] .tpl-climb, [data-template-id="parcel"] .tpl-climb {
