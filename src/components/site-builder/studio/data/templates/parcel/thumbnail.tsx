      ...
      <div className="relative h-full min-h-[260px] overflow-hidden p-4" style={{ background: "#efe9da", color: "#243018", fontFamily: '"IBM Plex Sans Hebrew", sans-serif' }}>
        ...
        <div className="relative z-10 mt-3 grid grid-cols-[1fr_0.8fr] gap-3">
          <div>
            ...
            <h3 className="mt-1 text-2xl font-black leading-none">{tx("בודקים קרקע.")}</h3>
          </div>
        ...
        <div className="absolute inset-x-4 bottom-4 border-t pt-2 text-[10px] font-bold tracking-[0.16em]" style={{ borderColor: "rgba(107,90,46,0.28)", color: "#6e684f" }}>{tx("820 מ״ר · מגורים א׳ · חזית דרומית")}</div>
      </div>
    </div>
  );
}
