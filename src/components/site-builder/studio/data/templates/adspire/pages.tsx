      ...
      <div className="relative mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1fr_420px] lg:items-center">
        ...
        <Reveal variant="left" delayMs={100}>
          <form className="grid gap-3 border border-white/25 bg-white/10 p-5 backdrop-blur-xl" data-bizuply-block="lead-form" data-bizuply-crm-lead="true" data-bizuply-form-builder="true" data-bizuply-form-id="adspire-contact" data-bizuply-success-message="תודה! קיבלנו את הפנייה ונחזור אלייך בהקדם.">
            ...
            <textarea className="min-h-32 border border-white/25 bg-black/20 px-4 py-4 text-right text-white outline-none placeholder:text-white/65" placeholder="במה נוכל לעזור?"  name="message" data-bizuply-form-field-id="message"></textarea>
