export const vertexDefaultData = {
  templateId: "vertex",
  name: "Vertex",
  brandName: "Vertex",
  logoText: "VE",
  tagline: "ייעוץ טכנולוגי",
  navHome: "בית",
  navAbout: "אודות",
  navServices: "שירותים",
  navWork: "פרויקטים",
  navInsights: "תובנות",
  navContact: "צור קשר",
  heroEyebrow: "ייעוץ טכנולוגי",
  heroTitle: "מערכות שמזנקות קדימה.",
  ...
  phone: "03-000-0000",
  email: "hello@vertex.co.il",
  address: "תל אביב, ישראל",
  footerText: "תבנית Vertex — אתר רב-עמודי מקצועי עם עיצוב מלבני ותנועה.",
