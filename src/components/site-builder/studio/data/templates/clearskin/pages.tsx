    ...
    <>
      ...
      <section data-template-section-type="gallery" data-section-kind="gallery" className="beauty-acneClinic-gallery-frame-3 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">CLEAR / gallery</p></div><span className="text-xs text-[var(--muted)]">מעקב עור</span></div>
        </div>
      </section>
      ...
      <section data-template-section-type="packages" data-section-kind="packages" className="beauty-acneClinic-packages-frame-6 overflow-hidden px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-[0.85fr_1.15fr_0.55fr]">
          ...
          <div className="t-float hidden border border-[var(--p)]/35 p-5 md:block"><span className="text-xs text-[var(--muted)]">מעקב עור</span></div>
        </div>
      </section>
      <section data-template-section-type="whyUs" data-section-kind="whyUs" className="beauty-acneClinic-whyUs-frame-7 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">CLEAR / whyUs</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">מעקב עור</span></div>
    ...
    <>
      ...
      <section data-template-section-type="specialistsDeep" data-section-kind="specialistsDeep" className="beauty-acneClinic-specialistsDeep-frame-3 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">CLEAR / specialistsDeep</p></div><span className="text-xs text-[var(--muted)]">מעקב עור</span></div>
        </div>
      </section>
      ...
      <section data-template-section-type="aboutCta" data-section-kind="aboutCta" className="beauty-acneClinic-aboutCta-frame-7 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">CLEAR / aboutCta</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">מעקב עור</span></div>
    ...
    <>
      ...
      <section data-template-section-type="beforeAfter" data-section-kind="beforeAfter" className="beauty-acneClinic-beforeAfter-frame-3 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="order-1 flex items-start justify-between border-r-4 border-[var(--p)] pr-5 md:order-2"><div><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">CLEAR / beforeAfter</p></div><span className="text-xs text-[var(--muted)]">מעקב עור</span></div>
        </div>
      </section>
  ...
  return (
    <>
      <section data-template-section-type="bookingHero" data-section-kind="bookingHero" className="beauty-acneClinic-bookingHero-frame-7 px-5 py-12 md:py-24 lg:px-8">
        <div className="mx-auto max-w-7xl border-y border-[var(--p)]/35 py-10">
          <div className="mb-8 grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-end"><p className="text-xs font-bold uppercase tracking-[0.32em] text-[var(--p)]">CLEAR / bookingHero</p><div className="h-px bg-[var(--p)]/30" /><span className="text-xs text-[var(--muted)]">מעקב עור</span></div>
      ...
      <section data-section-kind="booking" data-bizuply-block="booking" data-template-section-type="booking" className="beauty-acneClinic-calendar-frame-8 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--a)_16%,transparent),transparent)] px-5 py-12 md:py-24 text-center lg:px-8">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-8 lg:grid-cols-[0.75fr_1.25fr] lg:items-start"><Reveal><h2 className="t-display text-2xl sm:text-4xl text-[var(--p)]">{getValue(data,"calendarTitle")}</h2><p className="mt-4 text-[var(--muted)]">בחרו יום ושעה פנויה. הלוח כאן לשמירת תור מהירה מתוך התבנית.</p></Reveal><Reveal delayMs={100} className="t-glow bg-[var(--surface)]/80 p-5"><BookingCalendarPanel pill /></Reveal></div>
        </div>
      </section>
...
export default function ClearskinPages(props: ClearskinPagesProps) {
  ...
  const mergedData = useMemo(() => ({ ...clearskinDefaultData, ...(data ?? {}) }), [data]);
  ...
  return (
    <div dir="rtl" data-template-id={mode === "preview" ? "clearskin-preview" : "clearskin"} className="min-h-screen w-full overflow-x-hidden" style={{ background: "#F3FEFF", color: "#164E63" }}>
