...
[data-template-id="tidehaus"] .tpl-ken, [data-template-id="tidehaus"] .tpl-ken {
  animation: tidehaus-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="tidehaus"] .tpl-rise, [data-template-id="tidehaus"] .tpl-rise {
  animation: tidehaus-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="tidehaus"] .tpl-rise-2, [data-template-id="tidehaus"] .tpl-rise-2 {
  animation: tidehaus-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="tidehaus"] .tpl-rise-3, [data-template-id="tidehaus"] .tpl-rise-3 {
  animation: tidehaus-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="tidehaus"] .tpl-marquee-track, [data-template-id="tidehaus"] .tpl-marquee-track {
  display: flex; width: max-content; animation: tidehaus-marquee 28s linear infinite;
}
[data-template-id="tidehaus"] .tpl-float, [data-template-id="tidehaus"] .tpl-float {
  animation: tidehaus-float 5s ease-in-out infinite;
}
[data-template-id="tidehaus"] .tpl-sweep, [data-template-id="tidehaus"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="tidehaus"] .tpl-sweep::after, [data-template-id="tidehaus"] .tpl-sweep::after {
...
[data-template-id="tidehaus"] .tpl-climb, [data-template-id="tidehaus"] .tpl-climb {
...
[data-template-id="tidehaus"] .tpl-tide-line, [data-template-id="tidehaus"] .tpl-tide-line {
  animation: tidehaus-tide 4s ease-in-out infinite;
}
[data-template-id="tidehaus"] .tpl-board-rail, [data-template-id="tidehaus"] .tpl-board-rail {
  display: flex; gap: 1rem; overflow-x: auto; scroll-snap-type: x mandatory;
}
[data-template-id="tidehaus"] .tpl-board-card, [data-template-id="tidehaus"] .tpl-board-card {
