...
[data-template-id="sushisen"] .tpl-ken, [data-template-id="sushisen"] .tpl-ken {
  animation: sushisen-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="sushisen"] .tpl-rise, [data-template-id="sushisen"] .tpl-rise {
  animation: sushisen-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="sushisen"] .tpl-rise-2, [data-template-id="sushisen"] .tpl-rise-2 {
  animation: sushisen-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="sushisen"] .tpl-rise-3, [data-template-id="sushisen"] .tpl-rise-3 {
  animation: sushisen-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="sushisen"] .tpl-marquee-track, [data-template-id="sushisen"] .tpl-marquee-track {
  display: flex; width: max-content; animation: sushisen-marquee 28s linear infinite;
}
[data-template-id="sushisen"] .tpl-float, [data-template-id="sushisen"] .tpl-float {
  animation: sushisen-float 5s ease-in-out infinite;
}
[data-template-id="sushisen"] .tpl-sweep, [data-template-id="sushisen"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="sushisen"] .tpl-sweep::after, [data-template-id="sushisen"] .tpl-sweep::after {
...
[data-template-id="sushisen"] .tpl-climb, [data-template-id="sushisen"] .tpl-climb {
...
[data-template-id="sushisen"] .tpl-conveyor, [data-template-id="sushisen"] .tpl-conveyor {
  display: flex; width: max-content; animation: sushisen-conveyor 22s linear infinite; gap: 1rem;
}
[data-template-id="sushisen"] .tpl-wasabi, [data-template-id="sushisen"] .tpl-wasabi {
  animation: sushisen-wasabi-pulse 2.2s ease-in-out infinite;
}
[data-template-id="sushisen"] .tpl-nigiri-rail, [data-template-id="sushisen"] .tpl-nigiri-rail {
  display: flex; gap: 1rem; overflow-x: auto; scroll-snap-type: x mandatory;
}
[data-template-id="sushisen"] .tpl-nigiri-card, [data-template-id="sushisen"] .tpl-nigiri-card {
