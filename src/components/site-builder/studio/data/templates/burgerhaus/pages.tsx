  ...
  return (
    <section className="border-t px-5 py-16 lg:px-8" style={{ borderColor: "rgba(245,245,245,0.12)" }}>
      <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 border p-8 md:flex-row md:items-center" style={{ borderColor: "#f59e0b", background: "#1a1a1a" }}>
        ...
        <button type="button" onClick={() => goTo("contact")} className="px-7 py-3.5 text-sm font-bold" style={{ background: "#f59e0b", color: "#111111" }}>{v(data, "heroPrimary")}</button>
      </div>
    </section>
  );
}
  ...
  return (
    <section className="border-t px-5 py-16 lg:px-8" style={{ borderColor: "rgba(245,245,245,0.12)", background: "#1a1a1a" }}>
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2">
        ...
        <form className="grid gap-3 border p-6" style={{ borderColor: "#f59e0b" }} onSubmit={(e) => e.preventDefault()}>
          <input className="w-full border bg-transparent px-4 py-3.5 text-right outline-none" style={{ borderColor: "rgba(245,245,245,0.12)", color: "#f5f5f5" }} placeholder="שם מלא" />
          <input className="w-full border bg-transparent px-4 py-3.5 text-right outline-none" style={{ borderColor: "rgba(245,245,245,0.12)", color: "#f5f5f5" }} placeholder="טלפון" />
          ...
          <button type="button" onClick={onCta} className="px-6 py-4 text-sm font-bold" style={{ background: "#f59e0b", color: "#111111" }}>{v(data, "cta")}</button>
        </form>
      </div>
    </section>
  );
