...
[data-template-id="nestora"] .tpl-ken, [data-template-id="nestora"] .tpl-ken {
  animation: nestora-ken 23s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="nestora"] .tpl-rise, [data-template-id="nestora"] .tpl-rise {
  animation: nestora-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="nestora"] .tpl-rise-2, [data-template-id="nestora"] .tpl-rise-2 {
  animation: nestora-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="nestora"] .tpl-rise-3, [data-template-id="nestora"] .tpl-rise-3 {
  animation: nestora-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="nestora"] .tpl-draw, [data-template-id="nestora"] .tpl-draw {
  transform-origin: right center; animation: nestora-draw 1.1s cubic-bezier(.22,1,.36,1) .2s both;
}
[data-template-id="nestora"] .tpl-marquee-track, [data-template-id="nestora"] .tpl-marquee-track {
  display: flex; width: max-content; animation: nestora-marquee 36s linear infinite;
}
[data-template-id="nestora"] .tpl-float, [data-template-id="nestora"] .tpl-float {
  animation: nestora-float 6s ease-in-out infinite;
}
[data-template-id="nestora"] .tpl-pulse-line, [data-template-id="nestora"] .tpl-pulse-line {
  animation: nestora-pulse 2.8s ease-in-out infinite;
}
[data-template-id="nestora"] .tpl-sweep, [data-template-id="nestora"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="nestora"] .tpl-sweep::after, [data-template-id="nestora"] .tpl-sweep::after {
...
[data-template-id="nestora"] .tpl-climb, [data-template-id="nestora"] .tpl-climb {
