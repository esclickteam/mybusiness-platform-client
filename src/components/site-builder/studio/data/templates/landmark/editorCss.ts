...
[data-template-id="landmark"] .tpl-ken, [data-template-id="landmark"] .tpl-ken {
  animation: landmark-ken 18s ease-in-out infinite alternate; transform-origin: center;
}
[data-template-id="landmark"] .tpl-rise, [data-template-id="landmark"] .tpl-rise {
  animation: landmark-rise .9s cubic-bezier(.22,1,.36,1) both;
}
[data-template-id="landmark"] .tpl-rise-2, [data-template-id="landmark"] .tpl-rise-2 {
  animation: landmark-rise .9s cubic-bezier(.22,1,.36,1) .12s both;
}
[data-template-id="landmark"] .tpl-rise-3, [data-template-id="landmark"] .tpl-rise-3 {
  animation: landmark-rise .9s cubic-bezier(.22,1,.36,1) .24s both;
}
[data-template-id="landmark"] .tpl-marquee-track, [data-template-id="landmark"] .tpl-marquee-track {
  display: flex; width: max-content; animation: landmark-marquee 28s linear infinite;
}
[data-template-id="landmark"] .tpl-float, [data-template-id="landmark"] .tpl-float {
  animation: landmark-float 5s ease-in-out infinite;
}
[data-template-id="landmark"] .tpl-sweep, [data-template-id="landmark"] .tpl-sweep { position: relative; overflow: hidden; }
[data-template-id="landmark"] .tpl-sweep::after, [data-template-id="landmark"] .tpl-sweep::after {
...
[data-template-id="landmark"] .tpl-climb, [data-template-id="landmark"] .tpl-climb {
...
[data-template-id="landmark"] .tpl-pin, [data-template-id="landmark"] .tpl-pin { animation:landmark-pin 2s infinite; }
@keyframes landmark-testi { to { transform:translateX(-50%); } }
[data-template-id="landmark"] .tpl-testi-track, [data-template-id="landmark"] .tpl-testi-track {
