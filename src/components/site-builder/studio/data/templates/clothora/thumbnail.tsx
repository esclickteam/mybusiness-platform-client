...
export default function ClothoraThumbnail() {
  return (
    <div className="relative flex h-full min-h-[260px] w-full flex-col justify-between overflow-hidden p-5 text-right" style={{ background: "#FAFAF9", color: "#111827", fontFamily: "Heebo, sans-serif" }}>
      ...
      <div className="relative">
        <div className="inline-flex px-2 py-1 text-[10px] font-black uppercase tracking-[0.2em]" style={{ background: "#111827", color: "#FFFFFF" }}>בגדים ואופנה</div>
        <h3 className="mt-4 text-3xl font-black leading-none" style={{ fontFamily: "Bodoni Moda, serif" }}>Clothora</h3>
        <p className="mt-2 text-xs font-semibold opacity-70">גזרות מדויקות. ארון חי.</p>
      </div>
