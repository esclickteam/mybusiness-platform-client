  ...
  return (
    <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top,#ffffff_0%,#f7f8ff_40%,#eef3ff_76%,#ffffff_100%)] py-24 text-slate-800">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
                      ...
                      <div className="flex items-start gap-4">
                        <span
                          className={[
                            ...
                            isOpen
                              ? "border border-violet-200/80 bg-gradient-to-br from-violet-100 via-sky-100 to-cyan-100 text-indigo-700 shadow-lg shadow-indigo-100"
        ...
        <div className="mt-14 overflow-hidden rounded-[2rem] border border-violet-200/80 bg-gradient-to-l from-violet-100 via-sky-100 to-cyan-100 p-[1px] shadow-[0_24px_80px_rgba(79,70,229,0.24)]">
          <div className="rounded-[2rem] bg-white/70 px-8 py-9 text-center backdrop-blur-xl sm:px-12">
            <h3 className="text-3xl font-black tracking-[-0.03em] text-slate-800">
              {t("faqMini.ctaTitle")}
            </h3>
