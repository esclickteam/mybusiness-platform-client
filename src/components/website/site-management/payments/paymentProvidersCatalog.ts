...
export const SITE_PAYMENT_PROVIDERS: PaymentProviderCatalogItem[] = [
  {
    ...
    instructions: [
      ...
      "אישור תשלום מתבצע בשרת בלבד (חתימת Webhook או sessions.retrieve) — לא מדף ההצלחה.",
    ],
    fields: [
      {
        key: "publicKey",
  ...
  },
  {
    ...
    instructions: [
      ...
      "דף החזרה מדפדפן אינו מאשר תשלום — רק IPN / אימות שרת.",
    ],
    fields: [
      {
        key: "accountId",
  ...
  },
  {
    ...
    instructions: [
      ...
      "ודאו שמטבע החנות תואם למטבע בחשבון PayMe (מומלץ ILS).",
  ...
  },
  {
    ...
    instructions: [
      ...
      "ודאו שמטבע החנות תואם למטבע בחשבון Grow.",
    ],
    fields: [
      {
        key: "merchantId",
        ...
        type: "password",
        required: true,
        keepOnEmptyHint: "השאירו ריק כדי לשמור על ה-userId הקיים",
      },
      {
        key: "pageCode",
        label: "pageCode",
        ...
        type: "password",
        required: true,
        keepOnEmptyHint: "השאירו ריק כדי לשמור על ה-pageCode הקיים",
      },
    ],
  },
  {
    ...
    instructions: [
      "הזינו api-key, secret-key ו-Payment Page UID מחשבון PayPlus.",
      "אישור תשלום מגיע ב-refURL_callback עם אימות HMAC + ipn-full — לא מדף ההצלחה.",
      "ודאו שמטבע החנות תואם למטבע בחשבון PayPlus.",
    ...
    fields: [
      ...
      },
      {
        ...
        type: "password",
        required: true,
        keepOnEmptyHint: "השאירו ריק כדי לשמור על ה-Page UID הקיים",
      },
    ],
  },
  {
    ...
    instructions: [
      ...
      "ודאו שמטבע החנות תואם למטבע בטרמינל Tranzila.",
    ],
    fields: [
      {
        key: "terminalNumber",
        ...
        type: "password",
        required: true,
        keepOnEmptyHint: "השאירו ריק כדי לשמור על הטרמינל הקיים",
      },
      {
        key: "accountId",
        label: "אימייל (אופציונלי)",
