 ...
 * iframe uses the app's real renderers, so the preview matches the actual
 * site/template 1:1 (including edits and images). Loading is deferred until the
 * card nears the viewport to keep the grid light.
 */
