...
export function buildCountdownWidgetMarker(label = i18n.t("leftover.countdown.title")) {
  return `<div data-bizuply-plugin="countdown" data-bizuply-widget="countdown" data-countdown-mount="true" style="width:100%;height:100%;min-height:120px;direction:rtl;box-sizing:border-box"><div style="width:100%;height:100%;padding:20px 12px;text-align:center;border:2px dashed #c4b5fd;border-radius:16px;background:linear-gradient(135deg,#f5f3ff,#eff6ff);font-family:system-ui,sans-serif;box-sizing:border-box;display:flex;flex-direction:column;align-items:center;justify-content:center"><div style="font-size:11px;font-weight:700;color:#7c3aed;margin-bottom:4px">${i18n.t("leftover.countdown.plugin")}</div><div style="font-size:15px;font-weight:800;color:#1e293b">${label}</div><div style="font-size:10px;color:#64748b;margin-top:4px">${i18n.t("leftover.countdown.dragHint")}</div></div></div>`;
}
