...
export default function BusinessProfileView() {
  ...
  // Fetch business and set avgRating
  useEffect(() => {
    setLoading(true);
    setError(null);
    ...
    api.get(`/business/${businessId}`)
      .then(res => {
        ...
        // DEBUG: log fetched business and rating
        console.log("[BusinessProfileView] Fetched business:", biz);
        console.log("[BusinessProfileView] Fetched rating:", biz.rating);
  ...
  const handleReviewSubmit = async (newReview) => {
    try {
      ...
      console.log("[BusinessProfileView] Submission response:", res.data);
          ...
          <div className="tab-content">
            ...
            {currentTab === 'ביקורות' && (
              <div className="reviews">
                {user && !(user.role === 'business' && user.businessId === businessId) && (
            ...
            {currentTab === 'חנות / יומן' && (
              <div className="shop-tab-placeholder"><p>Development coming soon…</p></div>
            )}
          </div>
