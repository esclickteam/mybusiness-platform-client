...
// Default: Open Sun–Thu, also open Sat (now allowed)
const DEFAULT_HOURS = {
  ...
  6: { start: "10:00", end: "16:00" }, // Saturday now open
};
...
export default function WeeklyHoursSetup({ initialHours = DEFAULT_HOURS, onSave }) {
  ...
  return (
    ...
    >
      <h2 style={{ textAlign: "center" }}>🗓️ Set Weekly Business Hours</h2>
      ...
      <div style={{ margin: "2.5em 0 0.5em", textAlign: "center" }}>
        <button
          ...
          style={{
            ...
            padding: "12px 36px",
            cursor: "pointer",
            boxShadow: "0 1px 6px #d3c1fa60",
          }}
        >
          💾 Save Weekly Business Hours
        </button>
      </div>
      ...
      <div
        style={{
          ...
          background: "#fff",
          borderRadius: 12,
          boxShadow: "0 0 6px #d3c1fa30",
          padding: 16,
        }}
      >
        <div style={{ fontWeight: "bold", marginBottom: 8, color: "#6c36a7" }}>
