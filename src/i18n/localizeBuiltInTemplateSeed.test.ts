...
describe("localizeBuiltInTemplateSeed", () => {
  ...
  it("localizes unique99 leftover section-variant chrome", () => {
    expect(localizeBuiltInText("שותפות", "en")).toMatch(/Partnership/i);
    expect(localizeBuiltInText("שותפות", "en")).not.toMatch(/[\u0590-\u05FF]/);
    expect(localizeBuiltInText("למד עוד", "es")).toMatch(/Saber|más/i);
    expect(localizeBuiltInText("החל מ־₪99", "pt-BR")).toContain("₪99");
    expect(localizeBuiltInText("בחרו זמן", "ar")).not.toMatch(/[\u0590-\u05FF]/);
    expect(localizeBuiltInText("ניהול חכם", "en")).toMatch(/Smart|management/i);
  });

  it("localizes unique100 leftover section-variant chrome", () => {
    expect(localizeBuiltInText("נשמח לשמוע מכם", "en")).toMatch(/love to hear|hear from you/i);
    expect(localizeBuiltInText("נשמח לשמוע מכם", "en")).not.toMatch(/[\u0590-\u05FF]/);
    expect(localizeBuiltInText("מה כולל המחיר?", "es")).toMatch(/precio|incluye/i);
    expect(localizeBuiltInText("הצטרפו לקהילה", "pt-BR")).toMatch(/comunidade|Entrem|Junte/i);
    expect(localizeBuiltInText("הוסיפו לסל", "ar")).not.toMatch(/[\u0590-\u05FF]/);
    expect(localizeBuiltInText("אודות – סיפור ויזואלי", "en")).toMatch(/About|visual/i);
  });

  it("localizes unique101 leftover section-variant chrome", () => {
    expect(localizeBuiltInText("\u05e4\u05d2\u05d9\u05e9\u05d5\u05ea", "en")).toBe("Meetings");
    expect(localizeBuiltInText("\u05e4\u05d2\u05d9\u05e9\u05d5\u05ea", "en")).not.toMatch(/[\u0590-\u05FF]/);
    expect(localizeBuiltInText("\u05e4\u05d2\u05d9\u05e9\u05d5\u05ea", "es")).toBe("Reuniones");
    expect(localizeBuiltInText("\u05d4\u05de\u05e7\u05d5\u05dd \u05e0\u05d5\u05dc\u05d3 \u05de\u05ea\u05d5\u05da \u05d0\u05d4\u05d1\u05d4 \u05dc\u05e4\u05e8\u05d8\u05d9\u05dd \u05d4\u05e7\u05d8\u05e0\u05d9\u05dd \u2014 \u05d4\u05d0\u05d5\u05e8 \u05d4\u05e0\u05db\u05d5\u05df, \u05d4\u05e9\u05d5\u05dc\u05d7\u05df \u05d4\u05de\u05d5\u05db\u05df, \u05d4\u05ea\u05d7\u05d5\u05e9\u05d4 \u05e9\u05de\u05e7\u05d1\u05dc\u05d9\u05dd \u05db\u05e9\u05e0\u05db\u05e0\u05e1\u05d9\u05dd. \u05d0\u05e0\u05d7\u05e0\u05d5 \u05de\u05e1\u05e4\u05e8\u05d9\u05dd \u05d0\u05ea \u05d4\u05e1\u05d9\u05e4\u05d5\u05e8 \u05d3\u05e8\u05da \u05ea\u05de\u05d5\u05e0\u05d5\u05ea, \u05d7\u05d5\u05de\u05e8\u05d9\u05dd \u05d5\u05e8\u05d2\u05e2\u05d9\u05dd \u05d0\u05de\u05d9\u05ea\u05d9\u05d9\u05dd, \u05dc\u05d0 \u05d3\u05e8\u05da \u05e1\u05d9\u05e1\u05de\u05d0\u05d5\u05ea. \u05db\u05dc \u05d1\u05d7\u05d9\u05e8\u05d4 \u05db\u05d0\u05df \u05e0\u05d5\u05e2\u05d3\u05d4 \u05dc\u05d9\u05e6\u05d5\u05e8 \u05d0\u05d5\u05d5\u05d9\u05e8\u05d4 \u05e9\u05e7\u05d8\u05d4, \u05de\u05d6\u05de\u05d9\u05e0\u05d4 \u05d5\u05de\u05d3\u05d5\u05d9\u05e7\u05ea.", "en")).toMatch(/[A-Za-z]/);
    expect(localizeBuiltInText("\u05d4\u05de\u05e7\u05d5\u05dd \u05e0\u05d5\u05dc\u05d3 \u05de\u05ea\u05d5\u05da \u05d0\u05d4\u05d1\u05d4 \u05dc\u05e4\u05e8\u05d8\u05d9\u05dd \u05d4\u05e7\u05d8\u05e0\u05d9\u05dd \u2014 \u05d4\u05d0\u05d5\u05e8 \u05d4\u05e0\u05db\u05d5\u05df, \u05d4\u05e9\u05d5\u05dc\u05d7\u05df \u05d4\u05de\u05d5\u05db\u05df, \u05d4\u05ea\u05d7\u05d5\u05e9\u05d4 \u05e9\u05de\u05e7\u05d1\u05dc\u05d9\u05dd \u05db\u05e9\u05e0\u05db\u05e0\u05e1\u05d9\u05dd. \u05d0\u05e0\u05d7\u05e0\u05d5 \u05de\u05e1\u05e4\u05e8\u05d9\u05dd \u05d0\u05ea \u05d4\u05e1\u05d9\u05e4\u05d5\u05e8 \u05d3\u05e8\u05da \u05ea\u05de\u05d5\u05e0\u05d5\u05ea, \u05d7\u05d5\u05de\u05e8\u05d9\u05dd \u05d5\u05e8\u05d2\u05e2\u05d9\u05dd \u05d0\u05de\u05d9\u05ea\u05d9\u05d9\u05dd, \u05dc\u05d0 \u05d3\u05e8\u05da \u05e1\u05d9\u05e1\u05de\u05d0\u05d5\u05ea. \u05db\u05dc \u05d1\u05d7\u05d9\u05e8\u05d4 \u05db\u05d0\u05df \u05e0\u05d5\u05e2\u05d3\u05d4 \u05dc\u05d9\u05e6\u05d5\u05e8 \u05d0\u05d5\u05d5\u05d9\u05e8\u05d4 \u05e9\u05e7\u05d8\u05d4, \u05de\u05d6\u05de\u05d9\u05e0\u05d4 \u05d5\u05de\u05d3\u05d5\u05d9\u05e7\u05ea.", "ar")).not.toMatch(/[\u0590-\u05FF]/);
