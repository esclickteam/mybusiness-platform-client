...
export const TEMPLATE_EXACT_LEXICON: Record<string, LocaleCopy> = {
  ...
  "יצירת קשר": r("Get in touch", "Contactar", "Fale connosco", "تواصلوا معنا"),
  שירותים: r("Services", "Servicios", "Serviços", "خدمات"),
  "השירותים שלנו": r("Our services", "Nuestros servicios", "Os nossos serviços", "خدماتنا"),
  ...
  "דברו איתנו": r("Talk to us", "Háblanos", "Falem connosco", "تحدثوا معنا"),
