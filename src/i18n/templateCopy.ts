...
import unique74ExactLexicon from "./templateExactLexicon.unique74.json";
import unique75ExactLexicon from "./templateExactLexicon.unique75.json";
import unique76ExactLexicon from "./templateExactLexicon.unique76.json";
import unique77ExactLexicon from "./templateExactLexicon.unique77.json";
import unique78ExactLexicon from "./templateExactLexicon.unique78.json";
import unique79ExactLexicon from "./templateExactLexicon.unique79.json";
import unique80ExactLexicon from "./templateExactLexicon.unique80.json";
import unique81ExactLexicon from "./templateExactLexicon.unique81.json";
import unique82ExactLexicon from "./templateExactLexicon.unique82.json";
import unique83ExactLexicon from "./templateExactLexicon.unique83.json";
import unique84ExactLexicon from "./templateExactLexicon.unique84.json";
...
import unique94ExactLexicon from "./templateExactLexicon.unique94.json";
import unique95ExactLexicon from "./templateExactLexicon.unique95.json";
import unique96ExactLexicon from "./templateExactLexicon.unique96.json";
import unique97ExactLexicon from "./templateExactLexicon.unique97.json";
import unique98ExactLexicon from "./templateExactLexicon.unique98.json";
import unique99ExactLexicon from "./templateExactLexicon.unique99.json";
import unique100ExactLexicon from "./templateExactLexicon.unique100.json";
import unique101ExactLexicon from "./templateExactLexicon.unique101.json";
import unique102ExactLexicon from "./templateExactLexicon.unique102.json";
import unique103ExactLexicon from "./templateExactLexicon.unique103.json";
import unique104ExactLexicon from "./templateExactLexicon.unique104.json";
import unique105ExactLexicon from "./templateExactLexicon.unique105.json";
...
const EXACT_LEXICON: Record<string, PhraseTranslation | LocaleCopy> = {
  ...
  ...(unique74ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique75ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique76ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique77ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique78ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique79ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique80ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique81ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique82ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique83ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique84ExactLexicon as Record<string, PhraseTranslation>),
  ...
  ...(unique94ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique95ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique96ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique97ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique98ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique99ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique100ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique101ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique102ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique103ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique104ExactLexicon as Record<string, PhraseTranslation>),
  ...(unique105ExactLexicon as Record<string, PhraseTranslation>),
