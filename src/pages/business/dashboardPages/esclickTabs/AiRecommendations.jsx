...
const AiRecommendations = ({ businessId, token, onTokenExpired }) => {
  ...
  return (
    <div>
      ...
      {/* 📌 הסבר למנהל העסק – איך ההמלצות נוצרות */}
      <div
        style={{
          marginTop: "2rem",
          padding: "1.5rem",
      ...
      >
        <h4>🧠 איך ההמלצות נוצרות?</h4>
        <ul style={{ paddingRight: "1rem" }}>
          <li>
            אם השאלה שקשורה לעסק – כמו מחיר, זמינות, שירות מסוים, שעות פעילות או זמינות תורים ביומן –{" "}
            המערכת מחפשת תשובה בתיאור העסק, ברשימת השירותים, בשאלות ותשובות מהפרופיל, ובזמינות היומן.
          </li>
          <li>
            אם אין התאמה – התשובה תישלף אוטומטית מ־OpenAI.
          </li>
          <li>
            אם התקבלה ביקורת נמוכה מ־4, תוצג המלצה לשלוח ללקוח הודעה בנוסח:
            <br />
            <i>
              "היי, שמנו לב שדרגת את השירות בציון נמוך – נשמח להבין איך לשפר את החוויה שלך, או להציע פיצוי מתאים."
            </i>
          </li>
          <li>
            המלצות נוספות בהתאם לדירוג הביקורת:
            <ul>
              <li>⭐⭐⭐½ ומטה: הודעה ללקוח עם בקשת שיפור או הצעת פיצוי.</li>
              <li>⭐⭐: התראה לבעל העסק עם המלצה ליצור קשר אישי ולהציע שובר הנחה.</li>
              <li>⭐: דגל אדום לבדיקה תפעולית של השירות או העובד.</li>
            </ul>
          </li>
        </ul>
        <p style={{ marginTop: "1rem", fontWeight: 600 }}>
          ההמלצות מתבססות על הנתונים שלך בלבד – ככל שהפרופיל מפורט יותר, כך המערכת חכמה יותר 🎯
        </p>
      </div>
    </div>
  );
