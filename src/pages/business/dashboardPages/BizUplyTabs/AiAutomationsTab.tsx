...
import { listSupportedAiTemplates, buildAiTemplateDiscoveryHref } from "../automations/aiAutomationCatalog";
import {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-2 flex-1 text-xs font-semibold leading-6 text-slate-600">
                    {aiTemplateDescription(t, template)}
                  </p>
                  <Link
                    to={href}
                  ...
                  >
                    {t("automations.aiTab.viewTemplate")}
                  </Link>
                </article>
              );
            })}
