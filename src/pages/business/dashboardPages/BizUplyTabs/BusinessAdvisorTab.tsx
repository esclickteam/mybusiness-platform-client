  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -left-24 -top-24 h-72 w-72 rounded-full bg-violet-500/30 blur-3xl" />
        ...
        <footer className="border-t border-white/10 bg-slate-950/45 px-4 py-4 backdrop-blur-xl sm:px-7 lg:px-8">
          ...
          <div className="mx-auto flex max-w-5xl flex-col gap-3 rounded-3xl border border-white/10 bg-white/10 p-2 shadow-2xl sm:flex-row sm:items-center">
            <input
              ...
              className="min-h-12 flex-1 rounded-2xl border border-transparent bg-white px-4 text-sm font-medium text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-violet-300 focus:ring-4 focus:ring-violet-500/20 disabled:cursor-not-allowed disabled:bg-slate-200"
            />
