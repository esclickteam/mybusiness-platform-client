    ...
    <div className="space-y-6" dir="rtl">
      ...
      <section className="grid gap-5 xl:grid-cols-[420px_minmax(0,1fr)]">
        <aside className="space-y-5">
          ...
          <div className="rounded-[2.2rem] border border-emerald-100 bg-white p-5 shadow-[0_18px_55px_rgba(15,23,42,0.06)]">
            <div className="mb-3 flex items-center gap-2 text-emerald-700">
              <ShieldCheck className="h-5 w-5" />
              <h3 className="text-base font-black">חיבור ללא אישור פייסבוק</h3>
            </div>

            <p className="text-sm font-bold leading-7 text-slate-500">
              Bizuply לא מתחברת ישירות לפייסבוק. Make מושך את הלידים ושולח
              אותם אלייך ל־CRM דרך API מאובטח עם קישור אישי.
            </p>
          </div>
        </aside>
