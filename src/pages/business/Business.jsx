    ...
    <div className="business-join-container">
      ...
      <div className="info-section">
        <div className="info-box purple">
          ...
          <ul>
            <li>עמוד עסקי מקצועי ללקוחות שלך, הכולל ניהול יומן חכם ומסונכרן עם כל הצרכים של הלקוח</li>
            <li>מערכת שיתופי פעולה מתקדמת להגדלת רווחים וצמיחה משותפת</li>
            <li>מערכת AI כוללת שותף חכם והמלצות לניהול העסק באמצעות הכלים החדשניים ביותר</li>
            <li>מחיר חודשי ידוע מראש, ללא הפתעות או עלויות נסתרות</li>
          </ul>
        </div>
        ...
        <div className="info-box white">
          <h2>איך זה עובד?</h2>
          <ul>
            <li>נרשמים ובוחרים את החבילה המתאימה לעסק</li>
            <li>בונים את העמוד העסקי הכולל צ'אט, יומן, גלריה ועוד</li>
            <li>מפיצים את העמוד ללקוחות שלכם וברשתות החברתיות</li>
            <li>נהנים מהמערכת החכמה והמתקדמת לעסקים שתוביל אתכם להצלחה</li>
          </ul>
        </div>
      </div>
