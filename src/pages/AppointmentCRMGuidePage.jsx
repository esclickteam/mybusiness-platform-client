...
export default function AppointmentCRMGuidePage() {
  return (
    <div className="appointment-crm-container" dir="rtl" lang="he">
      <h1>📅 מדריך מקצועי: ניהול יומן תיאום תורים ופגישות ו-CRM בעסקליק – השליטה המלאה בעסק שלך</h1>

      <p>
        ניהול נכון של העסק מחייב שליטה מושלמת גם בניהול הזמן וגם בקשרי הלקוחות. בעסקליק, שני הכלים המרכזיים – יומן תיאום תורים ופגישות ומערכת CRM לניהול קשרי לקוחות – מאפשרים לך לעשות זאת ביעילות, במקצועיות ובפשטות.
      </p>
