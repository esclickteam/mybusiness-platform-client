...
function AdminPlans() {
  const [plans, setPlans] = useState([
    ...
    { id: 2, name: "Premium", price: 99, duration: "Month", features: ["Client Chat", "Custom Banners"], trialDays: 7 }
  ]);
  ...
  return (
    <div className="admin-plans">
      ...
      <div className="coupon-section">
        <h2>🎁 {editCouponId ? "Edit Coupon" : "Add Discount Coupon"}</h2>
