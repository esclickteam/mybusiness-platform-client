          ...
          <div className="grid overflow-hidden rounded-[2rem] border border-slate-100 bg-white lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="bg-gradient-to-br from-white to-indigo-50/70 p-6 sm:p-8">
              <div className="grid gap-4">
                {[
                  ["Our Vision", "Technology should work for business owners — not the other way around."],
                  ["Our Journey", "BizUply brings essential tools under one roof: CRM, scheduling, messaging, reviews, partnerships and AI."],
                  ["Looking Ahead", "We’re building a reliable digital workspace for small and medium businesses."],
                  ["In a Few Words", "A smarter way to stay organized, connected and future-ready."],
