...
export const INTRO_CATEGORIES = [
  { key: "dash", title: "Dashboard", titleKey: "leftover.guided.introDash", hint: "Metrics and activity", hintKey: "leftover.guided.introDashHint", icon: "dashboard" },
  { key: "crm", title: "CRM and leads", titleKey: "leftover.guided.introCrm", hint: "Inquiries and follow-up", hintKey: "leftover.guided.introCrmHint", icon: "crm" },
  { key: "work", title: "Meetings and calendar", titleKey: "leftover.guided.introWork", hint: "Appointments and calendar", hintKey: "leftover.guided.introWorkHint", icon: "work" },
